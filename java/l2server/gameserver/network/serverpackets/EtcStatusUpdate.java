...
public class EtcStatusUpdate extends L2GameServerPacket
{
	...
	protected void writeImpl()
	{
		...
		writeC(_activeChar.isAffected(L2EffectType.CHARMOFCOURAGE.getMask()) ? 1 : 0); // 1 = charm of courage (allows resurrection on the same spot upon death on the siege battlefield)
