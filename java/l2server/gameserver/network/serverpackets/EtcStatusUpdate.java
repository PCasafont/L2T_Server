...
public class EtcStatusUpdate extends L2GameServerPacket
{
    ...
    { // several icons to a separate line (0 = disabled)
        ...
        writeC(_activeChar.getMessageRefusal() || _activeChar.isChatBanned() || _activeChar
                .isSilenceMode() ? 1 : 0); // 1 = block all chat
        ...
        writeC(_activeChar.isAffected(L2EffectType.CHARMOFCOURAGE
                .getMask()) ? 1 :
