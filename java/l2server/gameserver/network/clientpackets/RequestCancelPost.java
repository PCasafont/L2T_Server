...
public final class RequestCancelPost extends L2GameClientPacket
{
	...
	public void runImpl()
	{
		...
		for (L2ItemInstance item : attachments.getItems())
		{
			...
			final L2ItemInstance newItem = attachments.transferItem(attachments.getName() + " from " + msg.getSenderName(), item.getObjectId(), count, activeChar.getInventory(), activeChar, null);
			if (newItem == null)
				return;
