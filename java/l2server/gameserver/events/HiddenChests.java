...
public class HiddenChests
{
		...
		try
		{
			for (int i = 0; i < SPECIAL_CHEST_COUNT; i++)
			{
				...
				while (!found)
				{
					...
					while ((randomSpawn.getNpc().getX() < 150000) || (randomSpawn.getNpc().getY() > 227000) || randomSpawn.getNpc().isInsideZone(L2Character.ZONE_CASTLE) || randomSpawn.getNpc().isInsideZone(L2Character.ZONE_CLANHALL) || randomSpawn.getNpc().isInsideZone(L2Character.ZONE_FORT))
	...
	{
		String html = "<html>" + "<body>" + "<center><table><tr><td><img src=icon.etc_alphabet_h_i00 width=32 height=32></td><td><img src=icon.etc_alphabet_i_i00 width=32 height=32></td><td><img src=icon.etc_alphabet_d_i00 width=32 height=32></td><td><img src=icon.etc_alphabet_d_i00 width=32 height=32></td><td><img src=icon.etc_alphabet_e_i00 width=32 height=32></td><td><img src=icon.etc_alphabet_n_i00 width=32 height=32></td></tr></table></center>" + "<table><tr><td><img src=icon.etc_alphabet_t_i00 width=32 height=32></td><td><img src=icon.etc_alphabet_r_i00 width=32 height=32></td><td><img src=icon.etc_alphabet_e_i00 width=32 height=32></td><td><img src=icon.etc_alphabet_a_i00 width=32 height=32></td><td><img src=icon.etc_alphabet_s_i00 width=32 height=32></td><td><img src=icon.etc_alphabet_u_i00 width=32 height=32></td><td><img src=icon.etc_alphabet_r_i00 width=32 height=32></td><td><img src=icon.etc_alphabet_e_i00 width=32 height=32></td></tr></table>" + "<br><br>" + "<table width=300><tr><td>These are all the treasures in the world with hints for you to find them:</td></tr></table><br>" + "<center>";
		int x = 0;
	...
	class OpenChestCastFinalizer implements Runnable
	{
		...
		public void run()
		{
			if (_player.isCastingNow())
			{
				...
				if ((_player.getTarget() == _chest) && !_chest.isDead() && Util.checkIfInRange(1000, _player, _chest, true))
				{
