...
public class RankingKillInfo
{
	...
	private String getBasicKillInfo(L2PcInstance killed, L2PcInstance killer)
	{
		...
		tb.append("<tr><td ><font color=886531>Current CP / Max Cp:</font></td><td FIXWIDTH=100><font color=LEVEL>" + (int) killer.getCurrentCp() + " / " + killer.getMaxCp() + "</font></td></tr>");
		tb.append("<tr><td><font color=886531>Current HP / Max HP:</font></td><td><font color=FF0000>" + (int) killer.getCurrentHp() + " / " + killer.getMaxHp() + "</font></td></tr>");
		tb.append("<tr><td><font color=886531>Current MP / Max MP:</font></td><td><font color=3366FF>" + (int) killer.getCurrentMp() + " / " + killer.getMaxMp() + "</font></td></tr>");
		tb.append("</table>");
		tb.append("<img src=\"L2UI.Squaregray\" width=300 height=1>");
		tb.append("<table width=300>");
		tb.append("<tr><td><font color=886531>Legal PvP Points:</font></td><td FIXWIDTH=70><font color=LEVEL>" + killer.getPvpKills() + "</font></td></tr>");
		tb.append("<tr><td><font color=886531>Legal PK Points:</font></td><td><font color=LEVEL>" + killer.getPkKills() + "</font></td></tr>");
		tb.append("<tr><td><font color=886531>Times killed me:</font></td><td><font color=LEVEL>" + getSpecificKillsInfo(killer.getName(), killed.getName()) + "</font></td></tr>");
		tb.append("<tr><td><font color=886531>Times I killed:</font></td><td><font color=LEVEL>" + getSpecificKillsInfo(killed.getName(), killer.getName()) + "</font></td></tr>");
		tb.append("</table>");
		tb.append("<img src=\"L2UI.Squaregray\" width=300 height=1>");
		tb.append("</body></html>");
		return tb.toString();
