...
public class L2PcInstance extends L2Playable
{
	...
	public boolean doDie(L2Character killer)
	{
		...
		if (isBot())
			getBotController().onDeath(killer);
	...
	public void increasePvpKills(L2Character target)
	{
		if (target instanceof L2PcInstance)
		{
			...
			if (Config.isServer(Config.TENKAI) && !isBot())
			{
	...
	private BotController _botController = null;
	
	@Override
	public final boolean isBot()
	{
		return _botController != null || this instanceof L2ApInstance;
	}
	
	public final void setBotController(final BotController botController)
	{
		_botController = botController;
	}
	
	public final BotController getBotController()
	{
