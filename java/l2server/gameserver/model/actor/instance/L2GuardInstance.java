...
public class L2GuardInstance extends L2Attackable
{
	 ...
	 * <li>Call the L2Character constructor to set the this.template of the L2GuardInstance (copy skills from template to object and link this.calculators to NPC_STD_CALCULATOR) </li>
	...
	/**
	 * Notify the L2GuardInstance to return to its home location (AI_INTENTION_MOVE_TO) and clear its this.aggroList.<BR><BR>
	 */
	@Override
	 ...
	 * <li>If L2PcInstance is in the this.aggroList of the L2GuardInstance, set the L2PcInstance Intention to AI_INTENTION_ATTACK</li>
	 * <li>If L2PcInstance is NOT in the this.aggroList of the L2GuardInstance, set the L2PcInstance Intention to AI_INTENTION_INTERACT (after a distance verification) and show message</li><BR><BR>
	 * <p>
	...
	public void onAction(L2PcInstance player, boolean interact)
	{
		...
		{
			// Check if the L2PcInstance is in the this.aggroList of the L2GuardInstance
			...
			else
			{
				...
				{
					// Send a Server->Client packet SocialAction to the all L2PcInstance on the this.knownPlayer of the L2NpcInstance
