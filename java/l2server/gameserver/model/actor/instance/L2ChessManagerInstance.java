...
public class L2ChessManagerInstance extends L2NpcInstance
{
	...
	public void showChatWindow(L2PcInstance playerInstance, int val)
	{
		...
		else if (ChessEvent.isState(ChessState.STARTED))
		{
			...
			{
				npcHtmlMessage.setHtml("<html><head><title>Instanced Events</title></head><body>There is a started game already.<br>" + "<a action=\"bypass -h npc_" + getObjectId() + "_observe\">Observe Match</a></body></html>");
				playerInstance.sendPacket(npcHtmlMessage);
			}
		}
