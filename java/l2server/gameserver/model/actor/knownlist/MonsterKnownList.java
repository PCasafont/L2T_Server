...
public class MonsterKnownList extends AttackableKnownList
{
	...
	protected boolean removeKnownObject(L2Object object, boolean forget)
	{
		...
		{
			// Clear the this.aggroList of the L2MonsterInstance
			getActiveChar().clearAggroList();

			// Remove all L2Object from this.knownObjects and this.knownPlayer of the L2MonsterInstance then cancel Attak or Cast and notify AI
