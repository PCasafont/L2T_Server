...
public class PcKnownList extends PlayableKnownList
{
	...
	/**
	 * Add a visible L2Object to L2PcInstance this.knownObjects and this.knownPlayer (if necessary) and send Server-Client Packets needed to inform the L2PcInstance of its state and actions in progress.<BR><BR>
	 * <p>
	 ...
	 * <li> Send Server->Client packet MoveToPawn/CharMoveToLocation and AutoAttackStart to the L2PcInstance </li><BR><BR>
	 *
	 * @param object The L2Object to add to this.knownObjects and _knownPlayer
	 */
	@Override
	...
	/**
	 * Remove a L2Object from L2PcInstance this.knownObjects and this.knownPlayer (if necessary) and send Server-Client Packet DeleteObject to the L2PcInstance.<BR><BR>
	 *
	 * @param object The L2Object to remove from this.knownObjects and _knownPlayer
	 */
	@Override
