 ...
 * @author LittleHakor
 */
public class SigelPhoenixKnightController extends SigelController
{
	...
	@SuppressWarnings("unused")
	private static final int DIVINE_BLESSING_ID = 262;
	@SuppressWarnings("unused")
	private static final int ANGELIC_ICON_ID = 406;
	@SuppressWarnings("unused")
	private static final int TOUCH_OF_LIFE_ID = 341;
	
	public SigelPhoenixKnightController(final L2PcInstance player)
	{
		super(player);
	}
