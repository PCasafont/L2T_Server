...
public enum Stats
{
	...
	PSKILL_CRIT_DMG("pSkillCritDmg"), MAGIC_CRIT_DMG("mCritDmg"), MAGIC_CRIT_DMG_ADD("mCritDmgAdd"), MAGIC_CRIT_ATTACK("mCritAtk"), MOMENTUM_POWER("momentumPower"), MOMENTUM_CRIT_RATE("momentumCritRate"), NORMAL_ATK_DMG("normalAtkDmg"),
	...
	// ACCURACY & RANGE
	ACCURACY_COMBAT("accCombat"), ACCURACY_MAGIC("accMagic"), POWER_ATTACK_RANGE("pAtkRange"), MAGIC_ATTACK_RANGE("mAtkRange"), POWER_ATTACK_ANGLE("pAtkAngle"), ATTACK_COUNT_MAX("atkCountMax"),
	
	// Run speed, walk & escape speed are calculated proportionally, magic speed is a buff
	RUN_SPEED("runSpd"), WALK_SPEED("walkSpd"),
	
	// Position-based stats
	CRITICAL_RATE_FRONT("frontCritRate"), CRITICAL_RATE_SIDE("sideCritRate"), CRITICAL_RATE_BEHIND("behindCritRate"), CRITICAL_DMG_FRONT("frontCritDmg"), CRITICAL_DMG_SIDE("sideCritDmg"), CRITICAL_DMG_BEHIND("behindCritDmg"),
	
	// BASIC STATS
	STAT_STR("STR"), STAT_CON("CON"), STAT_DEX("DEX"), STAT_INT("INT"), STAT_WIT("WIT"), STAT_MEN("MEN"), STAT_LUC("LUC"), STAT_CHA("CHA"),
	
	// Special stats, share one slot in Calculator
	
	// VARIOUS
	BREATH("breath"), FALL("fall"), AGGRESSION("aggression"), // locks a mob on tank caster
	AGGRESSION_PROF("aggressionProf"), AGGRESSION_DMG("aggressionDmg"), VALAKAS("valakas"),
	
	CRIT_VULN("critVuln"), // Resistance to Crit dmg in percent
	CRIT_ADD_VULN("critAddVuln"), // Resistance to Crit dmg in value (ex: +100 will be 100 more crit dmg, NOT 100% more)
	REFLECT_VULN("reflectVuln"), MAGIC_DAMAGE_VULN("magicDamVul"), MAGIC_CRIT_VULN("magicCritVuln"), // Resistace to Crit dmg in percent
	MAGIC_SUCCESS_RES("magicSuccRes"), MAGIC_FAILURE_RATE("magicFailureRate"), DEBUFF_IMMUNITY("debuffImmunity"), // "Bool" value, considered true if greater than 0
	BUFF_IMMUNITY("buffImmunity"), // "Bool" value, considered true if greater than 0
	BLOCK_RESURRECTION("blockResurrection"), //"Bool" value, considered true if greater than 0
	BLOCK_ESCAPE("blockEscape"), //"Bool" value, considered true if greater than 0
	IS_BEHIND("isBehind"), //"Bool" value, considered true if greater than 0
	INVUL_RADIUS("invulRadius"), // "Limited" invulnerability, attacks above this range will not affect you
	FIXED_DMG_VULN("fixedDmgVuln"), // From the rare fixed dmg skills such as Topaz's active
	...
	REFLECT_DAMAGE_PERCENT("reflectDam"), REFLECT_DEBUFFS("reflectDebuffs"), VENGEANCE_SKILL_MAGIC_DAMAGE("vengeanceMdam"), VENGEANCE_SKILL_PHYSICAL_DAMAGE("vengeancePdam"), ABSORB_DAMAGE_PERCENT("absorbDam"), TRANSFER_DAMAGE_PERCENT("transDam"), MANA_SHIELD_PERCENT("manaShield"), TRANSFER_DAMAGE_TO_PLAYER("transDamToPlayer"), ABSORB_MANA_DAMAGE_PERCENT("absorbDamMana"), DAMAGE_CAP("dmgCap"), PSKILL_CRIT_PER_DEX("pSkillCritPerDex"), SPD_PER_DEX("spdPerDex"),
	
	MAX_LOAD("maxLoad"),
	
	PATK_PLANTS("pAtk-plants"), PATK_INSECTS("pAtk-insects"), PATK_ANIMALS("pAtk-animals"), PATK_MONSTERS("pAtk-monsters"), PATK_DRAGONS("pAtk-dragons"), PATK_GIANTS("pAtk-giants"), PATK_MCREATURES("pAtk-magicCreatures"),
	
	PDEF_PLANTS("pDef-plants"), PDEF_INSECTS("pDef-insects"), PDEF_ANIMALS("pDef-animals"), PDEF_MONSTERS("pDef-monsters"), PDEF_DRAGONS("pDef-dragons"), PDEF_GIANTS("pDef-giants"), PDEF_MCREATURES("pDef-magicCreatures"),
	
	// ExSkill
	LEVEL("level"), INVENTORY_LIMIT("inventoryLimit"), WAREHOUSE_LIMIT("whLimit"), FREIGHT_LIMIT("FreightLimit"), P_SELL_LIMIT("PrivateSellLimit"), P_BUY_LIMIT("PrivateBuyLimit"), REC_D_LIMIT("DwarfRecipeLimit"), REC_C_LIMIT("CommonRecipeLimit"),
	...
	transformId("transformId"), TALISMAN_SLOTS("talisman"), JEWELRY_SLOTS("jewelry"), CLOAK_SLOT("cloak"),
	
	// Servitor Share
	OWNER_PATK("ownerPAtk"), OWNER_PDEF("ownerPDef"), OWNER_MATK("ownerMAtk"), OWNER_MDEF("ownerMDef"), OWNER_MAXHP("ownerMaxHp"), OWNER_MAXMP("ownerMaxMp"), OWNER_CRIT("ownerCrit"), OWNER_CRIT_DMG("ownerCritDmg"), OWNER_PATKSPD("ownerPAtkSpd"), OWNER_MATKSPD("ownerMAtkSpd"), OWNER_PVP_PVE("ownerPvPPvE"), // "Bool" value, considered true if greater than 0
