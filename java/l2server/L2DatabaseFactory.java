...
public class L2DatabaseFactory
{
	...
	private L2DatabaseFactory()
	{
		...
		try
		{
			...
			config.setAcquireRetryDelay(3000); // Waiting time before trying to acquire connection again, too short delay might slow down the db
	...
	{
		Log.info("During this session the connection pool initialized " + _gameDatabase.getTotalCreatedConnections() + " connections.");
