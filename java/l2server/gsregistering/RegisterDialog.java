...
public class RegisterDialog extends JDialog implements ActionListener
{
    ...
    public RegisterDialog(final GUserInterface owner)
    {
        ...
        final double rightSize = Math
                .max(_combo.getPreferredSize().getWidth(), btnCancel.getPreferredSize().getWidth());

        final double height = _combo.getPreferredSize().getHeight() + 4 * textPane.getPreferredSize()
                .getHeight() + btnSave.getPreferredSize().getHeight();
