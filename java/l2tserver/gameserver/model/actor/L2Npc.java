...
import l2tserver.gameserver.ai.L2NewbieHelperAI;
...
import l2tserver.gameserver.model.L2NpcAIData;
...
import l2tserver.gameserver.model.actor.instance.L2DoormenInstance;
import l2tserver.gameserver.model.actor.instance.L2FishermanInstance;
...
import l2tserver.gameserver.model.actor.instance.L2TeleporterInstance;
import l2tserver.gameserver.model.actor.instance.L2TrainerInstance;
import l2tserver.gameserver.model.actor.instance.L2WarehouseInstance;
import l2tserver.gameserver.model.actor.knownlist.NpcKnownList;
import l2tserver.gameserver.model.actor.stat.NpcStat;
import l2tserver.gameserver.model.actor.status.NpcStatus;
...
import l2tserver.gameserver.model.zone.type.L2TownZone;
...
import l2tserver.gameserver.network.serverpackets.ExChangeNpcState;
...
public class L2Npc extends L2Character
{
	...
	public void onRandomAnimation(int animationId)
	{
		...
		if (now - _lastSocialBroadcast > _minimalSocialInterval)
		{
			...
			broadcastPacket(new SocialAction(this.getObjectId(), animationId));
		}
	}
	...
	public boolean canInteract(L2PcInstance player)
	{
		...
		if (player.getInstanceId() != getInstanceId()
				&& getInstanceId() != player.getObjectId()
	...
	private final void showChatWindowCommon(L2PcInstance player, String val)
	{
		...
		else if (npcId == 40005)
		{
			...
			if (Config.isServer(Config.TENKAI))
				htm = "<tr><td align=center><button action=\"bypass -h npc_%objectId%_Delevel\" value=\"Delevel\"" +
						" width=200 height=31 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td></tr>";
			html.replace("%delevel%", htm);
		}
		else if (val.equals("6") && npcId == 40004)
		{
	...
	public void setIsInvisible(boolean b)
	{
		...
		for (L2Character chara : this.getKnownList().getKnownCharacters())
		{
			if (chara == null)
				continue;
