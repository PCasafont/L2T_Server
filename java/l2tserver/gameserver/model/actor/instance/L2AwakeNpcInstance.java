...
public final class L2AwakeNpcInstance extends L2Npc
{
	...
	public void showChatWindow(L2PcInstance player)
	{
		...
		String iHaveNothing = "<html><body>I have nothing to say to you<br>" +
				"<a action=\"bypass -h npc_" + getObjectId() + "_Quest\">Quest</a>" +
				"</body></html>";
	...
	{
		String className[] = {"Sigel Knight", "Tyrr Warrior", "Othell Rogue", "Yul Archer", "Feoh Wizard", "Iss Enchanter", "Wynn Summoner", "Aeore Healer"};
		String ancientHero[] = {"Abelius", "Spyros", "Ashagen", "Cranigg", "Leister", "Soltkrieg", "Nabiarov", "Lakcis"};
		String htmlText = "";
		htmlText += "<html><body scroll=\"no\"><table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"292\" height=\"358\" background=\"L2UI_CH3.refinewnd_back_Pattern\"><tr><td>";
		htmlText += "<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"292\" background=\"L2UI_CT1.HtmlWnd_DF_Texture" + className[classId - 139].split(" ")[1] + "\"><tr><td align=\"center\">";
		htmlText += "<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"272\" height=\"338\"><tr><td height=\"90\"></td></tr>";
		if (canAwake)
		{
			htmlText += "<tr><td align=\"center\">You are brave to take this road. Will you accept the help of the ancient hero " + ancientHero[classId - 139] + " and Awaken as an " + className[classId - 139] + "</td></tr>";
			htmlText += "<tr><td align=\"center\"><button value=\"Awaken\" action=\"bypass -h npc_" + getObjectId() + "_Awake " + classId + "\" width=200 height=30 back=\"L2UI_CT1.HtmlWnd_DF_Awake_Down\" fore=\"L2UI_CT1.HtmlWnd_DF_Awake\"></td></tr>";
		}
		else
		{
			htmlText += "<tr><td align=\"center\">It is not possible for you to Awaken as an " + className[classId - 139] + ". <br>";
			htmlText += "<font color=\"af9878\">(Only characters level 85 or above who have completed their 3rd class transfer and possess the Scroll of Afterlife may Awaken.)</font></td></tr>";
		}
