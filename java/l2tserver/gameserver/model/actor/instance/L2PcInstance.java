 ...
 */
package l2tserver.gameserver.model.actor.instance;
...
import l2tserver.gameserver.ItemsAutoDestroy;
...
import l2tserver.gameserver.ai.L2CharacterAI;
import l2tserver.gameserver.ai.L2PlayerAI;
import l2tserver.gameserver.ai.L2SummonAI;
import l2tserver.gameserver.cache.HtmCache;
import l2tserver.gameserver.cache.WarehouseCacheManager;
import l2tserver.gameserver.communitybbs.BB.Forum;
import l2tserver.gameserver.communitybbs.Manager.ForumsBBSManager;
...
import l2tserver.gameserver.datatables.CertificateSkillTable;
...
import l2tserver.gameserver.events.Curfew;
import l2tserver.gameserver.events.RankingKillInfo;
import l2tserver.gameserver.events.chess.ChessEvent;
import l2tserver.gameserver.events.chess.ChessEvent.ChessState;
import l2tserver.gameserver.events.instanced.EventInstance;
import l2tserver.gameserver.events.instanced.EventTeam;
import l2tserver.gameserver.events.instanced.EventTeleporter;
...
import l2tserver.gameserver.events.instanced.types.StalkedStalkers;
...
import l2tserver.gameserver.instancemanager.PlayerAssistsManager;
...
import l2tserver.gameserver.model.FishData;
import l2tserver.gameserver.model.L2Abnormal;
import l2tserver.gameserver.model.L2AccessLevel;
import l2tserver.gameserver.model.L2ArmorSet;
import l2tserver.gameserver.model.L2Clan;
import l2tserver.gameserver.model.L2ClanMember;
import l2tserver.gameserver.model.L2ContactList;
import l2tserver.gameserver.model.L2EnchantSkillLearn;
import l2tserver.gameserver.model.L2Fishing;
import l2tserver.gameserver.model.L2FlyMove;
import l2tserver.gameserver.model.L2ItemInstance;
import l2tserver.gameserver.model.L2Macro;
import l2tserver.gameserver.model.L2ManufactureItem;
import l2tserver.gameserver.model.L2ManufactureList;
import l2tserver.gameserver.model.L2Object;
import l2tserver.gameserver.model.L2Party;
import l2tserver.gameserver.model.L2PetData;
import l2tserver.gameserver.model.L2PetLevelData;
import l2tserver.gameserver.model.L2PremiumItem;
import l2tserver.gameserver.model.L2Radar;
import l2tserver.gameserver.model.L2RecipeList;
import l2tserver.gameserver.model.L2Request;
import l2tserver.gameserver.model.L2ShortCut;
import l2tserver.gameserver.model.L2Skill;
import l2tserver.gameserver.model.L2SkillLearn;
import l2tserver.gameserver.model.L2Spawn;
import l2tserver.gameserver.model.L2Transformation;
import l2tserver.gameserver.model.L2UIKeysSettings;
...
import l2tserver.gameserver.model.MacroList;
...
import l2tserver.gameserver.model.ShortCuts;
import l2tserver.gameserver.model.TradeList;
import l2tserver.gameserver.model.L2FlyMove.L2FlyMoveChoose;
import l2tserver.gameserver.model.L2FlyMove.L2FlyMoveOption;
...
import l2tserver.gameserver.model.actor.L2Vehicle;
import l2tserver.gameserver.model.actor.appearance.PcAppearance;
import l2tserver.gameserver.model.actor.knownlist.PcKnownList;
import l2tserver.gameserver.model.actor.position.PcPosition;
import l2tserver.gameserver.model.actor.stat.PcStat;
import l2tserver.gameserver.model.actor.status.PcStatus;
...
import l2tserver.gameserver.model.base.SubClass;
import l2tserver.gameserver.model.entity.Castle;
import l2tserver.gameserver.model.entity.Duel;
...
import l2tserver.gameserver.model.entity.ClanWarManager.ClanWar;
import l2tserver.gameserver.model.entity.ClanWarManager.ClanWar.WarState;
import l2tserver.gameserver.model.itemcontainer.Inventory;
import l2tserver.gameserver.model.itemcontainer.ItemContainer;
import l2tserver.gameserver.model.itemcontainer.PcAuction;
import l2tserver.gameserver.model.itemcontainer.PcInventory;
import l2tserver.gameserver.model.itemcontainer.PcRefund;
import l2tserver.gameserver.model.itemcontainer.PcWarehouse;
import l2tserver.gameserver.model.itemcontainer.PetInventory;
import l2tserver.gameserver.model.multisell.PreparedListContainer;
import l2tserver.gameserver.model.olympiad.HeroesManager;
import l2tserver.gameserver.model.olympiad.Olympiad;
import l2tserver.gameserver.model.olympiad.OlympiadGameManager;
import l2tserver.gameserver.model.olympiad.OlympiadGameTask;
...
import l2tserver.gameserver.model.zone.type.L2NoRestartZone;
...
import l2tserver.gameserver.network.serverpackets.AcquireSkillList;
import l2tserver.gameserver.network.serverpackets.ActionFailed;
import l2tserver.gameserver.network.serverpackets.ChangeWaitType;
...
import l2tserver.gameserver.network.serverpackets.ExAutoSoulShot;
...
import l2tserver.gameserver.network.serverpackets.ExDuelUpdateUserInfo;
import l2tserver.gameserver.network.serverpackets.ExFishingEnd;
import l2tserver.gameserver.network.serverpackets.ExFishingStart;
...
import l2tserver.gameserver.network.serverpackets.ExGetOnAirShip;
import l2tserver.gameserver.network.serverpackets.ExMentorList;
...
import l2tserver.gameserver.network.serverpackets.ExPrivateStoreSetWholeMsg;
import l2tserver.gameserver.network.serverpackets.ExSetCompassZoneCode;
import l2tserver.gameserver.network.serverpackets.ExSpawnEmitter;
...
import l2tserver.gameserver.network.serverpackets.ExTacticalSign;
import l2tserver.gameserver.network.serverpackets.ExUserCubics;
import l2tserver.gameserver.network.serverpackets.ExUserEffects;
import l2tserver.gameserver.network.serverpackets.ExUserLoad;
import l2tserver.gameserver.network.serverpackets.ExUserPaperdoll;
import l2tserver.gameserver.network.serverpackets.ExVitalityEffectInfo;
import l2tserver.gameserver.network.serverpackets.ExVoteSystemInfo;
import l2tserver.gameserver.network.serverpackets.ExWaitWaitingSubStituteInfo;
...
import l2tserver.gameserver.network.serverpackets.FriendStatusPacket;
import l2tserver.gameserver.network.serverpackets.GameGuardQuery;
import l2tserver.gameserver.network.serverpackets.GetOnVehicle;
...
import l2tserver.gameserver.network.serverpackets.L2GameServerPacket;
import l2tserver.gameserver.network.serverpackets.LeaveWorld;
...
import l2tserver.gameserver.network.serverpackets.NicknameChanged;
import l2tserver.gameserver.network.serverpackets.NpcHtmlMessage;
import l2tserver.gameserver.network.serverpackets.ObservationMode;
import l2tserver.gameserver.network.serverpackets.ObservationReturn;
import l2tserver.gameserver.network.serverpackets.PartySmallWindowUpdate;
import l2tserver.gameserver.network.serverpackets.PetInventoryUpdate;
import l2tserver.gameserver.network.serverpackets.PlaySound;
import l2tserver.gameserver.network.serverpackets.PlayerMultiSellList;
import l2tserver.gameserver.network.serverpackets.PledgeCrest;
import l2tserver.gameserver.network.serverpackets.PledgeShowMemberListDelete;
import l2tserver.gameserver.network.serverpackets.PledgeShowMemberListUpdate;
import l2tserver.gameserver.network.serverpackets.PrivateStoreListBuy;
import l2tserver.gameserver.network.serverpackets.PrivateStoreListSell;
import l2tserver.gameserver.network.serverpackets.PrivateStoreManageListBuy;
import l2tserver.gameserver.network.serverpackets.PrivateStoreManageListSell;
import l2tserver.gameserver.network.serverpackets.PrivateStoreMsgBuy;
...
import l2tserver.gameserver.network.serverpackets.RecipeShopMsg;
import l2tserver.gameserver.network.serverpackets.RecipeShopSellList;
import l2tserver.gameserver.network.serverpackets.RelationChanged;
import l2tserver.gameserver.network.serverpackets.Ride;
import l2tserver.gameserver.network.serverpackets.ServerClose;
import l2tserver.gameserver.network.serverpackets.SetupGauge;
import l2tserver.gameserver.network.serverpackets.ShortBuffStatusUpdate;
...
import l2tserver.gameserver.network.serverpackets.SkillList;
import l2tserver.gameserver.network.serverpackets.Snoop;
...
import l2tserver.gameserver.network.serverpackets.TargetSelected;
import l2tserver.gameserver.network.serverpackets.TargetUnselected;
import l2tserver.gameserver.network.serverpackets.TradeDone;
import l2tserver.gameserver.network.serverpackets.TradeOtherDone;
import l2tserver.gameserver.network.serverpackets.TradeStart;
...
import l2tserver.gameserver.stats.skills.L2SkillSiegeFlag;
import l2tserver.gameserver.stats.skills.L2SkillSummon;
import l2tserver.gameserver.stats.skills.L2SkillTrap;
...
import l2tserver.gameserver.util.FloodProtectors;
import l2tserver.gameserver.util.IllegalPlayerAction;
...
public class L2PcInstance extends L2Playable
{
	...
	private static final String RESTORE_CHAR_SUBCLASSES = "SELECT class_id,exp,sp,level,class_index,is_dual,certificates FROM character_subclasses WHERE charId=? ORDER BY class_index ASC";
	...
	private static final String UPDATE_CHAR_SUBCLASS = "UPDATE character_subclasses SET exp=?,sp=?,level=?,class_id=?,is_dual=?,certificates=? WHERE charId=? AND class_index =?";
	...
	private static final String RESTORE_CHAR_HENNAS = "SELECT slot,symbol_id,expireTime FROM character_hennas WHERE charId=? AND class_index=?";
	private static final String ADD_CHAR_HENNA = "INSERT INTO character_hennas (charId,symbol_id,slot,class_index,expireTime) VALUES (?,?,?,?,?)";
	...
	/** Active shots. */
	protected Set<Integer> _activeSoulShots = new CopyOnWriteArraySet<Integer>();
	...
	private L2Abnormal[] _eventSavedSummonEffects = new L2Abnormal[EVENT_SAVED_EFFECTS_SIZE]; // TODO for new summon system
	...
	public int getRelation(L2PcInstance target)
	{
		...
		{
			if ((target.getPledgeType() != L2Clan.SUBUNIT_ACADEMY || target.getLevel() > 70) && (getPledgeType() != L2Clan.SUBUNIT_ACADEMY || getLevel() > 70))
			{
	...
	{
		//Ertheias get his race skills at lvl 1
	...
	private void insertNewRecipeData(int recipeId, boolean isDwarf)
	{
		...
		catch (SQLException e)
		{
			if (Log.isLoggable(Level.SEVERE))
				Log.log(Level.SEVERE, "SQL exception while inserting recipe: "+recipeId+" from character "+getObjectId(), e);
		}
		finally
		{
	...
	private void deleteRecipeData(int recipeId, boolean isDwarf)
	{
		...
		{
			if (Log.isLoggable(Level.SEVERE))
				Log.log(Level.SEVERE, "SQL exception while deleting recipe: "+recipeId+" from character "+getObjectId(), e);
		}
		finally
		{
			L2DatabaseFactory.close(con);
	...
	public QuestState processQuestEvent(String quest, String event)
	{
		...
		if (qs != null) {
			if (getLastQuestNpcObject() > 0)
			{
				...
				if (object instanceof L2Npc && isInsideRadius(object, ((L2Npc)object).getInteractionDistance(), false, false))
				{
	...
	public void updateReputationForHunting(long exp, int sp)
	{
		...
		int expDivider = Config.REPUTATION_EXP_DIVIDER * lvlSq;
		int spDivider = Config.REPUTATION_SP_DIVIDER * lvlSq;
	...
	public void setClassId(int id)
	{
		...
		try
		{
			if (getLvlJoinedAcademy() != 0 && _clan != null && PlayerClassTable.getInstance().getClassById(id).getLevel() <= 76)
			{
	...
	public void rewardSkills()
	{
		...
		if (getExpertiseIndex() > 0)
		{
			...
			if (Config.DEBUG) Log.fine("awarded "+getName()+" with new expertise.");
			
		}
		else
		{
			removeSkill(239);
			if (Config.DEBUG) Log.fine("No skills awarded at lvl: "+lvl);
		}
	...
	public int giveAvailableSkills(boolean forceAll)
	{
		...
		while (skills.length > unLearnable)
		{
			...
			{
				if (s.getMinLevel() > getLevel() || (s.getMinLevel() >= 85 && !forceAll) || s.isRemember())
				{
					unLearnable++;
					continue;
				}
				...
				if (sk == null || ((sk.getId() == L2Skill.SKILL_DIVINE_INSPIRATION  || sk.getId() == L2Skill.SKILL_DIVINE_EXPANSION) && !Config.AUTO_LEARN_DIVINE_INSPIRATION && !isGM()))
				{
					unLearnable++;
					continue;
				}
	...
	public long getSp() { return getStat().getSp(); }
	...
	public boolean dropItem(String process, L2ItemInstance item, L2Object reference, boolean sendMessage)
	{
		...
		if (Config.AUTODESTROY_ITEM_AFTER * 1000 > 0 && Config.DESTROY_DROPPED_PLAYER_ITEM && !Config.LIST_PROTECTED_ITEMS.contains(item.getItemId()))
		{
	...
	public void setProtection(boolean protect)
	{
		if (Config.DEVELOPER && (protect || _protectEndTime > 0))
			Log.warning(getName() + ": Protection " + (protect?"ON " + (TimeController.getGameTicks() + Config.PLAYER_SPAWN_PROTECTION * TimeController.TICKS_PER_SECOND) :"OFF") + " (currently " + TimeController.getGameTicks() + ")");
		
		_protectEndTime = protect ? TimeController.getGameTicks() + Config.PLAYER_SPAWN_PROTECTION * TimeController.TICKS_PER_SECOND : 0;
	}
	
	public void setTeleportProtection(boolean protect)
	{
		if (Config.DEVELOPER && (protect || _teleportProtectEndTime > 0))
			Log.warning(getName() + ": Tele Protection " + (protect?"ON " + (TimeController.getGameTicks() + Config.PLAYER_TELEPORT_PROTECTION * TimeController.TICKS_PER_SECOND) :"OFF") + " (currently " + TimeController.getGameTicks() + ")");
		
		_teleportProtectEndTime = protect? TimeController.getGameTicks() + Config.PLAYER_TELEPORT_PROTECTION * TimeController.TICKS_PER_SECOND : 0;
	}
	...
	{
		_recentFakeDeathEndTime = protect ? TimeController.getGameTicks() + Config.PLAYER_FAKEDEATH_UP_PROTECTION * TimeController.TICKS_PER_SECOND : 0;
	}
	...
	/**
	 * 
	 * @see l2tserver.gameserver.model.actor.L2Character#enableSkill(l2tserver.gameserver.model.L2Skill)
	 */
	@Override
	...
	/**
	 * 
	 * @see l2tserver.gameserver.model.actor.L2Character#checkDoCastConditions(l2tserver.gameserver.model.L2Skill)
	 */
	@Override
	protected boolean checkDoCastConditions(L2Skill skill)
	{
		...
		switch (skill.getSkillType())
		{
			...
			case SUMMON:
			{
				...
				if (isInEvent() && _event.isType(EventType.LuckyChests))
				{
	...
	public void broadcastStatusUpdate(L2Character causer, StatusUpdateDisplay display)
	{
		...
		{
			if (Config.DEBUG)
				Log.fine("Send status for party window of " + getObjectId() + " (" + getName() + ") to his party. CP: " + getCurrentCp() + " HP: " + getCurrentHp() + " MP: " + getCurrentMp());
	 ...
	 *
	 *
	 * @see l2tserver.gameserver.model.actor.L2Playable#doDie(l2tserver.gameserver.model.actor.L2Character)
	 */
	@Override
	public boolean doDie(L2Character killer)
	{
		...
		if (killer != null)
		{
			...
			if (pk != null && pk.getClan() != null && getClan() != null && getClan() != pk.getClan() && !isAcademyMember() && !(pk.isAcademyMember())
					&& ((_clan.isAtWarWith(pk.getClanId()) && pk.getClan().isAtWarWith(_clan.getClanId())) || (isInSiege() && pk.isInSiege()))
					&& !pk.getIsInsideGMEvent() && !getIsInsideGMEvent() && !pk.isInEvent() && !isInEvent())
			{
				// 	when your reputation score is 0 or below, the other clan cannot acquire any reputation points
				if (getClan().getReputationScore() > 0)
				{
					pk.getClan().addReputationScore(Config.REPUTATION_SCORE_PER_KILL, false);
					SystemMessage sm = SystemMessage.getSystemMessage(SystemMessageId.BECAUSE_A_CLAN_MEMBER_OF_S1_WAS_KILLED_BY_C2_CLAN_REPUTATION_INCREASED_BY_1);
		...
		if (!isInEvent())
		{
			...
			else if (isAffected(L2EffectType.CHARMOFCOURAGE.getMask()) && this.isInSiege())
			{
				reviveRequest(this, null, false);
			}
		}
			...
			if (dropPercent > 0 && Rnd.get(100) < dropPercent)
			{
				...
				for (L2ItemInstance itemDrop : getInventory().getItems())
				{
					...
					if (
							...
							Arrays.binarySearch(Config.REPUTATION_NONDROPPABLE_ITEMS, itemDrop.getItemId()) >= 0 || // Item listed in the non droppable item listsd
							Arrays.binarySearch(Config.REPUTATION_NONDROPPABLE_PET_ITEMS, itemDrop.getItemId()) >= 0 || // Item listed in the non droppable pet item list
	...
	public void onKillUpdatePvPReputation(L2Character target)
	{
						...
						== Castle.TENDENCY_DARKNESS)))	//Castle condition should be moved to checkIfPvP ?
		{
			...
			{
				float expReward = targetPlayer.getDeathPenalty(targetPlayer.getClan() != null && targetPlayer.getClan().isAtWarWith(this.getClanId()));
				...
				if (expReward > 0)
				{
					...
					addAdena("PvP", Math.round(targetPlayer.getAdena()*0.05), targetPlayer, true);
					targetPlayer.reduceAdena("PvP", Math.round(targetPlayer.getAdena()*0.05), this, true);
				}
			}
			...
			if (!isInsideZone(ZONE_PVP) && !targetPlayer.isInsideZone(ZONE_PVP))
			{
				...
				{
					boolean war = getClan() != null
						&& getClan().isAtWarWith(targetPlayer.getClan())
			...
			if (targetPlayer.getReputation() < 0)	// Target player has karma
			{
				if (Config.REPUTATION_AWARD_PK_KILL)
				{
					...
					if (Config.isServer(Config.TENKAI))
					{
						...
						{
							addExpAndSp(Math.round(expReward/2), 0);
							addAdena("PvPK", (int)Math.round(targetPlayer.getAdena()*0.25), targetPlayer, true);
							targetPlayer.reduceAdena("PvPK", (int)Math.round(targetPlayer.getAdena()*0.25), this, true);
						}
					}
				}
	...
	public void increasePkKillsAndDecreaseReputation(L2Character target)
	{
		...
		if (target instanceof L2PcInstance && ((L2PcInstance)target).isInEvent())
			return;
	...
	{
		if (isInsideZone(ZONE_PVP) || isInEvent())
			return;
	...
	public void updatePvPStatus(L2Character target)
	{
		...
		if ((isInDuel() && playerTarget.getDuelId() == getDuelId())) return;
	...
	{
		return getActiveRequester() != null || _activeTradeList != null || _requestExpireTime > TimeController.getGameTicks();
	}
	...
	protected void reduceArrowCount(boolean bolts)
	{
		...
		else
		{
			...
			if (Config.DEBUG) Log.fine("removed arrows count");
			sendPacket(new ItemList(this,false));
			return;
		}
	...
	public void setAccessLevel(int level)
	{
		...
		else
		{
			...
			if (accessLevel == null)
			{
				...
				{
					Log.warning( "Tryed to set unregistered access level " + level + " to character " + getName() + ". Setting access level without privileges!" );
					_accessLevel = AccessLevels._userAccessLevel;
				}
			}
			else
	...
	private void storeCharBase()
	{
		...
		try
		{
			...
			int x = _observerMode ? _lastX : (_eventSavedPosition != null && isInEvent()) ? _eventSavedPosition.getX() : getX();
			int y = _observerMode ? _lastY : (_eventSavedPosition != null && isInEvent()) ? _eventSavedPosition.getY() : getY();
			int z = _observerMode ? _lastZ : (_eventSavedPosition != null && isInEvent()) ? _eventSavedPosition.getZ() : getZ();
			/*if (!_hasLoaded && level > 1) // The client didn't send EnterWorld
			{
				// Place at Talking Island
				x = -114328;
				y = 253357;
				z = -1545;
			}*/
			...
			statement.setDouble(2, getMaxHp());
			statement.setDouble(3, getCurrentHp());
			statement.setDouble(4, getMaxCp());
			...
			statement.setInt(13, x);
			statement.setInt(14, y);
			statement.setInt(15, z);
			...
			statement.setInt(24, _templateId);
			statement.setInt(25, getCurrentClass().getId());
			statement.setLong(26, getDeleteTimer());
			statement.setString(27, getTitle());
			statement.setInt(28, getTitleColor());
	...
	{
		if (!Config.STORE_SKILL_COOLTIME || isInEvent())
			return;
		...
		try
		{
			...
			while (rset.next())
			{
				...
				if (Config.SKILL_CHECK_ENABLE && (!isGM() || Config.SKILL_CHECK_GM))
				{
					...
					{
						Util.handleIllegalPlayerAction(this, "Player " + getName() + " has invalid skill " + skill.getName() + " ("+skill.getId() + "/" + skill.getLevelHash() + "), class:" + getCurrentClass().getName(), 1);
	...
	public boolean isAutoAttackable(L2Character attacker)
	{
		...
		if (attacker instanceof L2Playable)
		{
			...
			if (isInEvent()
					&& EventsManager.getInstance().isPlayerParticipant(cha.getObjectId()))
			{
				EventInstance attackerEvent = cha.getEvent();
				return _event.getConfig().isAllVsAll()
						|| (_event == attackerEvent && _event.getParticipantTeamId(getObjectId()) != _event.getParticipantTeamId(cha.getObjectId()));
			}
			
			if (isInEvent() && cha.isInEvent())
				return true;
	...
	{
		//if (isGM())
		//	sendMessage("Using Skill[" + skill.getName() + ":" + skill.getId() +"].");
	...
	private boolean checkUseMagicConditions(L2Skill skill, boolean forceUse, boolean dontMove)
	{
		...
		if ((isOutOfControl() || isParalyzed() || isStunned() || isSleeping()) && !skill.canBeUsedWhenDisabled())
		{
			sendPacket(ActionFailed.STATIC_PACKET);
			return false;
		}
		...
		if (target != this && target instanceof L2Playable && ((L2Playable)target).isAffected(L2EffectType.UNTARGETABLE.getMask()))
		{
			sendPacket(ActionFailed.STATIC_PACKET);
			return false;
		}
		...
		if (sklType == L2SkillType.SUMMON)
		{
			...
			{
				if (summonTemplate.Type.equalsIgnoreCase("L2SiegeSummon") && (!SiegeManager.getInstance().checkIfOkToSummon(this, false) && !FortSiegeManager.getInstance().checkIfOkToSummon(this, false)))
					return false;
			}
		}
		...
		if (skill.isOffensive())
		{
			...
			if (target != this && !target.isAttackable() && !getAccessLevel().allowPeaceAttack())
			{
	...
	public boolean checkPvpSkill(L2Object target, L2Skill skill, boolean srcIsSummon)
	{
		...
		)
		{
			...
			if (skill.isPvpSkill()) // pvp skill
			{
				...
				{
					if (getClan().isAtWarWith(((L2PcInstance)target).getClanId()) && ((L2PcInstance)target).getClan().isAtWarWith(getClanId()))
				...
				if (
						...
						((L2PcInstance)target).getReputation() >= 0			 //   target has no negative reputation
				)
					return false;
			}
					...
					|| (skilldatpet != null && !skilldatpet.isCtrlPressed() && skill.isOffensive() && srcIsSummon))
			{
				...
				if (
						((L2PcInstance)target).getPvpFlag() == 0 &&			 //   target's pvp flag is not set and
						((L2PcInstance)target).getReputation() >= 0          //   target has no karma
				)
					return false;
			}
		}
					...
					if (magic)
					{
						if (!summon)
						{
							switch(itemId)
							{
								...
								case 22081: case 9194: case 9195:
								case 19441: case 19442: case 22434:
	...
	public void setHero(boolean hero)
	{
		...
		{
			broadcastPacket(new SocialAction(this.getObjectId(), 20016));
	...
	public boolean addSubClass(int classId, int classIndex)
	{
		...
		try
		{
			...
			if (getRace() == Race.Ertheia)
			{
				...
				newClass.setLevel((byte)85);
				newClass.setExp(Experience.getAbsoluteExp(85));
			}
			...
			{
				Log.log(Level.WARNING, "WARNING: Could not add character sub class for " + getName() + ": " + e.getMessage(), e);
				return false;
			}
			finally
			{
	...
	public boolean modifySubClass(int classIndex, int newClassId)
	{
		...
		{
			int oldClassId = 0;
			SubClass sub = getSubClasses().get(classIndex);
			if (sub != null)
				oldClassId = sub.getClassId();
			else
			{	
				Log.warning("modifySubClass: " + getName() + " has requested to modify sub class index " + classIndex + " from class ID " + oldClassId + " to " + newClassId + ".");
				return false;
			}
			...
			{
				Log.log(Level.WARNING, "Could not modify sub class for " + getName() + " to class index " + classIndex + ": " + e.getMessage(), e);
	...
	public boolean setActiveClass(int classIndex)
	{
		...
		try
		{
			...
			broadcastPacket(new SocialAction(this.getObjectId(), SocialAction.LEVEL_UP));
			sendPacket(new SkillCoolTime(this));
			sendPacket(new ExStorageMaxCount(this));
	...
	private synchronized void cleanup()
	{
		...
		try
		{
			...
			{
				int team = HandysBlockCheckerManager.getInstance().getHolder(_handysBlockCheckerEventArena).getPlayerTeam(this);
				HandysBlockCheckerManager.getInstance().removePlayer(this, this._handysBlockCheckerEventArena, team);
				if (getTeam() > 0 )
				{
					...
					this.setInsideZone(L2Character.ZONE_PVP, false);
					// Teleport Back
	...
	public final void sendDamageMessage(L2Character target, int damage, boolean mcrit, boolean pcrit, boolean miss)
	{
		...
		if ((target.isInvul(this) && !(target instanceof L2Npc))
				|| (target.getFaceoffTarget() != null
				&& target.getFaceoffTarget() != this))
	...
	protected void stopFeed()
	{
		synchronized (this)
		{
			if (_mountFeedTask != null)
			{
				...
				_mountFeedTask = null;
				if (Config.DEBUG) Log.fine("Pet [#"+_mountNpcId+"] feed task stop");
			}
		}
	}
	...
	/* (non-Javadoc)
	 * @see l2tserver.gameserver.model.actor.L2Character#isMovementDisabled()
	 */
	@Override
	...
	public void summonLastSummons()
	{
		for (int petId : _lastSummons)
		{
			...
			{
				boolean canSummon = true;
				if (((L2SkillSummon)skill).getSummonPoints() > 0 && getSpentSummonPoints() + ((L2SkillSummon)skill).getSummonPoints() > getMaxSummonPoints())
					canSummon = false;
				...
				if (canSummon)
				{
					...
					L2SummonInstance summon = new L2SummonInstance(IdFactory.getInstance().getNextId(), npcTemplate, this, skill);
					...
					if (summon.getLevel() > Config.MAX_LEVEL)
					{
						...
						Log.warning("Summon ("+summon.getName()+") NpcID: "+summon.getNpcId()+" has a level above "+Config.MAX_LEVEL+". Please rectify.");
					}
					else
					{
	...
	public boolean isAtWarWithCastle(int castleId)
	{
		...
		return this.getClan().getWarList().contains(clanId);
	}
	...
	class HasMovedTask implements Runnable
	{
		public void run()
		{
			...
			if (isInEvent())
			{
				if (!_hasMoved && !isDead() && !event.isType(EventType.VIP)
						&& !event.isType(EventType.KingOfTheHill)
	...
	private void restoreBuff(L2Abnormal buff, L2Object[] targets)
	{
		...
		int effectCurTime = buff.getTime() - (TimeController.getGameTicks() - _eventSavedTime) / TimeController.TICKS_PER_SECOND;
	...
	public void confirmUseMobSummonItem(L2ItemInstance item)
	{
		...
		if (mobId == 0)
		{
			...
			if (target instanceof L2MonsterInstance && !(target instanceof L2ArmyMonsterInstance) && !(target instanceof L2ChessPieceInstance) && !(target instanceof L2EventGolemInstance) && !((L2MonsterInstance)target).isRaid()
					&& ((L2MonsterInstance)target).getCollisionHeight() < 49 && ((L2MonsterInstance)target).getCollisionRadius() < 29)
			{
			...
			else if (target instanceof L2MonsterInstance && (((L2MonsterInstance)target).getCollisionHeight() >= 50 || ((L2MonsterInstance)target).getCollisionRadius() >= 30))
			{
	...
	class MobPetSummonFinalizer implements Runnable
	{
		...
		public void run()
		{
			...
			setIsCastingNow(false);
			L2MobSummonInstance summon = new L2MobSummonInstance(IdFactory.getInstance().getNextId(), _npcTemplate, L2PcInstance.this, _item);
	...
	class StalkerHintsTask implements Runnable
	{
		...
		public void run()
		{
			if (!_stop && _level < 4 && isInEvent() && getEvent() instanceof StalkedStalkers)
			{
				_level++;
				((StalkedStalkers)L2PcInstance.this.getEvent()).stalkerMessage(L2PcInstance.this, _level);
				int nextHintTimer = 0;
				switch (_level)
				{
					case 1:
	...
	public boolean isCastingProtected()
	{
		return isCastingNow() && (getLastSkillCast() != null && (getLastSkillCast().getTargetType() == SkillTargetType.TARGET_HOLY
				|| getLastSkillCast().getTargetType() == SkillTargetType.TARGET_FLAGPOLE
	...
	public int getStrenghtPoints(boolean randomize)
	{
		...
		int strenghtPoints = getExpertiseIndex() * levelI + ((getLevel() - EXPERTISE_LEVELS[getExpertiseIndex()]) * levelI) / ((getExpertiseIndex() < 7 ? EXPERTISE_LEVELS[getExpertiseIndex() + 1] : 86) - EXPERTISE_LEVELS[getExpertiseIndex()]);
	...
	public void flyMoveStep(int stepId)
	{
		...
		sendPacket(fm);
		fmb.setInvisible(getAppearance().getInvisible());
	...
	public void removeMentor()
	{
		...
		try
		{
			...
			sm = SystemMessage.getSystemMessage(SystemMessageId.YOU_REACHED_LEVEL_86_SO_THE_MENTORING_RELATIONSHIP_WITH_YOUR_MENTOR_S1_CAME_TO_AN_END);
	...
	public void giveMentorBuff()
	{
		...
		{
			if (L2World.getInstance().getPlayer(objectId) != null && L2World.getInstance().getPlayer(objectId).isOnline())
			{
	...
	public String getInternalIP()
	{
		if (_internalIP == null)
		{
			if (getClient() != null && getClient().getTrace() != null)
				_internalIP = (getClient().getTrace()[0][0] + "." + getClient().getTrace()[0][1] + "." + getClient().getTrace()[0][2] + "." + getClient().getTrace()[0][3]);
			else
				return "";
		}
		return _internalIP;
	...
	public void storeCharFriendMemos()
	{
		...
		for (Map.Entry<Integer, String> friendMemo : _friendMemo.entrySet())
		{
			...
			{
				con = L2DatabaseFactory.getInstance().getConnection();
				PreparedStatement statement = con.prepareStatement("UPDATE character_friends SET memo=? WHERE charId=? AND friendId=? AND relation=0");
			...
			{
				Log.log(Level.WARNING, "Could not update character(" + getObjectId() + ") friend(" + friendMemo.getKey() + ") memo: "+ e.getMessage(), e);
			}
			finally
			{
				L2DatabaseFactory.close(con);
		...
		for (Map.Entry<Integer, String> blockMemo : _blockMemo.entrySet())
		{
			...
			{
				con = L2DatabaseFactory.getInstance().getConnection();
				PreparedStatement statement = con.prepareStatement("UPDATE character_friends SET memo=? WHERE charId=? AND friendId=? AND relation=1");
			...
			{
				Log.log(Level.WARNING, "Could not update character(" + getObjectId() + ") block(" + blockMemo.getKey() + ") memo: "+ e.getMessage(), e);
			}
			finally
			{
				L2DatabaseFactory.close(con);
	...
	public void captcha(String message)
	{
		...
		message +
		"<img src=\"Crest.crest_" + Config.SERVER_ID +"_" + imgId + "\" width=256 height=64><br>" +
	...
	public boolean onActionCaptcha(boolean increase)
	{
		...
		{
			sendPacket(new CreatureSay(0, Say2.TELL, "AntiBots", "Next time try to play without a bot or looking at what is happening on your screen."));
			Util.handleIllegalPlayerAction(this, "Player " + getName() + " didn't reply to the Captcha but tried to target a lot of times! Character being kicked and account locked.", IllegalPlayerAction.PUNISH_KICK);
	...
	public class CaptchaTask implements Runnable
	{
		...
		public void run()
		{
			if (/*_times == 0 ||*/ L2PcInstance.this.getTarget() instanceof L2Attackable
					 || L2PcInstance.this.isFishing())
			{
				//_times++;
				L2PcInstance.this.setBotLevel(0);
				L2PcInstance.this.captcha("Please, understand that this is to avoid cheaters on this server.<br>" +
	...
	public int getArmorEnchant()
	{
		...
		if (chest == null || chest.getArmorItem() == null
				|| chest.getArmorItem().getArmorSet() == null)
			return 0;
	...
	public void setAbilityPoints(int points)
	{
		...
		{
			Log.log(Level.WARNING, "Error found while storing " + getName() + "'s ability points: " + e.getMessage(), e);
		}
		finally
		{
			L2DatabaseFactory.close(con);
	...
	public boolean isMage()
	{
		...
		if (playerClass == 143 || (playerClass >= 166 && playerClass <= 170) || playerClass == 146 || (playerClass >= 179 && playerClass <= 181))
			return true;
		return false;
	}
	...
	{
		int playerClass = getClassId();
		if (playerClass == 140 || (playerClass >= 152 && playerClass <= 157) || playerClass == 141 || (playerClass >= 158 && playerClass <= 161) || playerClass == 142 || (playerClass >= 162 && playerClass <= 165)
				|| playerClass == 139 || (playerClass >= 148 && playerClass <= 151))
			return true;
		return false;
	}
	...
	{
		int playerClass = getClassId();
		if (playerClass == 144 || (playerClass >= 171 && playerClass <= 175))
			return true;
		return false;
	}
