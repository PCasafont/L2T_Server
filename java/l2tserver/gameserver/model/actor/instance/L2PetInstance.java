...
import l2tserver.gameserver.model.actor.stat.PetStat;
...
public class L2PetInstance extends L2Summon
{
				...
				else
				{
					if (getCurrentFed() == 0)
					{
						...
						if (Rnd.get(100) < 30)
						{
							...
							getOwner().sendPacket(sm);
							Log.info("Hungry pet ["+getTemplate().getName()+"]["+getLevel()+"] deleted for player: "+getOwner()+" Control Item Id :"+getControlObjectId());
							deleteMe(getOwner());
						}
					}
	...
	/* (non-Javadoc)
	 * @see l2tserver.gameserver.model.actor.L2Summon#getSoulShotsPerHit()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see l2tserver.gameserver.model.actor.L2Summon#getSpiritShotsPerHit()
	 */
	@Override
