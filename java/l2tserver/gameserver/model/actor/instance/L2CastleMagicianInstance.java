...
public class L2CastleMagicianInstance extends L2NpcInstance implements L2SquadTrainer
{
		...
		else if (command.equals("subskills"))
		{
			if (player.getClan() != null)
			{
				if (player.isClanLeader())
				{
					...
					{
						skilllist.addSkill(sus.getSkill().getId(), sus.getSkill().getLevelHash(), sus.getSkill().getLevelHash(), sus.getReputation(), 0);
					}
	...
	/* (non-Javadoc)
	 * @see l2tserver.gameserver.model.actor.L2SquadTrainer#showSubUnitSkillList(l2tserver.gameserver.model.actor.instance.L2PcInstance)
	 */
	@Override
