...
public class L2SummonInstance extends L2Summon
{
	...
	public L2SummonInstance(int objectId, L2NpcTemplate template, L2PcInstance owner, L2Skill skill)
	{
		...
		if (Config.DEBUG && (_itemConsumeCount != 0))
			Log.warning("L2SummonInstance: Item Consume ID: " + _itemConsumeId + ", Count: " + _itemConsumeCount + ", Rate: " + _itemConsumeSteps + " times.");
		if (Config.DEBUG)
	 ...
	 *
	 * @see l2tserver.gameserver.model.actor.L2Character#doCast(l2tserver.gameserver.model.L2Skill)
	 */
	@Override
