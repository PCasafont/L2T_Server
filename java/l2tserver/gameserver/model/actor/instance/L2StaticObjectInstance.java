...
import l2tserver.gameserver.model.actor.knownlist.StaticObjectKnownList;
import l2tserver.gameserver.model.actor.stat.StaticObjStat;
import l2tserver.gameserver.model.actor.status.StaticObjStatus;
import l2tserver.gameserver.network.serverpackets.ShowTownMap;
...
public class L2StaticObjectInstance extends L2Character
{
	...
	/* (non-Javadoc)
	 * @see l2tserver.gameserver.model.L2Object#isAttackable()
	 */
	@Override
