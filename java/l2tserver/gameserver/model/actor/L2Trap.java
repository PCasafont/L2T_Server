...
import l2tserver.gameserver.model.actor.knownlist.TrapKnownList;
import l2tserver.gameserver.model.quest.Quest;
import l2tserver.gameserver.model.quest.Quest.TrapAction;
...
public class L2Trap extends L2Character
{
	...
	/**
	 * 
	 * @see l2tserver.gameserver.model.actor.L2Character#getKnownList()
	 */
	@Override
	...
	/**
	 * 
	 * @see l2tserver.gameserver.model.actor.L2Character#onDecay()
	 */
	@Override
	public void onDecay()
	{
	...
	/**
	 * 
	 * @see l2tserver.gameserver.model.actor.L2Character#doDie(l2tserver.gameserver.model.actor.L2Character)
	 */
	@Override
	...
	/**
	 * 
	 * @see l2tserver.gameserver.model.actor.L2Character#getActiveWeaponInstance()
	 */
	@Override
	...
	/**
	 * 
	 * @see l2tserver.gameserver.model.actor.L2Character#getActiveWeaponItem()
	 */
	@Override
	...
	/**
	 * 
	 * @see l2tserver.gameserver.model.actor.L2Character#getLevel()
	 */
	@Override
	public int getLevel()
	{
	...
	/**
	 * 
	 * @see l2tserver.gameserver.model.actor.L2Character#getTemplate()
	 */
	@Override
	...
	/**
	 * 
	 * @see l2tserver.gameserver.model.actor.L2Character#getSecondaryWeaponInstance()
	 */
	@Override
	...
	/**
	 * 
	 * @see l2tserver.gameserver.model.actor.L2Character#getSecondaryWeaponItem()
	 */
	@Override
	...
	/**
	 * 
	 * @see l2tserver.gameserver.model.actor.L2Character#updateAbnormalEffect()
	 */
	@Override
