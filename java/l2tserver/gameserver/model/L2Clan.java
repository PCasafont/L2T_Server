...
import l2tserver.gameserver.model.itemcontainer.ClanWarehouse;
import l2tserver.gameserver.network.SystemMessageId;
import l2tserver.gameserver.network.serverpackets.CreatureSay;
import l2tserver.gameserver.network.serverpackets.ExSubPledgeSkillAdd;
...
import l2tserver.gameserver.network.serverpackets.PledgeReceiveSubPledgeCreated;
import l2tserver.gameserver.network.serverpackets.PledgeShowInfoUpdate;
import l2tserver.gameserver.network.serverpackets.PledgeShowMemberListAll;
import l2tserver.gameserver.network.serverpackets.PledgeShowMemberListDeleteAll;
...
import l2tserver.gameserver.network.serverpackets.PledgeSkillListAdd;
...
import l2tserver.gameserver.network.serverpackets.PledgeSkillList.SubPledgeSkill;
...
public class L2Clan
{
	...
	public void updateClanInDB()
	{
		...
		{
			con = L2DatabaseFactory.getInstance().getConnection();
			statement = con.prepareStatement("UPDATE clan_data SET clan_name=?,leader_id=?,ally_id=?,ally_name=?,reputation_score=?,ally_penalty_expiry_time=?,ally_penalty_type=?,char_penalty_expiry_time=?,dissolving_expiry_time=? WHERE clan_id=?");
