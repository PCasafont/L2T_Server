...
public class PcInventory extends Inventory
{
	...
	/**
	 * @see l2tserver.gameserver.model.itemcontainer.PcInventory#getAllItemsByItemId(int, boolean)
	 */
	...
	/**
	 * @see l2tserver.gameserver.model.itemcontainer.PcInventory#getAllItemsByItemId(int, int, boolean)
	 */
