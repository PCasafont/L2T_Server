...
import l2tserver.gameserver.network.serverpackets.ExDuelEnd;
import l2tserver.gameserver.network.serverpackets.ExDuelReady;
import l2tserver.gameserver.network.serverpackets.ExDuelStart;
...
public class Duel
{
	...
	public static class PlayerCondition
	{
		...
		private ArrayList<L2Abnormal> _debuffs;
