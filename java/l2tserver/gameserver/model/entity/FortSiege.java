 ...
 */
package l2tserver.gameserver.model.entity;
...
import l2tserver.gameserver.model.CombatFlag;
...
import l2tserver.gameserver.model.L2SiegeClan.SiegeClanType;
...
public class FortSiege implements Siegable
{
	...
	public class ScheduleEndSiegeTask implements Runnable
	{
		public void run()
		{
			...
			{
				Log.log(Level.WARNING, "Exception: ScheduleEndSiegeTask() for Fort: " + FortSiege.this._fort.getName() + " " + e.getMessage(), e);
			}
		}
	}
	...
	public class ScheduleStartSiegeTask implements Runnable
	{
		...
		public void run()
		{
			...
			{
				Log.log(Level.WARNING, "Exception: ScheduleStartSiegeTask() for Fort: " + _fortInst.getName() + " " + e.getMessage(), e);
			}
		}
	}
	...
	public class ScheduleSuspiciousMerchantSpawn implements Runnable
	{
		public void run()
		{
			...
			{
				Log.log(Level.WARNING, "Exception: ScheduleSuspicoiusMerchantSpawn() for Fort: " + FortSiege.this._fort.getName() + " " + e.getMessage(), e);
			}
		}
	}
	...
	public class ScheduleSiegeRestore implements Runnable
	{
		public void run()
		{
			...
			{
				Log.log(Level.WARNING, "Exception: ScheduleSiegeRestore() for Fort: " + FortSiege.this._fort.getName() + " " + e.getMessage(), e);
			}
		}
	}
	...
	public void endSiege()
	{
		if (getIsInProgress())
		{
			...
			ThreadPoolManager.getInstance().scheduleGeneral(new ScheduleSuspiciousMerchantSpawn(), Config.FS_MERCHANT_RESPAWN * 60 * 1000L); // Prepare 3hr task for suspicious merchant respawn
	...
	public void startSiege()
	{
		if (!getIsInProgress())
		{
			...
			_siegeEnd = ThreadPoolManager.getInstance().scheduleGeneral(new ScheduleEndSiegeTask(), Config.FS_SIEGE_DURATION * 60 * 1000l); // Prepare auto end task
		...
		if (_commanders != null && getFort() != null && _commanders.size() != 0)
		{
			...
			if (spawn != null)
			{
				...
				else if (_siegeRestore == null)
				{
					...
					_siegeRestore = ThreadPoolManager.getInstance().scheduleGeneral(new ScheduleSiegeRestore(), Config.FS_COUNTDOWN * 60 * 1000l);
				}
				else
					getFort().getSiege().announceToPlayer(SystemMessage.getSystemMessage(SystemMessageId.SEIZED_BARRACKS));
			}
			else
				Log.warning("FortSiege.killedCommander(): killed commander, but commander not registered for fortress. NpcId: " + instance.getNpcId() + " FortId: " + getFort().getFortId());
		}
	}
	...
	/* (non-Javadoc)
	 * @see l2tserver.gameserver.model.entity.Siegable#giveFame()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see l2tserver.gameserver.model.entity.Siegable#getFameFrequency()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see l2tserver.gameserver.model.entity.Siegable#getFameAmount()
	 */
	@Override
