...
import l2tserver.gameserver.FortUpdater;
import l2tserver.gameserver.ThreadPoolManager;
import l2tserver.gameserver.FortUpdater.UpdaterType;
...
import l2tserver.gameserver.model.zone.type.L2FortZone;
...
public class Fort
{
	...
	public class FortFunction
	{
		...
		public void dbSave()
		{
			...
			{
				Log.log(Level.SEVERE, "Exception: Fort.updateFunctions(int type, int lvl, int lease, long rate, long time, boolean addNew): " + e.getMessage(), e);
			}
			finally
			{
	...
	public static class ScheduleSpecialEnvoysDeSpawn implements Runnable
	{
		...
		public void run()
		{
			...
			{
				Log.log(Level.WARNING, "Exception: ScheduleSpecialEnvoysSpawn() for Fort " + _fortInst.getName() + ": " + e.getMessage(), e);
			}
		}
	}
