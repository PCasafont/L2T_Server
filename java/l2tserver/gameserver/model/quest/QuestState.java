 ...
 */
package l2tserver.gameserver.model.quest;
...
import l2tserver.gameserver.network.serverpackets.TutorialCloseHtml;
import l2tserver.gameserver.network.serverpackets.TutorialEnableClientEvent;
import l2tserver.gameserver.network.serverpackets.TutorialShowHtml;
import l2tserver.gameserver.network.serverpackets.TutorialShowQuestionMark;
...
public final class QuestState
{
	...
	public String set(String var, String val)
	{
		...
		if ("cond".equals(var))
		{
			...
			{
				Log.log(Level.WARNING, getPlayer().getName() + ", " + getQuestName() + " cond [" + val + "] is not an integer.  Value stored, but no packet was sent: " + e.getMessage(), e);
			}
		}
	 ...
	 * @link l2tserver.loginserver.serverpacket.QuestList
	 */
	...
	{
		getPlayer().addExpAndSp((int) getPlayer().calcStat(Stats.EXP_RATE, exp * Config.RATE_QUEST_REWARD_XP, null, null), (int) getPlayer().calcStat(Stats.SP_RATE, sp * Config.RATE_QUEST_REWARD_SP, null, null), false);
	}
