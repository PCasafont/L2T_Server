...
public class RegionBBSManager extends BaseBBSManager
{
	...
	private static Map<Integer, List<L2PcInstance>> _onlinePlayers = new ConcurrentHashMap<Integer, List<L2PcInstance>>();
	private static Map<Integer, Map<String, String>> _communityPages = new ConcurrentHashMap<Integer, Map<String, String>>();
