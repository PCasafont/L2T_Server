...
public enum Stats
{
	...
	CRITICAL_ATTACK("pCritAtk"), // this is another type for special critical damage mods - crit damage SA
	...
	MAGIC_CRIT_VULN("magicCritVuln"), // Resistace to Crit dmg in percent
	MAGIC_SUCCESS_RES("magicSuccRes"),
	MAGIC_FAILURE_RATE("magicFailureRate"),
	DEBUFF_IMMUNITY("debuffImmunity"), // "Bool" value, considered true if greater than 0
	...
	OWNER_PVP_PVE("ownerPvPPvE"),	// "Bool" value, considered true if greater than 0
