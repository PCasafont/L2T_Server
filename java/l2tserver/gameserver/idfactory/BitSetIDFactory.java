 ...
 */
package l2tserver.gameserver.idfactory;
...
import l2tserver.util.PrimeFinder;
...
public class BitSetIDFactory extends IdFactory
{
	...
	/**
	 * 
	 * @see l2tserver.gameserver.idfactory.IdFactory#releaseId(int)
	 */
	@Override
	...
	/**
	 * 
	 * @see l2tserver.gameserver.idfactory.IdFactory#getNextId()
	 */
	@Override
	...
	/**
	 * 
	 * @see l2tserver.gameserver.idfactory.IdFactory#size()
	 */
	@Override
