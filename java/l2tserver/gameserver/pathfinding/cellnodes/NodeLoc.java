 ...
 */
package l2tserver.gameserver.pathfinding.cellnodes;
...
public class NodeLoc extends AbstractNodeLoc
{
	...
	/**
	 * @see l2tserver.gameserver.pathfinding.AbstractNodeLoc#getX()
	 */
	@Override
	public int getX()
	{
	...
	/**
	 * @see l2tserver.gameserver.pathfinding.AbstractNodeLoc#getY()
	 */
	@Override
	public int getY()
	{
	...
	/**
	 * @see l2tserver.gameserver.pathfinding.AbstractNodeLoc#getZ()
	 */
	@Override
	public short getZ()
	{
	...
	/**
	 * @see l2tserver.gameserver.pathfinding.AbstractNodeLoc#getNodeX()
	 */
	@Override
	public int getNodeX()
	{
	...
	/**
	 * @see l2tserver.gameserver.pathfinding.AbstractNodeLoc#getNodeY()
	 */
	@Override
	public int getNodeY()
	{
