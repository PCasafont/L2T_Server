...
public class GeoEngine extends GeoData
{
	...
	//Public Methods
	/**
	 * @see l2tserver.gameserver.GeoData#getType(int, int)
	 */
	@Override
	...
	/**
	 * @see l2tserver.gameserver.GeoData#getHeight(int, int, int)
	 */
	@Override
	...
	/**
	 * @see l2tserver.gameserver.GeoData#getSpawnHeight(int, int, int, int, int)
	 */
	@Override
	...
	/**
	 * @see l2tserver.gameserver.GeoData#geoPosition(int, int)
	 */
	@Override
	...
	/**
	 * @see l2tserver.gameserver.GeoData#canSeeTarget(L2Object, Point3D)
	 */
	@Override
	...
	/**
	 * @see l2tserver.gameserver.GeoData#canSeeTarget(l2tserver.gameserver.model.L2Object, l2tserver.gameserver.model.L2Object)
	 */
	@Override
	...
	/**
	 * @see l2tserver.gameserver.GeoData#canSeeTargetDebug(l2tserver.gameserver.model.actor.instance.L2PcInstance, l2tserver.gameserver.model.L2Object)
	 */
	@Override
	...
	/**
	 * @see l2tserver.gameserver.GeoData#getNSWE(int, int, int)
	 */
	@Override
	...
	/**
	 * @see l2tserver.gameserver.GeoData#moveCheck(int, int, int, int, int, int, int)
	 */
	@Override
	...
	/**
	 * @see l2tserver.gameserver.GeoData#addGeoDataBug(l2tserver.gameserver.model.actor.instance.L2PcInstance, java.lang.String)
	 */
	@Override
	...
	private static short nGetHeight(int geox, int geoy, int z)
	{
			...
			//multilevel
		{
			...
			{
				Log.warning("Broken geofile (case1), region: " + region + " - invalid layer count: " + layers + " at: " + geox + " "
						+ geoy);
				return (short) z;
			}
	...
	private static short nGetSpawnHeight(int geox, int geoy, int zmin, int zmax, L2Spawn spawn)
	{
			...
			//multilevel
		{
			...
			if (layers <= 0 || layers > 125)
			{
				Log.warning("Broken geofile (case2), region: " + region + " - invalid layer count: " + layers + " at: " + geox + " "
						+ geoy);
				return (short) zmin;
			}
			while (layers > 0)
			...
			{
				if (Config.DEBUG)
					Log.warning("SpawnHeight Error - Couldnt find correct layer to spawn NPC - GeoData or Spawnlist Bug!: zmin: " + zmin
		...
		{
			if (Config.DEBUG)
				Log.warning("SpawnHeight Error - Spawnlist z value is wrong or GeoData error: zmin: " + zmin + " zmax: " + zmax
