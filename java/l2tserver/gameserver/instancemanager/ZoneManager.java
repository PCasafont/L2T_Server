...
import l2tserver.gameserver.model.zone.form.ZoneCuboid;
import l2tserver.gameserver.model.zone.form.ZoneCylinder;
import l2tserver.gameserver.model.zone.form.ZoneNPoly;
					...
					if (n.getName().equalsIgnoreCase("list"))
					{
						...
						for (XmlNode d : n.getChildren())
						{
							if (d.getName().equalsIgnoreCase("zone"))
							{
								...
								try
								{
									newZone = Class.forName("l2tserver.gameserver.model.zone.type.L2" + zoneType);
								}
