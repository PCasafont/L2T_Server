...
public class L2NpcWalkerAI extends L2CharacterAI implements Runnable
{
	...
	public void run()
	{
		...
		if (delay < 0)
		{
			...
			if (Config.DEVELOPER)
				Log.warning("Wrong Delay Set in Npc Walker Functions = " + delay + " secs, using default delay: " + DEFAULT_MOVE_DELAY + " secs instead.");
		}
	...
	{
		Log.warning("Npc Walker ID: " + getActor().getNpcId() + ": Blocked at route position [" + _currentPos + "], coords: " + blocked_at_pos.x + ", " + blocked_at_pos.y + ", " + blocked_at_pos.z + ". Teleporting to next point");
