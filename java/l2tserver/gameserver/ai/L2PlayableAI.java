...
public abstract class L2PlayableAI extends L2CharacterAI
{
	...
	/**
	 * @see l2tserver.gameserver.ai.L2CharacterAI#onIntentionAttack(l2tserver.gameserver.model.actor.L2Character)
	 */
	@Override
	...
	/**
	 * @see l2tserver.gameserver.ai.L2CharacterAI#onIntentionCast(l2tserver.gameserver.model.L2Skill, l2tserver.gameserver.model.L2Object)
	 */
	@Override
