 ...
 */
package l2tserver.gameserver.ai.aplayer;
...
public class L2AWarriorAI extends L2APlayerAI
{
	...
	private static final int OGRE_CRY = 10292;   // + P. Atk., P. Def. And M. Def. by 35% and P. Critical Damage and Max HP by 10%.
	private static final int PUMA_CRY = 10293;   // + P. Accuracy by 10 and Atk. Spd. by 20%, and decreases Critical Damage received by 40%.
	...
	{
		return new int[]{30267, 19698, 19699, 19700, 19701, 19702, 19464, 19463, 19458, 17623, 35570, 34860, 19462, 19454, 35809, 30311};
	}
