...
public final class ExGmViewCharacterInfo extends L2GameServerPacket
{
	...
	public ExGmViewCharacterInfo(L2PcInstance player)
	{
		...
		buffer.put((byte)(player.getPrivateStoreType() != L2PcInstance.STORE_PRIVATE_CUSTOM_SELL ? player.getPrivateStoreType() : L2PcInstance.STORE_PRIVATE_SELL));
		...
		short runSpd = (short)(player.getRunSpeed() / moveMultiplier);
		short walkSpd = (short)(player.getWalkSpeed() / moveMultiplier);
		buffer.putShort((short)18);
