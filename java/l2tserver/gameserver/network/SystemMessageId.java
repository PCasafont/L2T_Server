 ...
 */
package l2tserver.gameserver.network;
...
public final class SystemMessageId
{
	...
	*/
	 ...
	 */
	public static final SystemMessageId ONLY_CHARACTERS_OVER_LEVEL_76_WHO_CPMPLETED_3RD_CLASS_TRANSFER_MAY_BE_A_SPONSOR_OF_ACADEMY_TRAINEE;
	...
	*/
	...
	static
	{
		...
		IT_IS_AUTOMATICALLY_REJECTED_BECAUSE_YOUR_DECISION_TO_PARTICIPATE_WAS_NOT_WITHIN_THE_TIME_FRAME = new SystemMessageId(3448);
		...
		ONLY_CHARACTERS_OVER_LEVEL_76_WHO_CPMPLETED_3RD_CLASS_TRANSFER_MAY_BE_A_SPONSOR_OF_ACADEMY_TRAINEE = new SystemMessageId(3573);
		...
		S1_HAS_SUCCESSFULLY_HATCHED_THE_EGG_BY_CREATING_THE_PERFECT_TEMPERATURE_FOR_INCUBATION = new SystemMessageId(3724);
		...
		IN_S1_SECONDS_YOU_WILL_BE_MOVED_TO_WHERE_YOU_WERE_BEFORE_PARTICIPATING_IN_THE_CEREMONY_OF_CHAOS = new SystemMessageId(3749);
		...
		ONLY_PCS_WHO_ARE_ABOVE_LEVEL_40_HAVE_COMPLETED_SECOND_CLASS_TRANSFER_AND_BELONG_TO_A_CLAN_THAT_IS_ABOVE_LEVEL_5_CAN_SUMMON = new SystemMessageId(3752);
		ONLY_PCS_WHO_ARE_ABOVE_LEVEL_40_AND_HAVE_COMPLETED_SECOND_CLASS_TRANSFER_CAN_OBTAIN_INDIVIDUAL_FAME = new SystemMessageId(3753);
		...
		YOU_CAN_NO_LONGER_PARTICIPATE_IN_THE_CEREMONY_OF_CHAOS_AS_YOU_HAVE_CANCELLED_REGISTRATION_OR_FORFEITED_AFTER_ENTERING_THE_ARENA_30_TIMES_OR_MORE = new SystemMessageId(3788);
		...
		YOU_HAVE_BEEN_TRANSPORTED_OUT_OF_THE_CEREMONY_OF_CHAOS_AS_YOU_HAVE_FORFEITED_THE_MATCH = new SystemMessageId(3793);
		...
		IF_A_CHARACTER_DIES_WHEN_PK_IS_4_OR_HIGHER_THE_LOWER_THE_FAME_IS_THE_HIGHER_THE_ITEM_DROP_RATE_IS = new SystemMessageId(3816);
		...
		IF_YOU_WANT_FAME_AND_ECONOMIC_DEVELOPMENT_FOR_YOUR_CLAN_SELECT_A_REQUEST_FROM_ANY_OF_THE_3_GUILDS_AND_START_THE_CLAN_REQUEST = new SystemMessageId(3821);
		S1_HAS_BEEN_ACCEPTED = new SystemMessageId(3822);
		CLANS_ARE_BOOMING_WITH_THE_ACQUISITION_OF_INDIVIDUAL_REQUEST_POINTS_EARNED_THROUGH_PRIVATE_HUNTS_AND_CLAN_REQUEST_ACTIVITIES_DONE_WITH_YOUR_CLANMATES = new SystemMessageId(3823);
		...
		THE_GOAL_NUMBER_OF_REQUEST_POINTS_HAS_BEEN_REACHED_OR_NO_MORE_REDEEMING_IS_ALLOWED_TODAY = new SystemMessageId(3868);
		...
		EXCEPT_THE_VITALITY_BUFF_ALL_BUFFS_INCLUDING_ROSY_SEDUCTION_AND_ART_OF_SEDUCTION_WILL_BE_DELETED = new SystemMessageId(3890);
		...
		YOU_CANNOT_RECEIVE_THE_ITEM_S1_BECAUSE_YOUVE_EXCEEDED_THE_LIMIT_ON_THE_QUANTITY_AND_WEIGHT_OF_THE_INVENTORY = new SystemMessageId(3893);
		LEVEL_S1_OF_THE_EVENT_KALIELS_BLESSING_IS_S2_COMPLETED = new SystemMessageId(3894);
		YOU_CANNOT_GO_BECAUSE_THE_MAXIMUM_NUMBER_OF_PARTICIPANTS_IN_THE_CLAN_REQUEST_HAS_BEEN_EXCEEDED = new SystemMessageId(3895);
		THERES_A_NEW_CLAN_REQUEST_GET_IT_FROM_THE_CLAN_REQUEST_MANAGER = new SystemMessageId(3896);
		YOU_WILL_BE_AUTOMATICALLY_JOINED_IN_THE_EVENT_FOR_1_HOUR_30_MINUTES_AFTER_THE_SERVER_OPENS = new SystemMessageId(3897);
		...
		ONLY_THE_CLAN_LEADER_OR_SOMEONE_WITH_RANK_MANAGEMENT_AUTHORITY_MAY_REGISTER_THE_CLAN = new SystemMessageId(4031);
		...
		ONLY_THE_CLAN_LEADER_OR_SOMEONE_WITH_RANK_MANAGEMENT_AUTHORITY_MAY_CHANGE_CLAN_INFORMATION = new SystemMessageId(4035);
		...
		THE_CLAN_YOU_SELECTED_IS_NO_LONGER_TAKING_APPLICATIONS_AS_IT_HAS_TOO_MANY_APPLICANTS = new SystemMessageId(4041);
		S1S_CLAN_ENTRY_APPLICATION_HAS_BEEN_REJECTED = new SystemMessageId(4042);
		ENTERED_INTO_WAITING_LIST = new SystemMessageId(4043);
		YOU_MAY_ENTER_NAMES_INTO_THE_WAITING_LIST_AFTER_S1_MINUTES_DUE_TO_DELETING_FROM_THE_WAITING_LIST = new SystemMessageId(4044);
		...
		S1_CAN_NO_LONGER_PREEMPTIVELY_ATTACK_ANOTHER_PLAYER_EXCEPT_PLAYERS_WHOSE_NAMES_ARE_IN_PURPLE_OR_ARE_IN_CHAOTIC_STATE = new SystemMessageId(4072);
		...
		PLEASE_CHECK_FOR_ITEMS_YOU_OWN_IN_MY_CHARACTER__HOME_ON_THE_HOMEPAGE_AS_PAID_ITEMS_WILL_BE_DELETED = new SystemMessageId(4076);
		...
		CLAN_ENTRY_APPLICATION_DELETED_30_DAYS_AFTER_APPLICATION_WHICH_IS_S1_S2_S3_AT_630_AM = new SystemMessageId(4087);
		...
		WE_ARE_GIVING_OUT_PASSES_FOR_INACTIVE_PLAYERS_PLEASE_CLICK_OK_TO_GO_TO_THE_HOMEPAGE_FOR_YOUR_PASS = new SystemMessageId(4090);
		...
		INACTIVE_ACCOUNTS_WILL_RECEIVE_EQUIPMENT_AND_CONSUMABLES_FOR_THE_FIRST_CHARACTER_TO_LOG_IN_PER_SERVER = new SystemMessageId(4110);
		...
		S1_HAS_BEEN_RESTORED_TO_ITS_PREVIOUS_APPEARANCE_AS_ITS_TEMPORARY_MODIFICATION_HAS_EXPIRED = new SystemMessageId(4113);
		...
		S1S2_HAS_BEEN_RESTORED_TO_ITS_PREVIOUS_APPEARANCE_AS_ITS_TEMPORARY_MODIFICATION_HAS_EXPIRED = new SystemMessageId(4117);
		...
		YOU_HAVE_BEEN_ENTERED_ON_THE_WAITING_LIST_AGAIN_AS_THE_REPLACEMENT_PLAYER_DOES_NOT_FIT_THE_REQUIREMENTS = new SystemMessageId(4125);
		...
		WHEN_YOU_LOG_IN_WITH_A_NEW_ACCOUNT_A_NEW_ACCOUNT_ITEM_WILL_BE_GIVEN_TO_THE_FIRST_CHARACTER_TO_LOG_INTO_EACH_SERVER_FOR_1_WEEK = new SystemMessageId(4133);
		...
		LOWER_THE_PERFORMANCE_OF_THE_GAME_YOU_ARE_NOT_PLAYING_TO_DECREASE_LOAD_ON_THE_COMPUTER = new SystemMessageId(4702);
