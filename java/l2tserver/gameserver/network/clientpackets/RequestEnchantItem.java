...
import l2tserver.gameserver.datatables.EnchantItemTable.EnchantScroll;
import l2tserver.gameserver.datatables.EnchantItemTable.EnchantSupportItem;
import l2tserver.gameserver.model.L2ItemInstance;
import l2tserver.gameserver.model.L2Skill;
import l2tserver.gameserver.model.L2World;
import l2tserver.gameserver.model.actor.instance.L2PcInstance;
import l2tserver.gameserver.network.SystemMessageId;
import l2tserver.gameserver.network.serverpackets.EnchantResult;
			...
			if (success)
			{
				...
				if (Config.LOG_ITEM_ENCHANTS)
				{
					...
					try
					{
						...
						PreparedStatement statement = con.prepareStatement("INSERT INTO log_enchants(player_id, item_id, item_object_id, scroll, support_id, chance, time) VALUES(?,?,?,?,?,?,?)");
