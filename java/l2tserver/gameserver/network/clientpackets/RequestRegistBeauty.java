...
import l2tserver.gameserver.datatables.BeautyTable.BeautyInfo;
import l2tserver.gameserver.model.actor.instance.L2PcInstance;
import l2tserver.gameserver.network.serverpackets.ExResponseBeautyRegistPacket;
...
public final class RequestRegistBeauty extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if (styleInfo != null)
		{
			...
			activeChar.sendPacket(new ExResponseBeautyRegistPacket(activeChar.getAdena(), activeChar.getInventory().getInventoryItemCount(36308, 0), 1, _hair, _face, _hairColor));
