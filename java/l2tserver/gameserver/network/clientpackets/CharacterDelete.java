...
import l2tserver.gameserver.network.serverpackets.CharDeleteFail;
import l2tserver.gameserver.network.serverpackets.CharDeleteSuccess;
...
public final class CharacterDelete extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if (Config.DEBUG) Log.fine("deleting slot:" + _charSlot);
