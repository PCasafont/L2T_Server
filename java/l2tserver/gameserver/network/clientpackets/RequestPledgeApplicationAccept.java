...
import l2tserver.gameserver.network.serverpackets.AskJoinPledge;
...
public final class RequestPledgeApplicationAccept extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		{
			Message msg = new Message(_applicantId, "Clan Application Rejected", "Sorry, your clan application has been rejected.", SendBySystem.SYSTEM);
