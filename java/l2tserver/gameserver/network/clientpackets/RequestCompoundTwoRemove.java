...
import l2tserver.gameserver.network.serverpackets.ExCompoundTwoRemoveFail;
import l2tserver.gameserver.network.serverpackets.ExCompoundTwoRemoveOK;
...
public final class RequestCompoundTwoRemove extends L2GameClientPacket
{
	...
	{
		return "RequestCompoundTwoRemove";
	}
}
