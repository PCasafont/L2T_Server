...
public class RequestDispel extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if (!skill.canBeDispeled() || skill.isStayAfterDeath() || skill.isDebuff())
			return;
		if (skill.getTransformId() > 0 && (skill.getTargetType() != SkillTargetType.TARGET_SELF && skill.getTargetType() != SkillTargetType.TARGET_PARTY && skill.getSkillType() != L2SkillType.BUFF)) //LasTravel: Self/Party transformation buffs can be cancelled
			return;
