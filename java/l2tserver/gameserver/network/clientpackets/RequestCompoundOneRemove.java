...
import l2tserver.gameserver.network.serverpackets.ExCompoundOneRemoveFail;
import l2tserver.gameserver.network.serverpackets.ExCompoundOneRemoveOK;
...
public final class RequestCompoundOneRemove extends L2GameClientPacket
{
	...
	{
		return "RequestCompoundOneRemove";
	}
}
