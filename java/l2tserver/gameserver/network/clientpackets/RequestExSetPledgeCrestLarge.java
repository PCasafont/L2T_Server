...
import l2tserver.gameserver.network.serverpackets.ExSetPledgeEmblemAck;
		...
		if ((activeChar.getClanPrivileges() & L2Clan.CP_CL_REGISTER_CREST) == L2Clan.CP_CL_REGISTER_CREST)
		{
			...
			else
			{
				...
				if (_partId == 4)
				{
					...
					activeChar.sendPacket(new ExShowScreenMessage("Please be aware that if your emblem is inappropiate, your\n clan might be deleted and your accounts permanently banned.", 20000));
					updated = true;
				}
				else
