...
import l2tserver.gameserver.network.serverpackets.ExMentorAdd;
...
public class RequestMenteeAdd extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		{
			sm = SystemMessage.getSystemMessage(SystemMessageId.S1_ALREADY_HAS_MENTORING_RELATIONSHIP_WITH_ANOTHER_CHARACTER);
			sm.addCharName(mentee);
			activeChar.sendPacket(sm);
			return;
		}
