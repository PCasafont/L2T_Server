...
import l2tserver.gameserver.network.serverpackets.MultiSellList;
...
public class MultiSell implements Reloadable
{
	...
	public final void separateAndSend(String listName, L2PcInstance player, L2Npc npc, boolean inventoryOnly)
	{
		...
		if (template == null)
		{
			Log.warning("[MultiSell] can't find list: " + listName + " requested by player: " + player.getName() + ", npcId:" + (npc != null ? npc.getNpcId() : 0));
			return;
		}
