 ...
 */
package l2tserver.gameserver.taskmanager;

import static l2tserver.gameserver.taskmanager.TaskTypes.TYPE_NONE;
import static l2tserver.gameserver.taskmanager.TaskTypes.TYPE_SHEDULED;
import static l2tserver.gameserver.taskmanager.TaskTypes.TYPE_TIME;
...
import l2tserver.gameserver.taskmanager.tasks.TaskCleanUp;
import l2tserver.gameserver.taskmanager.tasks.TaskCustomTasks;
import l2tserver.gameserver.taskmanager.tasks.TaskDailyQuestClean;
import l2tserver.gameserver.taskmanager.tasks.TaskGlobalVariablesSave;
import l2tserver.gameserver.taskmanager.tasks.TaskJython;
import l2tserver.gameserver.taskmanager.tasks.TaskOlympiadSave;
import l2tserver.gameserver.taskmanager.tasks.TaskRaidPointsReset;
import l2tserver.gameserver.taskmanager.tasks.TaskRecom;
import l2tserver.gameserver.taskmanager.tasks.TaskScript;
import l2tserver.gameserver.taskmanager.tasks.TaskVitalityReset;
