 ...
 */
package l2tserver.gameserver.templates.chars;
...
import l2tserver.gameserver.model.L2MinionData;
import l2tserver.gameserver.model.L2NpcAIData;
import l2tserver.gameserver.model.L2RandomMinionData;
	...
	public void addQuestEvent(Quest.QuestEventType EventType, Quest q)
	{
		...
		else
		{
			...
			if (!EventType.isMultipleRegistrationAllowed())
			{
				...
				{
					Log.warning("Quest event not allowed in multiple quests.  Skipped addition of Event Type \"" + EventType + "\" for NPC \"" + Name + "\" and quest \"" + q.getName() + "\".");
				}
			}
			else
			{
