...
public class LuckyChests extends EventInstance
{
	...
	public void chestPoints(L2PcInstance playerInstance, int points)
	{
		...
		if (points == 1)
		{
			...
			team.increasePoints();
			cs = new CreatureSay(playerInstance.getObjectId(), Say2.TELL, playerInstance.getName(), "I have opened a chest that contained 1 point.");
		}
		else if (points == 5)
		{
			...
			for (int i = 0; i < 5; i++)
				team.increasePoints();
			cs = new CreatureSay(playerInstance.getObjectId(), Say2.TELL, playerInstance.getName(), "I have opened a chest that contained 5 points!");
		}
		else if (points == 20)
		{
			...
			for (int i = 0; i < 20; i++)
				team.increasePoints();
			cs = new CreatureSay(playerInstance.getObjectId(), Say2.TELL, playerInstance.getName(), "I have opened a chest that contained 20 points!!!");
		}
