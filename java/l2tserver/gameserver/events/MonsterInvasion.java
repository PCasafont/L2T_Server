...
public class MonsterInvasion
{
	...
	public void start()
	{
		...
		try
		{
			...
			switch (race)
			{
				case 1: types = 3; break;
				case 2: types = 4; break;
				case 3: types = 4; break;
				case 4: types = 4; break;
				case 5: types = 3; break;
				case 6: types = 4; break;
				case 7: types = 3; break;
				case 8: types = 2; break;
			}
	...
	public void onCommanderDeath()
	{
		...
		{
			if (_armySpawns[i] != null && _armySpawns[i].getNpc() != null)
				_armySpawns[i].getNpc().doDie(_armySpawns[i].getNpc());
		}
	...
	public void showInfo(L2PcInstance activeChar)
	{
		...
		"<title>Event</title>" +
		"<body>" +
		"<center><br><tr><td>Monster Invasion</td></tr><br>" +
		"<br>" +
