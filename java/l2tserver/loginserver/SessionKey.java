 ...
 * <p>A SessionKey is made up of two 8 bytes keys. One is send in the {@link l2tserver.loginserver.serverpacket.LoginOk LoginOk}
 * packet and the other is sent in {@link l2tserver.loginserver.serverpacket.PlayOk PlayOk}</p>
 * @author -Wooden-
 *
 */
