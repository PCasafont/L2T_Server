...
import l2tserver.loginserver.SessionKey;
import l2tserver.loginserver.network.serverpackets.L2LoginServerPacket;
import l2tserver.loginserver.network.serverpackets.LoginFail;
import l2tserver.loginserver.network.serverpackets.PlayFail;
import l2tserver.loginserver.network.serverpackets.LoginFail.LoginFailReason;
import l2tserver.loginserver.network.serverpackets.PlayFail.PlayFailReason;
import l2tserver.network.MMOClient;
import l2tserver.network.MMOConnection;
import l2tserver.network.SendablePacket;
import l2tserver.util.Rnd;
import l2tserver.util.crypt.LoginCrypt;
import l2tserver.util.crypt.ScrambledKeyPair;
...
public final class L2LoginClient extends MMOClient<MMOConnection<L2LoginClient>>
{
	...
	/**
	 * @see l2tserver.mmocore.interfaces.MMOClient#decrypt(java.nio.ByteBuffer, int)
	 */
	@Override
	...
	/**
	 * @see l2tserver.mmocore.interfaces.MMOClient#encrypt(java.nio.ByteBuffer, int)
	 */
	@Override
