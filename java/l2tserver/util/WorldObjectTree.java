...
public class WorldObjectTree<T extends L2Object> extends L2ObjectMap<T>
{
	...
	/**
	 * @see l2tserver.util.L2ObjectMap#size()
	 */
	@Override
	public int size()
	{
	...
	/**
	 * @see l2tserver.util.L2ObjectMap#isEmpty()
	 */
	@Override
	...
	/**
	 * @see l2tserver.util.L2ObjectMap#clear()
	 */
	@Override
	public void clear()
	{
	...
	/**
	 * @see l2tserver.util.L2ObjectMap#put(T)
	 */
	@Override
	...
	/**
	 * @see l2tserver.util.L2ObjectMap#remove(T)
	 */
	@Override
	...
	/**
	 * @see l2tserver.util.L2ObjectMap#get(int)
	 */
	@Override
	public T get(int id)
	{
	...
	/**
	 * @see l2tserver.util.L2ObjectMap#contains(T)
	 */
	@Override
	...
	/**
	 * @see l2tserver.util.L2ObjectMap#iterator()
	 */
	@Override
