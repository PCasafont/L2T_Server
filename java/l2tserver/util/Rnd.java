...
public final class Rnd
{
	...
	public static final class RandomContainer
	{
		 ...
		 * @see l2tserver.util.Rnd#nextDouble()
		 */
	...
	public static enum RandomType
	{
		...
		/**
		 * Like {@link l2tserver.util.Rnd.RandomType#UNSECURE_ATOMIC}.<br>
		 * Each thread has it`s own random instance.<br>
		 * Provides best parallel access speed.
		 * 
		 * @see l2tserver.util.Rnd.ThreadLocalRandom
		 */
		 ...
		 * 
		 * @see l2tserver.util.Rnd.NonAtomicRandom
		 */
		UNSECURE_VOLATILE
	}
	...
	/**
	 * @see l2tserver.util.Rnd#get(int n)
	 */
