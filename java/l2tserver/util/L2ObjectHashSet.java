...
implements Iterable<T>
{
	...
	/* (non-Javadoc)
	 * @see l2tserver.util.L2ObjectSet#size()
	 */
	@Override
	public int size()
	{
	...
	/* (non-Javadoc)
	 * @see l2tserver.util.L2ObjectSet#isEmpty()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see l2tserver.util.L2ObjectSet#clear()
	 */
	@Override
	@SuppressWarnings("unchecked")
	...
	/* (non-Javadoc)
	 * @see l2tserver.util.L2ObjectSet#put(T)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see l2tserver.util.L2ObjectSet#remove(T)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see l2tserver.util.L2ObjectSet#contains(T)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see l2tserver.util.L2ObjectSet#iterator()
	 */
	@Override
