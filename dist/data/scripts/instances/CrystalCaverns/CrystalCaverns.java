...
public class CrystalCaverns extends Quest {
	...
	private class CCWorld extends InstanceWorld {
		public Map<Npc, Boolean> npcList1 = new HashMap<Npc, Boolean>();
		public Npc tears;
		...
		public List<Npc> copys = new ArrayList<Npc>();
		public Map<Npc, CrystalGolem> crystalGolems = new HashMap<Npc, CrystalGolem>();
		...
		public Map<DoorInstance, Player> openedDoors = new HashMap<DoorInstance, Player>();
		public Map<Integer, Map<Npc, Boolean>> npcList2 = new HashMap<Integer, Map<Npc, Boolean>>();
		public Map<Npc, Npc> oracles = new HashMap<Npc, Npc>();
		public List<Npc> keyKeepers = new ArrayList<Npc>();
		public List<Npc> guards = new ArrayList<Npc>();
		public List<Npc> oracle = new ArrayList<Npc>();
		// baylor variables
		private List<Player> raiders = new ArrayList<Player>();
		private int raidStatus = 0;
		private long dragonClawStart = 0;
		private int dragonClawNeed = 0;
		private List<Npc> animationMobs = new ArrayList<Npc>();
		private Npc camera = null;
		private Npc baylor = null;
		private Npc alarm = null;
	...
	// Bosses (new IDs)
	private static final int TEARS = 25716; // 25534;
	private static final int TEARS_COPY = 25717; // 25535;
	private static final int KECHI = 25714; // 25532;
	...
	private static final int[] MOBLIST =
			{22279, 22280, 22281, 22282, 22283, 22285, 22286, 22287, 22288, 22289, 22293, 22294, 22295, 22296, 22297, 22305, 22306, 22307, 22416,
					22418, 22419, 22420};
	...
	private static final int[][] ordreOracle1 =
			{{32274, 147090, 152505, -12169, 31613}, {32275, 147090, 152575, -12169, 31613}, {32274, 147090, 152645, -12169, 31613},
					{32274, 147090, 152715, -12169, 31613}};

	private static final int[][] ordreOracle2 = {{32274, 149783, 152505, -12169, 31613},
			// {32274, 149783, 152575, -12169, 31613},
			{32274, 149783, 152645, -12169, 31613}, {32276, 149783, 152715, -12169, 31613}};

	private static final int[][] ordreOracle3 = {{32274, 152461, 152505, -12169, 31613},
	...
	private static int[][] SPAWNS =
			{{141842, 152556, -11814, 50449}, {141503, 153395, -11814, 40738}, {141070, 153201, -11814, 39292}, {141371, 152986, -11814, 35575},
					{141602, 154188, -11814, 24575}, {141382, 154719, -11814, 37640}, {141376, 154359, -11814, 12054},
					{140895, 154383, -11814, 37508}, {140972, 154740, -11814, 52690}, {141045, 154504, -11814, 50674},
					{140757, 152740, -11814, 39463}, {140406, 152376, -11814, 16599}, {140268, 152007, -11817, 45316},
					{139996, 151485, -11814, 47403}, {140378, 151190, -11814, 58116}, {140521, 150711, -11815, 55997},
					{140816, 150215, -11814, 53682}, {141528, 149909, -11814, 22020}, {141644, 150360, -11817, 13283}, {142048, 150695, -11815, 5929},
					{141852, 151065, -11817, 27071}, {142408, 151211, -11815, 2402}, {142481, 151762, -11815, 12876}, {141929, 152193, -11815, 27511},
	...
	private static int[][] FIRST_SPAWNS =
			{{22276, 148109, 149601, -12132, 34490}, {22276, 148017, 149529, -12132, 33689}, {22278, 148065, 151202, -12132, 35323},
					{22278, 147966, 151117, -12132, 33234}, {22279, 144063, 150238, -12132, 29654}, {22279, 144300, 149118, -12135, 5520},
					{22279, 144397, 149337, -12132, 644}, {22279, 144426, 150639, -12132, 50655}, {22282, 145841, 151097, -12132, 31810},
					{22282, 144387, 149958, -12132, 61173}, {22282, 145821, 149498, -12132, 31490}, {22282, 146619, 149694, -12132, 33374},
					{22282, 146669, 149244, -12132, 31360}, {22284, 144147, 151375, -12132, 58395}, {22284, 144485, 151067, -12132, 64786},
					{22284, 144356, 149571, -12132, 63516}, {22285, 144151, 150962, -12132, 664}, {22285, 146657, 151365, -12132, 33154},
					{22285, 146623, 150857, -12132, 28034}, {22285, 147046, 151089, -12132, 32941}, {22285, 145704, 151255, -12132, 32523},
					{22285, 145359, 151101, -12132, 32767}, {22285, 147785, 150817, -12132, 27423}, {22285, 147727, 151375, -12132, 37117},
					{22285, 145428, 149494, -12132, 890}, {22285, 145601, 149682, -12132, 32442}, {22285, 147003, 149476, -12132, 31554},
					{22285, 147738, 149210, -12132, 20971}, {22285, 147769, 149757, -12132, 34980}};

	// Emerald Square
	private static int[][] EMERALD_SPAWNS =
			{{22280, 144437, 143395, -11969, 34248}, {22281, 149241, 143735, -12230, 24575}, {22281, 147917, 146861, -12289, 60306},
					{22281, 144406, 147782, -12133, 14349}, {22281, 144960, 146881, -12039, 23881}, {22281, 144985, 147679, -12135, 27594},
					{22283, 147784, 143540, -12222, 2058}, {22283, 149091, 143491, -12230, 24836}, {22287, 144479, 147569, -12133, 20723},
					{22287, 145158, 146986, -12058, 21970}, {22287, 145142, 147175, -12092, 24420}, {22287, 145110, 147133, -12088, 22465},
					{22287, 144664, 146604, -12028, 14861}, {22287, 144596, 146600, -12028, 14461}, {22288, 143925, 146773, -12037, 10813},
					{22288, 144415, 147070, -12069, 8568}, {22288, 143794, 145584, -12027, 14849}, {22288, 143429, 146166, -12030, 4078},
					{22288, 144477, 147009, -12056, 8752}, {22289, 142577, 145319, -12029, 5403}, {22289, 143831, 146902, -12051, 9717},
					{22289, 143714, 146705, -12028, 10044}, {22289, 143937, 147134, -12078, 7517}, {22293, 143356, 145287, -12027, 8126},
					{22293, 143462, 144352, -12008, 25905}, {22293, 143745, 142529, -11882, 17102}, {22293, 144574, 144032, -12005, 34668},
					{22295, 143992, 142419, -11884, 19697}, {22295, 144671, 143966, -12004, 32088}, {22295, 144440, 143269, -11957, 34169},
					{22295, 142642, 146362, -12028, 281}, {22295, 143865, 142707, -11881, 21326}, {22295, 143573, 142530, -11879, 16141},
					{22295, 143148, 146039, -12031, 65014}, {22295, 143001, 144853, -12014, 0}, {22296, 147505, 146580, -12260, 59041},
					{22296, 149366, 146932, -12358, 39407}, {22296, 149284, 147029, -12352, 41120}, {22296, 149439, 143940, -12230, 23189},
					{22296, 147698, 143995, -12220, 27028}, {22296, 141885, 144969, -12007, 2526}, {22296, 147843, 143763, -12220, 28386},
					{22296, 144753, 143650, -11982, 35429}, {22296, 147613, 146760, -12271, 56296}};

	private static int[][] ROOM1_SPAWNS =
			{{22288, 143114, 140027, -11888, 15025}, {22288, 142173, 140973, -11888, 55698}, {22289, 143210, 140577, -11888, 17164},
					{22289, 142638, 140107, -11888, 6571}, {22297, 142547, 140938, -11888, 48556}, {22298, 142690, 140479, -11887, 7663}};

	private static int[][] ROOM2_SPAWNS =
			{{22303, 146276, 141483, -11880, 34643}, {22287, 145707, 142161, -11880, 28799}, {22288, 146857, 142129, -11880, 33647},
					{22288, 146869, 142000, -11880, 31215}, {22289, 146897, 140880, -11880, 19210}};

	private static int[][] ROOM3_SPAWNS =
			{{22302, 145123, 143713, -12808, 65323}, {22294, 145188, 143331, -12808, 496}, {22294, 145181, 144104, -12808, 64415},
					{22293, 144994, 143431, -12808, 65431}, {22293, 144976, 143915, -12808, 61461}};

	private static int[][] ROOM4_SPAWNS =
			{{22304, 150563, 142240, -12108, 16454}, {22294, 150769, 142495, -12108, 16870}, {22281, 150783, 141995, -12108, 20033},
					{22283, 150273, 141983, -12108, 16043}, {22294, 150276, 142492, -12108, 13540}};

	// Steam Corridor
	private static int[][] STEAM1_SPAWNS =
			{{22305, 145260, 152387, -12165, 32767}, {22305, 144967, 152390, -12165, 30464}, {22305, 145610, 152586, -12165, 17107},
					{22305, 145620, 152397, -12165, 8191}, {22418, 146081, 152847, -12165, 31396}, {22418, 146795, 152641, -12165, 33850}
	...
	private static int[][] STEAM2_SPAWNS =
			{{22306, 147740, 152767, -12165, 65043}, {22306, 148215, 152828, -12165, 970}, {22306, 147743, 152846, -12165, 64147},
	...
	private static int[][] STEAM3_SPAWNS =
			{{22307, 150735, 152316, -12145, 31930}, {22307, 150725, 152467, -12165, 33635}, {22307, 151058, 152316, -12146, 65342},
	...
	private static int[][] STEAM4_SPAWNS = {//{22308, 151707, 150199, -12165, 32859},{22308, 152091, 150140, -12165, 32938},
			...
			{22416, 151636, 150280, -12142, 36869}, {22416, 149893, 150232, -12165, 64258}, {22416, 149864, 150110, -12165, 65054},
			{22416, 151926, 150218, -12165, 31613}, {22420, 149986, 150051, -12165, 105}, {22420, 151970, 149997, -12165, 32170},
	...
	private boolean checkConditions(Player player) {
		...
		for (Player partyMember : party.getPartyMembers()) {
			...
			Item item = partyMember.getInventory().getItemByItemId(CONT_CRYSTAL);
			if (item == null) {
	...
	private boolean checkOracleConditions(Player player) {
		...
		for (Player partyMember : party.getPartyMembers()) {
			Item item = partyMember.getInventory().getItemByItemId(RED_CORAL);
			if (item == null) {
				SystemMessage sm = SystemMessage.getSystemMessage(SystemMessageId.C1_ITEM_REQUIREMENT_NOT_SUFFICIENT);
				sm.addPcName(partyMember);
				party.broadcastToPartyMembers(sm);
	...
	private boolean checkBaylorConditions(Player player) {
		...
		for (Player partyMember : party.getPartyMembers()) {
			Item item1 = partyMember.getInventory().getItemByItemId(BOSS_CRYSTAL_1);
			Item item2 = partyMember.getInventory().getItemByItemId(BOSS_CRYSTAL_2);
			Item item3 = partyMember.getInventory().getItemByItemId(BOSS_CRYSTAL_3);
	...
	private void Throw(Creature effector, Creature effected) {
		...
		if (Config.GEODATA > 0) {
			Location destiny = GeoData.getInstance().moveCheck(effected.getX(), effected.getY(), effected.getZ(), x, y, z, effected.getInstanceId());
			x = destiny.getX();
			y = destiny.getY();
		}
		effected.broadcastPacket(new FlyToLocation(effected, x, y, z, FlyType.THROW_UP));
	...
	protected int enterInstance(Player player, String template, teleCoord teleto) {
		...
		//New instance
			...
			log.info("Crystal Caverns started " + template + " Instance: " + instanceId + " created by player: " + player.getName());
			...
			if (player.getParty() == null) {
				...
				for (Player partyMember : party.getPartyMembers()) {
					...
					InstanceManager.getInstance()
							.setInstanceTime(partyMember.getObjectId(), INSTANCEID, System.currentTimeMillis() + INSTANCEPENALTY);
	...
	protected void runHall(CCWorld world) {
		...
		for (int[] spawn : SPAWNS) {
			Npc mob = addSpawn(CGMOBS[Rnd.get(CGMOBS.length)], spawn[0], spawn[1], spawn[2], spawn[3], false, 0, false, world.instanceId);
	...
	protected void runEmeraldSquare(CCWorld world) {
		...
		Map<Npc, Boolean> spawnList = new HashMap<Npc, Boolean>();
		for (int[] spawn : EMERALD_SPAWNS) {
			Npc mob = addSpawn(spawn[0], spawn[1], spawn[2], spawn[3], spawn[4], false, 0, false, world.instanceId);
	...
	protected void runEmeraldRooms(CCWorld world, int[][] spawnList, int room) {
		Map<Npc, Boolean> spawned = new HashMap<Npc, Boolean>();
	...
	public String onSkillSee(Npc npc, Player caster, Skill skill, WorldObject[] targets, boolean isPet) {
		...
		if (npc.getNpcId() >= 32275 && npc.getNpcId() <= 32277 && skill.getId() != 2360 && skill.getId() != 2369) {
		...
		} else if (npc.isInvul(caster) && npc.getNpcId() == BAYLOR && skill.getId() == 2360 && caster != null) {
			...
			if (tmpworld instanceof CCWorld) {
				...
				if (world.dragonClawStart + DRAGONCLAWTIME <= System.currentTimeMillis() || world.dragonClawNeed <= 0) {
					world.dragonClawStart = System.currentTimeMillis();
					world.dragonClawNeed = caster.getParty().getMemberCount() - 1;
				} else {
					world.dragonClawNeed--;
				}
				if (world.dragonClawNeed == 0) {
					npc.stopSkillEffects(5225);
					npc.broadcastPacket(new MagicSkillUse(npc, npc, 5480, 1, 4000, 0, 0));
					if (world.raidStatus == 3) {
						world.raidStatus++;
					}
				}
			}
		} else if (npc.isInvul(caster) && npc.getNpcId() == TEARS && skill.getId() == 2369 && caster != null) {
			InstanceWorld tmpworld = InstanceManager.getInstance().getWorld(npc.getInstanceId());
			if (tmpworld instanceof CCWorld) {
				CCWorld world = (CCWorld) tmpworld;
				if (caster.getParty() == null) {
	...
	public String onAdvEvent(String event, Npc npc, Player player) {
		...
		if (tmpworld instanceof CCWorld) {
			...
			if (event.equalsIgnoreCase("TeleportOut")) {
				...
				addSpawn(Rnd.get(10) < 5 ? 29116 : 29117,
						npc.getX(),
						npc.getY(),
						npc.getZ(),
						npc.getHeading(),
				...
				npc.broadcastPacket(new MagicSkillUse(npc, npc, 5402, 1, 2000, 0, 0));
				...
				for (int i = 0; i < 10; i++) {
					...
					Npc mob = addSpawn(29104, 153571 + x, 142075 + y, -12737, 0, false, 0, false, world.instanceId);
					mob.getAI().setIntention(CtrlIntention.AI_INTENTION_IDLE);
					world.animationMobs.add(mob);
				}
				...
				world.raidStatus = 0;
				for (Npc mob : world.animationMobs) {
					mob.doDie(mob);
				}
				world.animationMobs.clear();
				...
				if (world.baylor == null) {
					...
					if (nowHp < maxHp * 0.2 && world.raidStatus < 3 && npc.getFirstEffect(5224) == null && npc.getFirstEffect(5225) == null) {
						if (nowHp < maxHp * 0.15 && world.raidStatus == 2) {
							...
							npc.doCast(SkillTable.getInstance().getInfo(5225, 1));
							npc.broadcastPacket(new CreatureSay(npc.getObjectId(), 1, npc.getName(), "Demons King Beleth, give me power! Aaaaa!!!"));
							startQuestTimer("baylor_remove_invul", 30000, world.baylor, null);
						}
						...
						npc.setTarget(world.raiders.get(Rnd.get(world.raiders.size())));
				...
				List<WorldObject> crystals = new ArrayList<WorldObject>();
				for (WorldObject object : World.getInstance().getVisibleObjects(npc, 300)) {
					if (object instanceof Item && ((Item) object).getItemId() == CRYSTALFOOD) {
						crystals.add(object);
					}
				}
				int minDist = 300000;
				for (WorldObject crystal : crystals) {
					...
					if (d < minDist) {
						minDist = d;
						cryGolem.foodItem = (Item) crystal;
					}
				}
				if (minDist != 300000) {
				...
				if (cryGolem.foodItem == null || !cryGolem.foodItem.isVisible()) {
					...
					if (d1 < 10000 || d2 < 10000) {
						npc.broadcastPacket(new MagicSkillUse(npc, npc, 5441, 1, 1, 0, 0));
	...
	public String onKill(Npc npc, Player player, boolean isPet) {
		...
		if (tmpworld instanceof CCWorld) {
			...
			if (world.status == 2 && world.npcList1.containsKey(npc)) {
				...
				if (npc.getNpcId() == GK1) {
					((MonsterInstance) npc).dropItem(player, 9698, 1);
					runEmeraldSquare(world);
				} else if (npc.getNpcId() == GK2) {
					((MonsterInstance) npc).dropItem(player, 9699, 1);
					runSteamRooms(world, STEAM1_SPAWNS, 22);
					L2Party party = player.getParty();
					if (party != null) {
						for (Player partyMember : party.getPartyMembers()) {
				...
				if (checkKillProgress(0, npc, world)) {
					...
					switch (world.status) {
						...
						case 25:
							...
							Npc kechi = addSpawn(KECHI, 154069, 149525, -12158, 51165, false, 0, false, world.instanceId);
							startQuestTimer("checkKechiAttack", 1000, kechi, null);
							return "";
						default:
							log.warn(
									"CrystalCavern-SteamCorridor: status " + world.status + " error. OracleOrder not found in " + world.instanceId);
							return "";
					}
			...
			if (npc.getNpcId() == ALARMID) {
				world.baylor.removeSkill(5244);
				world.baylor.removeSkill(5245);
				world.alarm = null;
				if (world.baylor.getMaxHp() * 0.3 < world.baylor.getStatus().getCurrentHp()) {
					startQuestTimer("baylor_alarm", 40000, world.baylor, null);
				}
		...
		if (tmpworld instanceof CCWorld) {
			...
			if (npcId == CRYSTAL_GOLEM) {
				...
				if (world.status < 30 && checkBaylorConditions(player)) {
					...
					L2Party party = player.getParty();
					if (party == null) {
						world.raiders.add(player);
					} else {
						for (Player partyMember : party.getPartyMembers()) {
							int rnd = Rnd.get(100);
							partyMember.destroyItemByItemId("Quest",
									rnd < 33 ? BOSS_CRYSTAL_1 : rnd < 67 ? BOSS_CRYSTAL_2 : BOSS_CRYSTAL_3,
									1,
									partyMember,
									true);
							world.raiders.add(partyMember);
						}
					}
				} else {
					return "";
				...
				int radius = 150;
				int i = 0;
				int members = world.raiders.size();
				for (Player p : world.raiders) {
					...
					for (DoorInstance door : InstanceManager.getInstance().getInstance(world.instanceId).getDoors()) {
						if (door.getDoorId() == room + 24220000) {
							if (door.getOpen()) {
								...
								QuestState st = ((Player) character).getQuestState(qn);
								if (st == null) {
