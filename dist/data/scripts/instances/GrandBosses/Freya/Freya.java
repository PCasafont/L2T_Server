...
public class Freya extends L2AttackableAIScript {
	...
	private static final Location[] playerEnter =
			{new Location(114185, -112435, -11210), new Location(114183, -112280, -11210), new Location(114024, -112435, -11210),
					new Location(114024, -112278, -11210), new Location(113865, -112435, -11210), new Location(113865, -112276, -11210)};

	//Spawns
	private static final int[][] iceKnightAroundRoom =
			{{113845, -116091, -11168, 8264}, {113381, -115622, -11168, 8264}, {113380, -113978, -11168, -8224}, {113845, -113518, -11168, -8224},
					{115591, -113516, -11168, -24504}, {116053, -113981, -11168, -24504}, {116061, -115611, -11168, 24804},
					{115597, -116080, -11168, 24804}, {112942, -115480, -10960, 52}, {112940, -115146, -10960, 52}, {112945, -114453, -10960, 52},
					{112945, -114123, -10960, 52}, {116497, -114117, -10960, 32724}, {116499, -114454, -10960, 32724},
					{116501, -115145, -10960, 32724}, {116502, -115473, -10960, 32724}};

	private static final int[][] iceBreathingCenterRoom =
			{{114713, -115109, -11202, 16456}, {114008, -115080, -11202, 3568}, {114422, -115508, -11202, 12400}, {115023, -115508, -11202, 20016},
					{115459, -115079, -11202, 27936}, {114176, -114576, -11202, 16456}, {115264, -114576, -11202, 3568}};
		...
		if (wrld != null && wrld instanceof FreyaWorld) {
			...
			if (npc.getNpcId() == world.FirstFreyaId || npc.getNpcId() == world.LastFreyaId) {
				switch (skill.getId()) {
					...
					case 6275:
					case 6276:
						InstanceManager.getInstance().sendPacket(world.instanceId, new ExShowScreenMessage(1801111, 2, true, 5000));
						break;
				}
					...
					if (Rnd.get(100) < 10) {
						...
						InstanceManager.getInstance()
								.sendPacket(world.instanceId,
										new PlaySound(sound >= 10 ? "SystemMsg_e.freya_voice_" : "SystemMsg_e.freya_voice_0" + sound));
					}
				}
			}
		}
	...
	public final String onAdvEvent(String event, Npc npc, Player player) {
		...
		if (wrld != null && wrld instanceof FreyaWorld) {
			...
			if (event.equalsIgnoreCase("stage_1_opendoor")) {
				...
				startQuestTimer("stage_1_begin", ScenePlayerDataTable.getInstance().getVideoDuration(15) + 1000, npc, null);
				...
				InstanceManager.getInstance().sendPacket(world.instanceId, new ExShowScreenMessage(1300150, 2, true, 7000));

				startQuestTimer("stage_1_freyamove", 2000, world.Freya, null, false);
			} else if (event.equalsIgnoreCase("stage_1_freyamove")) {
				InstanceManager.getInstance().sendPacket(world.instanceId, new ExShowScreenMessage(1801097, 2, true, 5000));
				...
				startQuestTimer("stage_1_pause", ScenePlayerDataTable.getInstance().getVideoDuration(16) + 1000, npc, null);
				...
				InstanceManager.getInstance().sendPacket(world.instanceId, new ExShowScreenMessage(1300151, 2, true, 7000));
				...
				startQuestTimer("stage_3_begin", ScenePlayerDataTable.getInstance().getVideoDuration(17) + 1000, npc, null);
			} else if (event.equalsIgnoreCase("stage_3_begin")) {
				InstanceManager.getInstance().sendPacket(world.instanceId, new ExSendUIEventRemove());

				spawnMonuments(world);

				world.Freya = addSpawn(world.LastFreyaId, 114720, -117085, -11088, 15956, false, 0, false, world.instanceId);

				InstanceManager.getInstance().sendPacket(world.instanceId, new ExShowScreenMessage(1300152, 2, true, 7000));
	...
	public String onKill(Npc npc, Player player, boolean isPet) {
		...
		if (tmpworld instanceof FreyaWorld) {
			...
			if (npc.getNpcId() == world.GlakiasId) {
				...
				startQuestTimer("stage_4_finalscene", ScenePlayerDataTable.getInstance().getVideoDuration(19) + 5000, npc, null);
	...
	private final synchronized void enterInstance(Player player, int template_id) {
		...
		if (world != null) {
			...
			if (!debug && !InstanceManager.getInstance().checkInstanceConditions(player, template_id, minPlayers, 35, 77, maxLvl)) {
				return;
			}
