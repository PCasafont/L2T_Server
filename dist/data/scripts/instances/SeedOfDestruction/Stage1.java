...
public class Stage1 extends Quest {
	...
	private static final int[] ATTACKABLE_DOORS =
			{12240005, 12240006, 12240007, 12240008, 12240009, 12240010, 12240013, 12240014, 12240015, 12240016, 12240017, 12240018, 12240021,
					12240022, 12240023, 12240024, 12240025, 12240026, 12240028, 12240029, 12240030};
			...
			try {
				...
				switch (world.status) {
					case 0:
						...
						break;
					case 1:
						ExShowScreenMessage message1 = new ExShowScreenMessage(1,
								0,
								5,
								0,
								1,
					...
					case 3:
						...
						return true;
					case 4:
						ExShowScreenMessage message2 = new ExShowScreenMessage(1,
								0,
								5,
								0,
								1,
					...
					case 7:
						...
						break;
					case 8:
						ExShowScreenMessage message4 =
								new ExShowScreenMessage(1, 0, 5, 0, 1, 0, 0, false, 10000, 1, "Come out, warriors. Protect Seed of Destruction");
		...
		if (tmpworld instanceof SOD1World) {
			...
			if (event.equalsIgnoreCase("Spawn")) {
				...
				if (tmp.getCurrentHp() < tmp.getMaxHp()) {
					...
					ExShowScreenMessage message3 = new ExShowScreenMessage(1,
							0,
							5,
							0,
							1,
