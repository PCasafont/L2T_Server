				...
				if (player != null) {
					...
					if (clan != null) {
						try {
							...
							String htm = HtmCache.getInstance().getHtm(activeChar.getHtmlPrefix(), "admin/claninfo.htm");
							...
							msg.replace("%clan_has_castle%",
									clan.getHasCastle() > 0 ? CastleManager.getInstance().getCastleById(clan.getHasCastle()).getName() : "No");
							msg.replace("%clan_has_clanhall%",
									clan.getHasHideout() > 0 ? ClanHallManager.getInstance().getClanHallById(clan.getHasHideout()).getName() : "No");
							msg.replace("%clan_has_fortress%",
									clan.getHasFort() > 0 ? FortManager.getInstance().getFortById(clan.getHasFort()).getName() : "No");
