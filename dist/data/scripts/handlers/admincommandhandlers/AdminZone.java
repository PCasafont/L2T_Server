...
public class AdminZone implements IAdminCommandHandler {
	...
	private static void showHtml(Player activeChar) {
		...
		adminReply.replace("%PEACE%", activeChar.isInsideZone(CreatureZone.ZONE_PEACE) ? "<font color=\"LEVEL\">YES</font>" : "NO");
		adminReply.replace("%PVP%", activeChar.isInsideZone(CreatureZone.ZONE_PVP) ? "<font color=\"LEVEL\">YES</font>" : "NO");
		adminReply.replace("%SIEGE%", activeChar.isInsideZone(CreatureZone.ZONE_SIEGE) ? "<font color=\"LEVEL\">YES</font>" : "NO");
		adminReply.replace("%TOWN%", activeChar.isInsideZone(CreatureZone.ZONE_TOWN) ? "<font color=\"LEVEL\">YES</font>" : "NO");
		adminReply.replace("%CASTLE%", activeChar.isInsideZone(CreatureZone.ZONE_CASTLE) ? "<font color=\"LEVEL\">YES</font>" : "NO");
		adminReply.replace("%FORT%", activeChar.isInsideZone(CreatureZone.ZONE_FORT) ? "<font color=\"LEVEL\">YES</font>" : "NO");
		adminReply.replace("%NOHQ%", activeChar.isInsideZone(CreatureZone.ZONE_NOHQ) ? "<font color=\"LEVEL\">YES</font>" : "NO");
		adminReply.replace("%CLANHALL%", activeChar.isInsideZone(CreatureZone.ZONE_CLANHALL) ? "<font color=\"LEVEL\">YES</font>" : "NO");
		adminReply.replace("%LAND%", activeChar.isInsideZone(CreatureZone.ZONE_LANDING) ? "<font color=\"LEVEL\">YES</font>" : "NO");
		adminReply.replace("%NOLAND%", activeChar.isInsideZone(CreatureZone.ZONE_NOLANDING) ? "<font color=\"LEVEL\">YES</font>" : "NO");
		adminReply.replace("%NOSUMMON%", activeChar.isInsideZone(CreatureZone.ZONE_NOSUMMONFRIEND) ? "<font color=\"LEVEL\">YES</font>" : "NO");
		adminReply.replace("%WATER%", activeChar.isInsideZone(CreatureZone.ZONE_WATER) ? "<font color=\"LEVEL\">YES</font>" : "NO");
		adminReply.replace("%SWAMP%", activeChar.isInsideZone(CreatureZone.ZONE_SWAMP) ? "<font color=\"LEVEL\">YES</font>" : "NO");
		adminReply.replace("%DANGER%", activeChar.isInsideZone(CreatureZone.ZONE_DANGERAREA) ? "<font color=\"LEVEL\">YES</font>" : "NO");
		adminReply.replace("%NOSTORE%", activeChar.isInsideZone(CreatureZone.ZONE_NOSTORE) ? "<font color=\"LEVEL\">YES</font>" : "NO");
		adminReply.replace("%SCRIPT%", activeChar.isInsideZone(CreatureZone.ZONE_SCRIPT) ? "<font color=\"LEVEL\">YES</font>" : "NO");
