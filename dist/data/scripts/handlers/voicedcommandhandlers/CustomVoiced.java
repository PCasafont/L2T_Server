...
public class CustomVoiced implements IVoicedCommandHandler {
	...
	private void sendHiddenStats(Player player) {
		...
		html += getStatHtm("Momentum Critical Rate", player.calcStat(Stats.MOMENTUM_CRIT_RATE, 100, null, null) - 100, 0, true, "%");
		...
		html += getStatHtm("Front Critical Rate", player.calcStat(Stats.CRITICAL_RATE_FRONT, 100, null, null) - 100, 0, true, "%");
		html += getStatHtm("Front Critical Dmg", player.calcStat(Stats.CRITICAL_DMG_FRONT, 100, null, null) - 100, 0, true, "%");
		html += getStatHtm("Behind Critical Rate", player.calcStat(Stats.CRITICAL_RATE_BEHIND, 100, null, null) - 100, 0, true, "%");
		html += getStatHtm("Behind Critical Dmg", player.calcStat(Stats.CRITICAL_DMG_BEHIND, 100, null, null) - 100, 0, true, "%");
		html += getStatHtm("Side Critical Rate", player.calcStat(Stats.CRITICAL_RATE_SIDE, 100, null, null) - 100, 0, true, "%");
		html += getStatHtm("Side Critical Dmg", player.calcStat(Stats.CRITICAL_DMG_SIDE, 100, null, null) - 100, 0, true, "%");
		...
		html += getStatHtm("Big Blunt Vulnerability", player.calcStat(Stats.BIGBLUNT_WPN_VULN, 100, null, null) - 100, 0, true, "%");
		html += getStatHtm("Dagger Vulnerability", player.calcStat(Stats.DAGGER_WPN_VULN, 100, null, null) - 100, 0, true, "%");
		html += getStatHtm("Dual Dagger Vulnerability", player.calcStat(Stats.DUALDAGGER_WPN_VULN, 100, null, null) - 100, 0, true, "%");
		html += getStatHtm("Bow Vulnerability", player.calcStat(Stats.BOW_WPN_VULN, 100, null, null) - 100, 0, true, "%");
		html += getStatHtm("Crossbow Vulnerability", player.calcStat(Stats.CROSSBOW_WPN_VULN, 100, null, null) - 100, 0, true, "%");
