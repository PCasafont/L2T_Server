...
public class ClanPenalty implements IUserCommandHandler {
	...
	public boolean useUserCommand(int id, L2PcInstance activeChar) {
		...
		final StringBuilder htmlContent = StringUtil.startAppend(500,
				"<html><body>" + "<center><table width=270 border=0 bgcolor=111111>" + "<tr><td width=170>Penalty</td>" +
						"<td width=100 align=center>Expiration Date</td></tr>" + "</table><table width=270 border=0><tr>");
