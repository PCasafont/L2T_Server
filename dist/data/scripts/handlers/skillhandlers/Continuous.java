...
public class Continuous implements ISkillHandler {
	...
	private static final L2SkillType[] SKILL_IDS =
			{L2SkillType.BUFF, L2SkillType.DEBUFF, L2SkillType.CONT, L2SkillType.CONTINUOUS_DEBUFF, L2SkillType.UNDEAD_DEFENSE, L2SkillType.AGGDEBUFF,
					L2SkillType.FUSION};
		...
		for (L2Object obj : targets) {
			...
			if (acted) {
				...
				if (target instanceof L2PcInstance && effects.length > 0 &&
						(effects[0].canBeShared() || skill.getTargetType() == L2SkillTargetType.TARGET_SELF) && !skill.isToggle() &&
