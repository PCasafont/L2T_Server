	...
	public boolean useBypass(String command, Player activeChar, Npc target) {
		...
		if (command.startsWith("ChangeCharName")) {
			if (command.equalsIgnoreCase("ChangeCharName")) {
				String html = "<html>" + "<title>Tenkai</title>" + "<body>" + "<center><br><tr><td>Change Name</tr></td><br>" + "<br>" +
			...
			if (command.equalsIgnoreCase("ChangeClanName")) {
				String html = "<html>" + "<title>Tenkai</title>" + "<body>" + "<center><br><tr><td>Change Clan Name</tr></td><br>" + "<br>" +
