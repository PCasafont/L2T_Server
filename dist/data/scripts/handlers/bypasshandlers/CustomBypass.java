...
public class CustomBypass implements IBypassHandler {
	private static final String[] COMMANDS =
			{"titlecolor", "changesex", "changerace", "changeclanname", "changecharname", "namecolor", "increaseclanlevel", "removeClanPenalty",
	...
	public boolean useBypass(String command, Player player, Npc target) {
		...
		} else if (command.equalsIgnoreCase("removePlayerClanPenalty")) //From a player
		{
			...
			if (command.equalsIgnoreCase("changeclanname") || command.equalsIgnoreCase("changecharname")) {
				...
				sb.append("But I can help you. This is not a recommended option, I would suggest you to create another " + changeWhat.split(" ")[0] +
						", but if you insist that much... it will be " + price + " " +
				...
				sb.append("</center><br><Button ALIGN=LEFT ICON=\"NORMAL\" action=\"bypass -h npc_" + target.getObjectId() +
						"_Chat title_color\">Back</Button></body></html>");
