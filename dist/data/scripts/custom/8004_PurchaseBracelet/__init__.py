...
class Quest(JQuest):
    ...
    def onAdvEvent(self, event, npc, player):
        ...
        if not st: return
        if st.getQuestItemsCount(6471) >= 20 and st.getQuestItemsCount(5094) >= 50 and st.getQuestItemsCount(
                9814) >= 4 and st.getQuestItemsCount(9816) >= 5 and st.getQuestItemsCount(
            9817) >= 5 and st.getQuestItemsCount(9815) >= 3 and st.getQuestItemsCount(57) >= 7500000:
