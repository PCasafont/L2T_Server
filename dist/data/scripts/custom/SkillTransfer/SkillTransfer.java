...
public class SkillTransfer extends Quest {
	...
	private static final int NPCs[] =
			{30022, 30030, 30032, 30036, 30067, 30068, 30116, 30117, 30118, 30119, 30144, 30145, 30188, 30194, 30293, 30330, 30375, 30377, 30464,
					30473, 30476, 30680, 30701, 30720, 30721, 30858, 30859, 30860, 30861, 30864, 30906, 30908, 30912, 31280, 31281, 31287, 31329,
					31330, 31335, 31969, 31970, 31976, 32155, 32162};
	...
	private static final int[][][] SKILL_TRANSFER_TREE = {
			// Cardinal (97)
			{{1013, 32}, {1033, 3}, {1050, 2}, {1059, 3}, {1087, 3}, {1189, 3}, {1240, 3}, {1242, 3}, {1243, 6}, {1255, 2}, {1257, 3}, {1259, 4},
					{1268, 4}, {1273, 13}, {1303, 2}, {1304, 3}, {1392, 3}, {1393, 3}, {1397, 3}, {1531, 7}, {1539, 4}},
			// Eva's Saint (105)
			{{1016, 9}, {1018, 3}, {1034, 13}, {1042, 12}, {1049, 14}, {1059, 3}, {1075, 15}, {1077, 3}, {1189, 3}, {1218, 33}, {1240, 3}, {1242, 3},
					{1254, 6}, {1258, 4}, {1268, 4}, {1271, 1}, {1307, 3}, {1311, 6}, {1392, 3}, {1396, 10}, {1399, 5}, {1401, 11}, {1402, 5},
					{1418, 1}, {1531, 7}, {1539, 4}},
			// Shillen Saint (112)
			{{1016, 9}, {1020, 27}, {1028, 19}, {1033, 3}, {1034, 13}, {1042, 12}, {1043, 1}, {1044, 3}, {1049, 14}, {1050, 2}, {1075, 15}, {1087, 3},
					{1218, 33}, {1243, 6}, {1254, 6}, {1255, 2}, {1257, 3}, {1258, 4}, {1259, 4}, {1271, 1}, {1273, 13}, {1304, 3}, {1307, 3},
						...
						if (SKILL_TRANSFER_TREE[index][i][0] == s.getId()) {
							...
							if (count < 0) {
								Util.handleIllegalPlayerAction(player,
										"Player " + player.getName() + " has too many transfered skills or items, skill:" + s.getName() + " (" +
												s.getId() + "/" + s.getLevel() + "), class:" + player.getCurrentClass().getName(),
										1);
