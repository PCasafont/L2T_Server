...
public class BoatGludinRune implements Runnable {
	...
	private static final VehiclePathPoint[] GLUDIN_TO_RUNE =
			{new VehiclePathPoint(-95686, 155514, -3610, 150, 800), new VehiclePathPoint(-98112, 159040, -3610, 150, 800),
					new VehiclePathPoint(-104192, 160608, -3610, 200, 1800), new VehiclePathPoint(-109952, 159616, -3610, 250, 1800),
					new VehiclePathPoint(-112768, 154784, -3610, 290, 1800), new VehiclePathPoint(-114688, 139040, -3610, 290, 1800),
					new VehiclePathPoint(-115232, 134368, -3610, 290, 1800), new VehiclePathPoint(-113888, 121696, -3610, 290, 1800),
	...
	public BoatGludinRune(L2BoatInstance boat) {
		...
		GLUDIN_SOUND =
				new PlaySound(0, "itemsound.ship_arrival_departure", 1, boat.getObjectId(), GLUDIN_DOCK[0].x, GLUDIN_DOCK[0].y, GLUDIN_DOCK[0].z);
