				...
				if (npc.getAI().getIntention() == CtrlIntention.AI_INTENTION_ATTACK && ai0 == 0) {
					...
					if (((Attackable) npc).getMostHated() != null) {
						...
						if (quest0 > 0) {
							if (c_quest0 == null) {
								i0 = 0;
							} else if ((c_quest0.getX() - ai1) * (c_quest0.getX() - ai1) + (c_quest0.getY() - ai2) * (c_quest0.getY() - ai2) >
									1500 * 1500) {
								i0 = 1;
							} else {
								i0 = 0;
						...
						if (quest0 > 1) {
							if (c_quest1 == null) {
								i0 = 0;
							} else if ((c_quest1.getX() - ai1) * (c_quest1.getX() - ai1) + (c_quest1.getY() - ai2) * (c_quest1.getY() - ai2) >
									1500 * 1500) {
								i0 = 1;
							} else {
								i0 = 0;
						...
						if (quest0 > 2) {
							if (c_quest2 == null) {
								i0 = 0;
							} else if ((c_quest2.getX() - ai1) * (c_quest2.getX() - ai1) + (c_quest2.getY() - ai2) * (c_quest2.getY() - ai2) >
									1500 * 1500) {
								i0 = 1;
							} else {
								i0 = 0;
						...
						if (quest0 > 3) {
							if (c_quest3 == null) {
								i0 = 0;
							} else if ((c_quest3.getX() - ai1) * (c_quest3.getX() - ai1) + (c_quest3.getY() - ai2) * (c_quest3.getY() - ai2) >
									1500 * 1500) {
								i0 = 1;
							} else {
								i0 = 0;
						...
						if (quest0 > 4) {
							if (c_quest4 == null) {
								i0 = 0;
							} else if ((c_quest4.getX() - ai1) * (c_quest4.getX() - ai1) + (c_quest4.getY() - ai2) * (c_quest4.getY() - ai2) >
									1500 * 1500) {
								i0 = 1;
							} else {
								i0 = 0;
		...
		if (event.equalsIgnoreCase("1003")) {
			if (ai4 == 1) {
				for (int i = 0; i < Xcoords.length; i++) {
					addSpawn(pirates_zombie_captain_b,
							nextSpawn(Xcoords[i], Ycoords[i], Zcoords[i], 650),
							Rnd.get(65536),
							false,
				...
				for (int i = 0; i < Xcoords.length; i++) {
					addSpawn(doll_blader_b, nextSpawn(Xcoords[i], Ycoords[i], Zcoords[i], 650), Rnd.get(65536), false, 0)/* .setIsRaidMinion(true) */;
				}
