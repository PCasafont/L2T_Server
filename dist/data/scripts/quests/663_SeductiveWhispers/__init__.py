...
MOBS = [20674, 20678, 20954, 20955, 20956, 20957, 20958, 20959, 20960, 20961, 20962, 20974, 20975, 20976, 20996, 20997,
        ...
        if event == "Wilbert_IWantToPlay.htm":  # quest accepted
            ...
            if beads < 50 and round == 0:  # check for 50 beads when game just starts only (round=0)
                ...
                if random > WIN_ROUND_CHANCE:  # random value is in range [WIN_ROUND_CHANCE..100]
                    ...
                    if round == 6:
                        htmltext = htmltext.replace("MYPRIZE",
                                                    "675,000 adena, 1 essential ingredient for a B-grade weapon")
                    if round == 7:
                        htmltext = htmltext.replace("MYPRIZE",
                                                    "1,284,000 adena, 2 B-grade Enchant Weapon Scrolls, 2 B-grade Enchat Armor Scrolls")
