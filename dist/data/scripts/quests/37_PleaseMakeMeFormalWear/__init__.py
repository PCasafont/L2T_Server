...
class Quest(JQuest):
    ...
    def onEvent(self, event, st):
        ...
        if st.getState() != State.COMPLETED:
            if event == "30842-1.htm" and cond == 0:
                ...
                if st.getQuestItemsCount(MYSTERIOUS_CLOTH) and st.getQuestItemsCount(
                        JEWEL_BOX) and st.getQuestItemsCount(SEWING_KIT):
    ...
    def onTalk(self, npc, player):
        ...
        if npcId == 30842 and cond == 0:
            ...
            elif npcId == 31520 and st.getQuestItemsCount(MYSTERIOUS_CLOTH) and st.getQuestItemsCount(
                    JEWEL_BOX) and st.getQuestItemsCount(SEWING_KIT):
