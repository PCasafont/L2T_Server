...
# Rewards
REWARDS = [5529] + range(5532, 5540) + range(5541, 5549) + [8331] + range(8341, 8343) + [8346] + [8349] + range(8712,
                                                                                                                8723)
...
# Mobs
MOBS = [20670, 20671, 20954, 20956, 20958, 20959, 20960, 20964, 20969, 20967, 20970, 20971, 20974, 20975, 21001, 21003,
        21005, 21020, 21021, 21089, 21108, 21110, 21113, 21114, 21116]
MOB = {
    20670: 14,
    20671: 14,
    20954: 11,
    ...
    def onEvent(self, event, st):
        ...
        if event == "yes":
            ...
            if st.getQuestItemsCount(SI_ORE) >= REQUIRED_ORE:
                ...
                htmltext = bingo0
                grid = range(1,
                             10)  # random.sample(xrange(1,10),9) ... damn jython that makes me think that inefficient stuff
