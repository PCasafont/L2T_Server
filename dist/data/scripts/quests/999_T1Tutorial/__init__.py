        ...
        if qs != None:
            ...
            if event == "TimerEx_NewbieHelper":
                ...
                if st.getQuestItemsCount(item) and st.getInt("onlyone") == 0:
                    ...
                    if Ex <= 3:
                        qs.set("Ex", "4")
                    if st.getPlayer().getClassId() == classId1:
                        st.giveItems(gift1, count1)
                        if gift1 == SPIRITSHOT_NOVICE:
                            st.playTutorialVoice("tutorial_voice_027")
                        else:
                            st.playTutorialVoice("tutorial_voice_026")
                    elif st.getPlayer().getClassId() == classId2:
                        if gift2:
...
for startNpc in [30008, 30009, 30017, 30019, 30129, 30131, 30573, 30575, 30370, 30528, 30530, 30400, 30401, 30402,
                 30403, 30404, 30600, 30601, 30602, 30598, 30599, 32133, 32134, 32135]:
