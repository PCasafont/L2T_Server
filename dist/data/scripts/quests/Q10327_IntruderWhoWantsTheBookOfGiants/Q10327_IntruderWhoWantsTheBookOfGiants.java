	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player) {
		...
		if (npc.getNpcId() == pantheon) {
			if (event.equalsIgnoreCase("32972-03.htm")) {
				...
				st.set("guardId",
						String.valueOf(addSpawn(guard, -114710, 245457, -7968, 49152, false, 0, false, player.getObjectId()).getObjectId()));
				bookIds[0] = addSpawn(book, -113757, 244686, -7952, 0, false, 0, false, player.getObjectId()).getObjectId();
				bookIds[1] = addSpawn(book, -115672, 244683, -7952, 0, false, 0, false, player.getObjectId()).getObjectId();
				bookIds[2] = addSpawn(book, -114714, 245750, -7952, 0, false, 0, false, player.getObjectId()).getObjectId();
				bookIds[3] = addSpawn(book, -114706, 243605, -7952, 0, false, 0, false, player.getObjectId()).getObjectId();
