...
class Quest(JQuest):
    ...
    def onTalk(self, npc, player):
        ...
        if cond == 0:
            ...
            if st.getQuestItemsCount(ANTIDOTE) >= 2 and st.getQuestItemsCount(
                    RITRONS_FRUIT) == 4 and st.getQuestItemsCount(MOON_FACE_FLOWER) == 20 and st.getQuestItemsCount(
                LEECH_FLUIDS) == 10:
        ...
        if st.getInt("cond") == 1:
            ...
            if count < max:
                ...
                if numItems != 0:
                    ...
                    if st.getQuestItemsCount(RITRONS_FRUIT) == 4 and st.getQuestItemsCount(
                            MOON_FACE_FLOWER) == 20 and st.getQuestItemsCount(LEECH_FLUIDS) == 10:
                        st.set("cond", "2")
