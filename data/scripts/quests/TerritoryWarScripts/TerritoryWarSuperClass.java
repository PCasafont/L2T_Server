...
{
    private static Map<Integer, TerritoryWarSuperClass> _forTheSakeScripts =
            new HashMap<Integer, TerritoryWarSuperClass>();
    private static Map<Integer, TerritoryWarSuperClass> _protectTheScripts =
            new HashMap<Integer, TerritoryWarSuperClass>();
    private static Map<Integer, TerritoryWarSuperClass> _killTheScripts =
            new HashMap<Integer, TerritoryWarSuperClass>();
    ...
    public String onSkillSee(L2Npc npc, L2PcInstance caster, L2Skill skill, L2Object[] targets, boolean isPet)
    {
        if (Util.contains(targets, npc))
        {
            ...
            {
                if (TerritoryWarManager.getInstance().getTerritory(caster.getSiegeSide() - 80).getOwnedWardIds()
                        .size() >= 3)
                {
                ...
                {
                    for (TerritoryNPCSpawn wardSpawn : TerritoryWarManager.getInstance()
                            .getTerritory(ward.getOwnerCastleId()).getOwnedWard())
                    {
    ...
    public String onKill(L2Npc npc, L2PcInstance killer, boolean isPet)
    {
        if (npc.getNpcId() == CATAPULT_ID)
        {
            ...
            TerritoryWarManager.getInstance()
                    .announceToParticipants(new ExShowScreenMessage(Text[0], 10000), 135000, 13500);
