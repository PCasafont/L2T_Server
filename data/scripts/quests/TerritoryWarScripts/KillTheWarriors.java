...
public class KillTheWarriors extends TerritoryWarSuperClass
{
	...
	{
		super(qnu, qn1, qna);
		CLASS_IDS = new int[] { 23, 101, 36, 108, 8, 93, 2, 88, 3, 89, 48, 114, 46, 113, 55, 117, 9, 92, 24, 102, 37, 109, 34, 107, 21, 100, 127, 131, 128, 132, 129, 133, 130, 134, 135, 136, 140, 141, 142, 144, 152, 153, 154, 155, 156, 157, 158, 159, 160, 161, 162, 163, 164, 165, 171, 172, 173, 174, 175 };
		qn = qn1;
		RANDOM_MIN = 15;
		RANDOM_MAX = 20;
