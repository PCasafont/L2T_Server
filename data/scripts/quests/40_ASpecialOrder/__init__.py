    ...
    def onTalk(self, npc, player):
        ...
        if id == State.COMPLETED:
            ...
            if cond == 2:
                ...
                if st.getQuestItemsCount(OrangeNimbleFish) >= 10 and st.getQuestItemsCount(
                        OrangeUglyFish) >= 10 and st.getQuestItemsCount(OrangeFatFish) >= 10:
                    st.set("cond", "4")
            ...
            if cond == 5:
                ...
                if st.getQuestItemsCount(GoldenCobol) >= 40 and st.getQuestItemsCount(
                        ThornCobol) >= 40 and st.getQuestItemsCount(GreatCobol) >= 40:
                    st.set("cond", "7")
