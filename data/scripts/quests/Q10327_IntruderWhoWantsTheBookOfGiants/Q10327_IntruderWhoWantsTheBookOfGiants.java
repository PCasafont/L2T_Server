	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		...
		if (npc.getNpcId() == _pantheon)
		{
			...
			else if (event.equalsIgnoreCase("teleport"))
			{
				...
				st.set("guardId", String.valueOf(addSpawn(_guard, -114710, 245457, -7968, 49152, false, 0, false, player.getObjectId()).getObjectId()));
				bookIds[0] = addSpawn(_book, -113757, 244686, -7952, 0, false, 0, false, player.getObjectId()).getObjectId();
				bookIds[1] = addSpawn(_book, -115672, 244683, -7952, 0, false, 0, false, player.getObjectId()).getObjectId();
				bookIds[2] = addSpawn(_book, -114714, 245750, -7952, 0, false, 0, false, player.getObjectId()).getObjectId();
				bookIds[3] = addSpawn(_book, -114706, 243605, -7952, 0, false, 0, false, player.getObjectId()).getObjectId();
