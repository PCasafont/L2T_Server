...
class Quest(JQuest):
    def __init__(self, id, name, descr):
        ...
        self.questItemIds = [HERB_OF_VANOR, HERB_OF_HARIT, HERB_OF_OEL_MAHUM, BLOOD_OF_EVA, SYMBOL_OF_LOYALTY,
                             ANTIDOTE_RECIPE, VOUCHER_OF_FAITH, POTION_OF_RECOVERY, ANTIDOTE_RECIPE]
        ...
        if npcId == SIR_KRISTOF_RODEMAI:
                ...
                if player.isClanLeader() and clan:
                    ...
                    if level <= 2:
                        ...
                        if st.getQuestItemsCount(
                                PROOF_OF_ALLIANCE):  # you already have the item, no need to complete the quest!
                            htmltext = "03"
                        else:
                            htmltext = "04"
                else:
            ...
            if id == State.CREATED:  # not a valid leader (has not started the quest yet) or a clan member
                ...
                if part == 1:  # and not symbol :
                    ...
                    htmltext = "06"
                        ...
                        st.getQuestItemsCount(HERB_OF_OEL_MAHUM) and st.getQuestItemsCount(BLOOD_OF_EVA) and isEffected(
                    player, 4082):
                    htmltext = "08"
                    ...
                    debug = "Uhhh....Kalis is confused by player: " + str(player)
            elif DEBUG:
            ...
            if leaderst:
                ...
                if id == State.STARTED:
                    ...
                    if part == 3 and leaderst.getQuestItemsCount(ANTIDOTE_RECIPE) and not leaderst.getQuestItemsCount(
                            BLOOD_OF_EVA):
                        htmltext = "01"
                    elif part == 5:
                        htmltext = "10"
