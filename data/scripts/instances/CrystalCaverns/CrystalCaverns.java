...
public class CrystalCaverns extends Quest
{
	...
	// Baylor alarm spawns
	private final static int[][] ALARMSPAWN = { { 153572, 141277, -12738 }, { 153572, 142852, -12738 }, { 154358, 142075, -12738 }, { 152788, 142075, -12738 } };
	
	// Oracle order
	private static final int[][] ordreOracle1 = { { 32274, 147090, 152505, -12169, 31613 }, { 32275, 147090, 152575, -12169, 31613 }, { 32274, 147090, 152645, -12169, 31613 }, { 32274, 147090, 152715, -12169, 31613 } };
	...
	private static int[][] STEAM3_SPAWNS = { { 22307, 150735, 152316, -12145, 31930 }, { 22307, 150725, 152467, -12165, 33635 }, { 22307, 151058, 152316, -12146, 65342 }, { 22307, 151057, 152461, -12165, 2171 }
	...
	{ 22416, 151636, 150280, -12142, 36869 }, { 22416, 149893, 150232, -12165, 64258 }, { 22416, 149864, 150110, -12165, 65054 }, { 22416, 151926, 150218, -12165, 31613 }, { 22420, 149986, 150051, -12165, 105 }, { 22420, 151970, 149997, -12165, 32170 }, { 22420, 150744, 150006, -12165, 63 } // ,{22417, 149782, 150188, -12151, 64001}
	};
	...
	public String onAttack(L2Npc npc, L2PcInstance attacker, int damage, boolean isPet, L2Skill skill)
	{
		if (npc.getNpcId() == TEARS)
		{
			...
			if (tmpworld instanceof CCWorld)
			{
				...
				{
					boolean notAOE = true;
					if ((skill != null) && ((skill.getTargetType() == L2SkillTargetType.TARGET_AREA) || (skill.getTargetType() == L2SkillTargetType.TARGET_FRONT_AREA) || (skill.getTargetType() == L2SkillTargetType.TARGET_BEHIND_AREA) || (skill.getTargetType() == L2SkillTargetType.TARGET_AURA) || (skill.getTargetType() == L2SkillTargetType.TARGET_FRONT_AURA) || (skill.getTargetType() == L2SkillTargetType.TARGET_BEHIND_AURA)))
						notAOE = false;
					if (notAOE)
					{
				...
				if (checkKillProgress(0, npc, world))
				{
					...
					switch (world.status)
					{
						...
						case 25:
							...
							return "";
						default:
							Log.warning("CrystalCavern-SteamCorridor: status " + world.status + " error. OracleOrder not found in " + world.instanceId);
							return "";
					}
