    ...
    public final String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
    {
        ...
        if (wrld != null && wrld instanceof FearonSiegeWorld)
        {
            ...
            if (event.equalsIgnoreCase("stage_1_start"))
            {
                ...
                InstanceManager.getInstance()
                        .sendDelayedPacketToInstance(world.instanceId, 10,
            ...
            else if (event.equalsIgnoreCase("stage_all_spawn_round"))
            {
                ...
                InstanceManager.getInstance()
                        .sendPacket(world.instanceId, new ExShowScreenMessage(1, 0, 2, 0, 0, 0, 0, true, 5 * 1000, 0,
                                "Round: " + world._eventRound));
                ...
                else if (world._eventRound == 10)
                {
                    ...
                    InstanceManager.getInstance().sendPacket(world.instanceId, new CreatureSay(world._bossMakkum
                            .getObjectId(), 1, world._bossMakkum.getName(), "It's the time to end with your lives!"));
                }
            }
            else if (event.equalsIgnoreCase("stone_ai"))
            {
                ...
                if (chars != null && !chars.isEmpty())
                {
                    for (L2Character chara : chars)
                    {
                        ...
                        if (chara.isInsideRadius(world._protectionStone, _protectionSkill
                                .getSkillRadius(), false, false))
                        {
            ...
            else if (event.equalsIgnoreCase("gravity_core_ai"))
            {
                ...
                if (world._summonGravityCore != null && !world._summonGravityCore.isDecayed())
                {
                    ...
                    if (chars != null && !chars.isEmpty())
                    {
                        for (L2Character chara : chars)
                        {
                            if (chara == null || !chara.isInsideRadius(world._summonGravityCore, _ultimateDef
            ...
            else if (event.equalsIgnoreCase("ai_magic_sup"))
            {
                 ...
                 */
                final Collection<L2PcInstance> chars = world._warriorMageSup.getKnownList()
                        .getKnownPlayersInRadius(1600);
                if (chars != null && !chars.isEmpty())
                {
                    if (world._warriorMageSup.getCurrentMp() < 800)
                    {
                        world._warriorMageSup.broadcastPacket(new CreatureSay(world._warriorMageSup
                                .getObjectId(), 1, world._warriorMageSup
                    ...
                    for (L2PcInstance chara : chars)
                    {
                        ...
                        if (chara.isDead() && world._warriorMageSup
                                .isInsideRadius(chara, _resSkill.getCastRange(), false, false))
                        {
                    ...
                    if (deadPlayers.size() > 0) //RES
                    {
                        ...
                        if (target != null && target.isDead() && world._warriorMageSup
                                .isInsideRadius(target, _resSkill.getCastRange(), false, false) && !target
                                .isReviveRequested())
                        {
                            world._warriorMageSup.broadcastPacket(new CreatureSay(world._warriorMageSup
                                    .getObjectId(), 1, world._warriorMageSup.getName(), target
                                    .getName() + " I'll resurrect you!"));
                    ...
                    else if (fuckedCount > 0 && fuckedCount <= 3) //HEAL
                    {
                        ...
                        if (target != null && world._warriorMageSup.getCurrentMp() >= _healSkill.getMpConsume())
                        {
                            world._warriorMageSup.broadcastPacket(new CreatureSay(world._warriorMageSup
                                    .getObjectId(), 1, world._warriorMageSup.getName(), target
                                    .getName() + " let me give you a hand!"));
                    ...
                    {
                        if (world._summonGravityCore == null || world._summonGravityCore
                                .isDecayed() && world._warriorMageSup.getCurrentMp() >= _summonTree
                                .getMpConsume()) //Be sure we don't spawn more than one
                        {
                            world._warriorMageSup.broadcastPacket(new CreatureSay(world._warriorMageSup
                                    .getObjectId(), 1, world._warriorMageSup
                                    .getName(),
                            ...
                            ThreadPoolManager.getInstance().scheduleAi(new Runnable()
                            {
                                ...
                                public void run()
                                {
                                    world._summonGravityCore = addSpawn(_gravityCoreId, world._warriorMageSup
                                            .getX(), world._warriorMageSup.getY(), world._warriorMageSup
                                            .getZ() + 20, 0, false, 20000, true, world.instanceId);
                    ...
                    //Give Buffs
                    {
                        ...
                        if (buffSkill != null && world._warriorMageSup.getCurrentMp() >= buffSkill.getMpConsume())
                        {
                            ...
                            world._warriorMageSup.broadcastPacket(new CreatureSay(world._warriorMageSup
                                    .getObjectId(), 1, world._warriorMageSup
                                    .getName(),
                                    skillType + "s! Come close to me to receive the power of " + skillType + "s God!"));
                            world._warriorMageSup.setTarget(world._warriorMageSup);
                            ...
                            ThreadPoolManager.getInstance().scheduleAi(new Runnable()
                            {
                                ...
                                public void run()
                                {
                                    ...
                                    {
                                        if (chara == null || !chara
                                                .isInsideRadius(world._warriorMageSup, 150, false, false))
                                        {
                                            continue;
                                        }
        ...
        if (tmpWorld instanceof FearonSiegeWorld)
        {
            ...
            if (npc == world._bossMakkum)
            {
                if (world.status == 0 && npc.getCurrentHp() < npc.getMaxHp() * 0.90)
                {
                    ...
                    InstanceManager.getInstance().sendPacket(world.instanceId, new SpecialCamera(world._protectionStone
                            .getObjectId(), 1000, 0, 150, 0, 16000));
                    InstanceManager.getInstance()
                            .sendPacket(world.instanceId, new MagicSkillUse(world._protectionStone, _portalEffect1
                    ...
                    ThreadPoolManager.getInstance().scheduleAi(new Runnable()
                    {
                        ...
                        public void run()
                        {
                            InstanceManager.getInstance()
                                    .sendPacket(world.instanceId,
                                            new MagicSkillUse(world._protectionStone, _portalEffect2
                                                    .getId(), 1, _portalEffect2.getHitTime(),
                                                    _portalEffect2.getReuseDelay()));

                            for (int i = 0; i < 15; i++)
                            {
                                L2Npc guard = addSpawn(_warriorGuard, world._protectionStone
                                        .getX(), world._protectionStone.getY(), world._protectionStone
                            ...
                            ThreadPoolManager.getInstance().scheduleAi(new Runnable()
                            {
                                ...
                                public void run()
                                {
                                    ...
                                    if (randomGuard != null)
                                    {
                                        InstanceManager.getInstance()
                                                .sendDelayedPacketToInstance(world.instanceId, 3,
                                                        new CreatureSay(randomGuard
                                                                .getObjectId(), 1, randomGuard
                                                                .getName(), "Our Captains will arrive soon!"));
                                    }
                ...
                else if (world.status == 1 && npc.getCurrentHp() < npc.getMaxHp() * 0.50)
                {
                    ...
                    ThreadPoolManager.getInstance().scheduleAi(new Runnable()
                    {
                        ...
                        public void run()
                        {
                            ...
                            world._warriorLeona = addSpawn(_warriorLeonaId, world._protectionStone
                                    .getX(), world._protectionStone.getY(), world._protectionStone
                                    .getZ() + 20, 0, true, 0, true, world.instanceId);
                            world._warriorKain = addSpawn(_warriorKainId, world._protectionStone
                                    .getX(), world._protectionStone.getY(), world._protectionStone
                                    .getZ() + 20, 0, true, 0, true, world.instanceId);
                            world._warriorMageSup = addSpawn(_warriorMageSUpId, world._protectionStone
                                    .getX(), world._protectionStone.getY(), world._protectionStone
                                    .getZ() + 20, 0, true, 0, true, world.instanceId);

                            world._warriorLeona
                                    .broadcastPacket(new MagicSkillUse(world._warriorLeona, _warriorsSpawnEffect
                                            .getId(), 1, _warriorsSpawnEffect.getHitTime(), _warriorsSpawnEffect
                                            .getReuseDelay()));
                            world._warriorKain
                                    .broadcastPacket(new MagicSkillUse(world._warriorKain, _warriorsSpawnEffect
                                            .getId(), 1, _warriorsSpawnEffect.getHitTime(), _warriorsSpawnEffect
                                            .getReuseDelay()));
                            world._warriorMageSup
                                    .broadcastPacket(new MagicSkillUse(world._warriorMageSup, _warriorsSpawnEffect
                                            .getId(), 1, _warriorsSpawnEffect.getHitTime(), _warriorsSpawnEffect
                                            .getReuseDelay()));
                            ...
                            {
                                InstanceManager.getInstance()
                                        .sendDelayedPacketToInstance(world.instanceId, 5, new CreatureSay(randomGuard
                                                .getObjectId(), 1, randomGuard.getName(), "They're here finally!"));
                            }
                            ...
                            ThreadPoolManager.getInstance().scheduleAi(new Runnable()
                            {
                                ...
                                public void run()
                                {
                                    ...
                                    InstanceManager.getInstance()
                                            .sendDelayedPacketToInstance(world.instanceId, 3,
                                                    new CreatureSay(world._warriorLeona
                                                            .getObjectId(), 1, world._warriorLeona
                                                            .getName(), "Keep pushing warriors!"));
                                    InstanceManager.getInstance()
                                            .sendDelayedPacketToInstance(world.instanceId, 3,
                                                    new CreatureSay(world._warriorKain
                                                            .getObjectId(), 1, world._warriorKain.getName(), "C'mon!"));
                    ...
                    for (L2PcInstance pMember : player.getParty().getPartyMembers())
                    {
                        ...
                        if (InstanceManager.getInstance().canGetUniqueReward(pMember, world._rewardedPlayers))
                        {
                            ...
                            pMember.addItem(_qn, DimensionalDoor.getDimensionalDoorRewardId(), Rnd
                                    .get(70 * DimensionalDoor.getDimensionalDoorRewardRate(), 80 * DimensionalDoor
