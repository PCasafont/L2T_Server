			...
			else if (event.equalsIgnoreCase("gravity_core_ai"))
			{
				...
				if (world.summonGravityCore != null && !world.summonGravityCore.isDecayed())
				{
					...
					if (chars != null && !chars.isEmpty())
					{
						...
						{
							if (chara == null ||
									!chara.isInsideRadius(world.summonGravityCore, ultimateDef.getSkillRadius(), false,
			...
			else if (event.equalsIgnoreCase("ai_magic_sup"))
			{
				...
				if (chars != null && !chars.isEmpty())
				{
					...
					if (deadPlayers.size() > 0) //RES
					{
						...
						{
							world.warriorMageSup.broadcastPacket(new CreatureSay(world.warriorMageSup.getObjectId(), 1,
									world.warriorMageSup.getName(), target.getName() + " I'll resurrect you!"));
					...
					else if (fuckedCount > 0 && fuckedCount <= 3) //HEAL
					{
						...
						{
							world.warriorMageSup.broadcastPacket(new CreatureSay(world.warriorMageSup.getObjectId(), 1,
									world.warriorMageSup.getName(), target.getName() + " let me give you a hand!"));
				...
				else if (world.status == 1 && npc.getCurrentHp() < npc.getMaxHp() * 0.50)
				{
					...
					ThreadPoolManager.getInstance().scheduleAi(new Runnable()
					{
						...
						public void run()
						{
							...
							world.warriorLeona =
									addSpawn(warriorLeonaId, world.protectionStone.getX(), world.protectionStone.getY(),
											world.protectionStone.getZ() + 20, 0, true, 0, true, world.instanceId);
							world.warriorKain =
									addSpawn(warriorKainId, world.protectionStone.getX(), world.protectionStone.getY(),
											world.protectionStone.getZ() + 20, 0, true, 0, true, world.instanceId);
