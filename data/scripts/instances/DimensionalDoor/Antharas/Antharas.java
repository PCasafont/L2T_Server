			...
			else if (event.equalsIgnoreCase("tryGetReward"))
			{
				synchronized (world.rewardedPlayers)
				{
					if (InstanceManager.getInstance().canGetUniqueReward(player, world.rewardedPlayers))
					{
						...
						player.addItem(_qn, DimensionalDoor.getDimensionalDoorRewardId(), Rnd.get(10 * DimensionalDoor.getDimensionalDoorRewardRate(), 18 * DimensionalDoor.getDimensionalDoorRewardRate()), player, true);
					}
					else
