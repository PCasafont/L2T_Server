...
public class ConquerACastle extends L2AttackableAIScript
{
	...
	private static final Location[] _enterCords = { new Location(-14968, 117129, -3217, 14944), //Gludio
	...
	private static final int[][] _finalBossSpawn = { { -18111, 109141, -2498, 16383 }, //Gludio
		...
		if (wrld != null && wrld instanceof ConquerACastleWorld)
		{
			...
			if (npc.getNpcId() == _helperDwarf)
			{
				if (skill.getId() == 299)
				{
					...
					InstanceManager.getInstance().sendPacket(world.instanceId, new CreatureSay(npc.getObjectId(), Say2.SHOUT, "Dwarf Soldier", "C'mon golem! Destroy these doors!"));
	...
	private static void attackDoor(ConquerACastleWorld world)
	{
		...
		if (door == null)
		{
			...
			InstanceManager.getInstance().sendPacket(world.instanceId, new CreatureSay(world.dwarf.getObjectId(), Say2.SHOUT, "Dwarf Soldier", "My golem can't see more doors, please guide me to the next position!"));
