...
public class BloodThirst  extends L2AttackableAIScript
{
	...
	public final String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		...
		if (wrld != null && wrld instanceof BloodThirstWorld)
		{
			...
			if (event.equalsIgnoreCase("stage_1_start"))
			{
				...
				world._bloodThirst = addSpawn(_bloodThirstId, 56167, -186938, -7944, 16383, false, 0, true, world.instanceId);
				...
				for (L2Spawn iSpawn : SpawnTable.getInstance().getSpecificSpawns("blood_thirst"))
				{
					...
					L2Npc iNpc = addSpawn(iSpawn.getNpcId(), iSpawn.getX(), iSpawn.getY(), iSpawn.getZ(), iSpawn.getHeading(), false, 0, true, world.instanceId);
	...
	public String onKill(L2Npc npc, L2PcInstance player, boolean isPet)
	{
		...
		if (tmpworld instanceof BloodThirstWorld)
		{
			...
			{	
				player.addItem(_qn, DimensionalDoor.getDimensionalDoorRewardId(), Rnd.get(4, 6), player, true);
