...
public class Beleth extends L2AttackableAIScript
{
    ...
    public final String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
    {
        ...
        if (wrld != null && wrld instanceof belethWorld)
        {
            ...
            else if (event.equalsIgnoreCase("stage_1_intro_1_11"))
            {
                InstanceManager.getInstance()
                        .sendPacket(world.instanceId, new SocialAction(world.beleth.getObjectId(), 1));
            ...
            {
                InstanceManager.getInstance()
                        .sendPacket(world.instanceId, new SocialAction(world.beleth.getObjectId(), 3));
        ...
        if (npc != null && npc.getNpcId() == npcEnter && Util.isDigit(event) &&
