...
public class FeedableBeasts extends L2AttackableAIScript
{
	...
	private static class GrowthCapableMob
	{
		...
		{
			this.spiceToMob.put(spice, Mobs);
		}

		public Integer getMob(int spice, int mobType, int classType)
		{
			if (this.spiceToMob.containsKey(spice))
			{
				return this.spiceToMob.get(spice)[mobType][classType];
			}
			return null;
		}
		...
		{
			int[][] temp;
			temp = this.spiceToMob.get(spice);
	...
	public FeedableBeasts(int questId, String name, String descr)
	{
		...
		this.GrowthCapableMobs.put(21451, temp);

		temp = new GrowthCapableMob(1, 40);
		temp.addMobs(GOLDEN_SPICE, Kookabura_1_Gold_1);
		this.GrowthCapableMobs.put(21452, temp);
		this.GrowthCapableMobs.put(21454, temp);

		temp = new GrowthCapableMob(1, 40);
		temp.addMobs(GOLDEN_SPICE, Kookabura_1_Gold_2);
		this.GrowthCapableMobs.put(21453, temp);
		this.GrowthCapableMobs.put(21455, temp);

		temp = new GrowthCapableMob(1, 40);
		temp.addMobs(CRYSTAL_SPICE, Kookabura_1_Crystal_1);
		this.GrowthCapableMobs.put(21456, temp);
		this.GrowthCapableMobs.put(21458, temp);

		temp = new GrowthCapableMob(1, 40);
		temp.addMobs(CRYSTAL_SPICE, Kookabura_1_Crystal_2);
		this.GrowthCapableMobs.put(21457, temp);
		this.GrowthCapableMobs.put(21459, temp);

		temp = new GrowthCapableMob(2, 25);
		temp.addMobs(GOLDEN_SPICE, Kookabura_2_1);
		this.GrowthCapableMobs.put(21460, temp);
		this.GrowthCapableMobs.put(21462, temp);

		temp = new GrowthCapableMob(2, 25);
		temp.addMobs(GOLDEN_SPICE, Kookabura_2_2);
		this.GrowthCapableMobs.put(21461, temp);
		this.GrowthCapableMobs.put(21463, temp);

		temp = new GrowthCapableMob(2, 25);
		temp.addMobs(CRYSTAL_SPICE, Kookabura_2_1);
		this.GrowthCapableMobs.put(21464, temp);
		this.GrowthCapableMobs.put(21466, temp);

		temp = new GrowthCapableMob(2, 25);
		temp.addMobs(CRYSTAL_SPICE, Kookabura_2_2);
		this.GrowthCapableMobs.put(21465, temp);
		this.GrowthCapableMobs.put(21467, temp);

		// Alpen Buffalo
		temp = new GrowthCapableMob(0, 100);
		temp.addMobs(GOLDEN_SPICE, Buffalo_0_Gold);
		temp.addMobs(CRYSTAL_SPICE, Buffalo_0_Crystal);
		this.GrowthCapableMobs.put(21470, temp);

		temp = new GrowthCapableMob(1, 40);
		temp.addMobs(GOLDEN_SPICE, Buffalo_1_Gold_1);
		this.GrowthCapableMobs.put(21471, temp);
		this.GrowthCapableMobs.put(21473, temp);

		temp = new GrowthCapableMob(1, 40);
		temp.addMobs(GOLDEN_SPICE, Buffalo_1_Gold_2);
		this.GrowthCapableMobs.put(21472, temp);
		this.GrowthCapableMobs.put(21474, temp);

		temp = new GrowthCapableMob(1, 40);
		temp.addMobs(CRYSTAL_SPICE, Buffalo_1_Crystal_1);
		this.GrowthCapableMobs.put(21475, temp);
		this.GrowthCapableMobs.put(21477, temp);

		temp = new GrowthCapableMob(1, 40);
		temp.addMobs(CRYSTAL_SPICE, Buffalo_1_Crystal_2);
		this.GrowthCapableMobs.put(21476, temp);
		this.GrowthCapableMobs.put(21478, temp);

		temp = new GrowthCapableMob(2, 25);
		temp.addMobs(GOLDEN_SPICE, Buffalo_2_1);
		this.GrowthCapableMobs.put(21479, temp);
		this.GrowthCapableMobs.put(21481, temp);

		temp = new GrowthCapableMob(2, 25);
		temp.addMobs(GOLDEN_SPICE, Buffalo_2_2);
		this.GrowthCapableMobs.put(21480, temp);
		this.GrowthCapableMobs.put(21482, temp);

		temp = new GrowthCapableMob(2, 25);
		temp.addMobs(CRYSTAL_SPICE, Buffalo_2_1);
		this.GrowthCapableMobs.put(21483, temp);
		this.GrowthCapableMobs.put(21485, temp);

		temp = new GrowthCapableMob(2, 25);
		temp.addMobs(CRYSTAL_SPICE, Buffalo_2_2);
		this.GrowthCapableMobs.put(21484, temp);
		this.GrowthCapableMobs.put(21486, temp);

		// Alpen Cougar
		temp = new GrowthCapableMob(0, 100);
		temp.addMobs(GOLDEN_SPICE, Cougar_0_Gold);
		temp.addMobs(CRYSTAL_SPICE, Cougar_0_Crystal);
		this.GrowthCapableMobs.put(21489, temp);

		temp = new GrowthCapableMob(1, 40);
		temp.addMobs(GOLDEN_SPICE, Cougar_1_Gold_1);
		this.GrowthCapableMobs.put(21490, temp);
		this.GrowthCapableMobs.put(21492, temp);

		temp = new GrowthCapableMob(1, 40);
		temp.addMobs(GOLDEN_SPICE, Cougar_1_Gold_2);
		this.GrowthCapableMobs.put(21491, temp);
		this.GrowthCapableMobs.put(21493, temp);

		temp = new GrowthCapableMob(1, 40);
		temp.addMobs(CRYSTAL_SPICE, Cougar_1_Crystal_1);
		this.GrowthCapableMobs.put(21494, temp);
		this.GrowthCapableMobs.put(21496, temp);

		temp = new GrowthCapableMob(1, 40);
		temp.addMobs(CRYSTAL_SPICE, Cougar_1_Crystal_2);
		this.GrowthCapableMobs.put(21495, temp);
		this.GrowthCapableMobs.put(21497, temp);

		temp = new GrowthCapableMob(2, 25);
		temp.addMobs(GOLDEN_SPICE, Cougar_2_1);
		this.GrowthCapableMobs.put(21498, temp);
		this.GrowthCapableMobs.put(21500, temp);

		temp = new GrowthCapableMob(2, 25);
		temp.addMobs(GOLDEN_SPICE, Cougar_2_2);
		this.GrowthCapableMobs.put(21499, temp);
		this.GrowthCapableMobs.put(21501, temp);

		temp = new GrowthCapableMob(2, 25);
		temp.addMobs(CRYSTAL_SPICE, Cougar_2_1);
		this.GrowthCapableMobs.put(21502, temp);
		this.GrowthCapableMobs.put(21504, temp);

		temp = new GrowthCapableMob(2, 25);
		temp.addMobs(CRYSTAL_SPICE, Cougar_2_2);
		this.GrowthCapableMobs.put(21503, temp);
		this.GrowthCapableMobs.put(21505, temp);
	}
	...
	public void spawnNext(L2Npc npc, int growthLevel, L2PcInstance player, int food)
	{
		...
		if (growthLevel == 2)
		{
			...
			if (Rnd.get(2) == 0)
			{
				...
				{
					nextNpcId = this.GrowthCapableMobs.get(npcId).getMob(food, 1, 1);
				}
				else
				{
					nextNpcId = this.GrowthCapableMobs.get(npcId).getMob(food, 1, 0);
				}
			}
			else
			{
				...
				if (Rnd.get(5) == 0)
				{
					nextNpcId = this.GrowthCapableMobs.get(npcId).getMob(food, 0, 1);
				}
				else
				{
					nextNpcId = this.GrowthCapableMobs.get(npcId).getMob(food, 0, 0);
				}
			}
		}
		else
		{
			...
			nextNpcId = this.GrowthCapableMobs.get(npcId).getRandomMob(food);
		}

		// remove the feedinfo of the mob that got despawned, if any
		if (this.FeedInfo.containsKey(npc.getObjectId()))
		{
			if (this.FeedInfo.get(npc.getObjectId()) == player.getObjectId())
			{
				this.FeedInfo.remove(npc.getObjectId());
			}
		}
		// despawn the old mob
		...
		else
		{
			...
			this.FeedInfo.put(nextNpc.getObjectId(), player.getObjectId());
			nextNpc.setRunning();
	...
	public String onSkillSee(L2Npc npc, L2PcInstance caster, L2Skill skill, L2Object[] targets, boolean isPet)
	{
		...
		if (this.GrowthCapableMobs.containsKey(npcId))
		{
			growthLevel = this.GrowthCapableMobs.get(npcId).getGrowthLevel();
		}

		// prevent exploit which allows 2 players to simultaneously raise the same 0-growth beast
		// If the mob is at 0th level (when it still listens to all feeders) lock it to the first feeder!
		if (growthLevel == 0 && this.FeedInfo.containsKey(objectId))
		{
			return super.onSkillSee(npc, caster, skill, targets, isPet);
		}
		else
		{
			this.FeedInfo.put(objectId, caster.getObjectId());
		}
		...
		if (this.GrowthCapableMobs.containsKey(npcId))
		{
			...
			if (this.GrowthCapableMobs.get(npcId).getMob(food, 0, 0) == null)
			{
				return super.onSkillSee(npc, caster, skill, targets, isPet);
			}
			...
			if (growthLevel > 0 && this.FeedInfo.get(objectId) != caster.getObjectId())
			{
			...
			if (Rnd.get(100) < this.GrowthCapableMobs.get(npcId).getChance())
			{
