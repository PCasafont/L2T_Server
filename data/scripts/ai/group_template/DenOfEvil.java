...
public class DenOfEvil extends L2AttackableAIScript
{
	...
	private static final int[][] _eye_spawn = { { 71544, -129400, -3360, 16472 }, { 70954, -128854, -3360, 16 }, { 72145, -128847, -3368, 32832 }, { 76147, -128372, -3144, 16152 }, { 71573, -128309, -3360, 49152 }, { 75211, -127441, -3152, 0 }, { 77005, -127406, -3144, 32784 }, { 75965, -126486, -3144, 49120 }, { 70972, -126429, -3016, 19208 }, { 69916, -125838, -3024, 2840 }, { 71658, -125459, -3016, 35136 }, { 70605, -124646, -3040, 52104 }, { 67283, -123237, -2912, 12376 }, { 68383, -122754, -2912, 27904 }, { 74137, -122733, -3024, 13272 }, { 66736, -122007, -2896, 60576 }, { 73289, -121769, -3024, 1024 }, { 67894, -121491, -2912, 43872 }, { 75530, -121477, -3008, 34424 }, { 74117, -120459, -3024, 52344 }, { 69608, -119855, -2534, 17251 }, { 71014, -119027, -2520, 31904 }, { 68944, -118964, -2527, 59874 }, { 62261, -118263, -3072, 12888 }, { 70300, -117942, -2528, 46208 }, { 74312, -117583, -2272, 15280 }, { 63276, -117409, -3064, 24760 }, { 68104, -117192, -2168, 15888 }, { 73758, -116945, -2216, 0 }, { 74944, -116858, -2220, 30892 }, { 61715, -116623, -3064, 59888 }, { 69140, -116464, -2168, 28952 }, { 67311, -116374, -2152, 1280 }, { 62459, -116370, -3064, 48624 }, { 74475, -116260, -2216, 47456 }, { 68333, -115015, -2168, 45136 }, { 68280, -108129, -1160, 17992 }, { 62983, -107259, -2384, 12552 }, { 67062, -107125, -1144, 64008 }, { 68893, -106954, -1160, 36704 }, { 63848, -106771, -2384, 32784 }, { 62372, -106514, -2384, 0 }, { 67838, -106143, -1160, 51232 }, { 62905, -106109, -2384, 51288 } };
	...
	public String onSpawn(L2Npc npc)
	{
		if (Util.contains(_eye_ids, npc.getNpcId()))
		{
			...
			if (zone == null)
			{
				Log.warning("NPC " + npc + " spawned outside of L2EffectZone, check your zone coords! X:" + npc.getX() + " Y:" + npc.getY() + " Z:" + npc.getZ());
				return null;
			}
	...
	public String onKill(L2Npc npc, L2PcInstance killer, boolean isPet)
	{
		if (Util.contains(_eye_ids, npc.getNpcId()))
		{
			...
			if (zone == null)
			{
				Log.warning("NPC " + npc + " killed outside of L2EffectZone, check your zone coords! X:" + npc.getX() + " Y:" + npc.getY() + " Z:" + npc.getZ());
				return null;
			}
			int skillId = getSkillIdByNpcId(npc.getNpcId());
			int skillLevel = zone.getSkillLevel(skillId);
