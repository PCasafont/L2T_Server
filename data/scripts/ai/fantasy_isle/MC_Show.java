...
public class MC_Show extends Quest
{
	...
	private static int[] messages = { 1800105, // How come people are not here... We are about to start the show.. Hmm
	...
	private void scheduleTimer()
	{
		...
		if (Config.DEBUG)
		{
			...
			Log.info("Fantasy Isle: MC show script starting at " + format.format(System.currentTimeMillis() + diff) + " and is scheduled each next 4 hours.");
		}
