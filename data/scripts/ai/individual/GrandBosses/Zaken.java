		...
		if (event.equalsIgnoreCase("1003"))
		{
			if (_ai4 == 1)
			{
				for (int i = 0; i < Xcoords.length; i++)
					addSpawn(pirates_zombie_captain_b, nextSpawn(Xcoords[i], Ycoords[i], Zcoords[i], 650), Rnd.get(65536), false, 0)/* .setIsRaidMinion(true) */;
			...
			else if (_ai4 == 3)
			{
				for (int i = 0; i < Xcoords.length; i++)
					for (int c = 0; c < 2; c++)
						addSpawn(vale_master_b, nextSpawn(Xcoords[i], Ycoords[i], Zcoords[i], 650), Rnd.get(65536), false, 0)/* .setIsRaidMinion(true) */;
			...
			else if (_ai4 == 4)
			{
				for (int i = 0; i < Xcoords.length; i++)
					for (int c = 0; c < 5; c++)
						addSpawn(pirates_zombie_b, nextSpawn(Xcoords[i], Ycoords[i], Zcoords[i], 650), Rnd.get(65536), false, 0)/* .setIsRaidMinion(true) */;
