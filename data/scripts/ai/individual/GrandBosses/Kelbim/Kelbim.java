...
public class Kelbim extends L2AttackableAIScript
{
	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		...
		else if (event.equalsIgnoreCase("stage_all_spawn_minions"))
		{
			...
			{
				L2Npc minion =
						addSpawn(kelbimGuard, kelbimBoss.getX(), kelbimBoss.getY(), kelbimBoss.getZ(), 0, true, 0, true,
								0);
			...
			{
				L2Npc minion =
						addSpawn(kelbimGuardians[Rnd.get(kelbimGuardians.length)], kelbimBoss.getX(), kelbimBoss.getY(),
								kelbimBoss.getZ(), 0, true, 0, true, 0);
				minion.setIsRunning(true);
				((L2Attackable) minion).setIsRaidMinion(true);
