...
public class DarkWaterDragon extends L2AttackableAIScript
{
	...
	private static HashSet<Integer> secondSpawn = new HashSet<Integer>(); //Used to track if second Shades were already spawned
	private static HashSet<Integer> myTrackingSet = new HashSet<Integer>(); //Used to track instances of npcs
	private static ConcurrentHashMap<Integer, L2PcInstance> _idmap = new ConcurrentHashMap<Integer, L2PcInstance>(); //Used to track instances of npcs
