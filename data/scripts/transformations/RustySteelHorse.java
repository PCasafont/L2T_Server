...
public class RustySteelHorse extends L2Transformation
{
	private static final int[] SKILLS = {5491, 839, 9206};

	public RustySteelHorse()
	{
	...
	{
		TransformationManager.getInstance().registerTransformation(new RustySteelHorse());
	}
}
