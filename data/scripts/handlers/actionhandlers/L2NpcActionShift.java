    ...
    public boolean action(L2PcInstance activeChar, L2Object target, boolean interact)
    {
        ...
        if (activeChar.getAccessLevel().isGm())
        {
            ...
            if (attTarget != null)
            {
                ...
                {
                    aggroInfo += "<tr><td>" + i.getKey().getName() + "</td><td>Aggro: " + i.getValue()
                            .getDamage() + "</td><td>Hate: " + i.getValue().getHate() + "</td></tr>";
                }
                aggroInfo += "</table>";
            }
            ...
            html.replace("%loc%", String
                    .valueOf(target.getX() + " " + target.getY() + " " + target.getZ() + " " + ((L2Character) target)
                            .getHeading()));
            ...
            {
                html.replace("%spawn%", targetNpc.getSpawn().getX() + " " + targetNpc.getSpawn()
                        .getY() + " " + targetNpc.getSpawn().getZ() + " " + targetNpc.getSpawn().getHeading());
                ...
                html.replace("%loc3d%", String.valueOf((int) Math.sqrt(((L2Character) target)
                        .getDistanceSq(targetNpc.getSpawn().getX(), targetNpc.getSpawn().getY(), targetNpc.getSpawn()
                                .getZ()))));
            ...
            if (targetNpc.hasAI())
            {
                html.replace("%ai_intention%",
                        "<tr><td><table width=270 border=0 bgcolor=131210><tr><td width=100><font color=FFAA00>Intention:</font></td><td align=right width=170>" +
                                String
                                        .valueOf(targetNpc.getAI().getIntention().name()) +
                                "</td></tr></table></td></tr>");
                html.replace("%ai%",
                ...
                html.replace("%ai_type%",
                        "<tr><td><table width=270 border=0 bgcolor=131210><tr><td width=100><font color=FFAA00>AIType</font></td><td align=right width=170>" +
                                String
                                        .valueOf(targetNpc.getAiType()) + "</td></tr></table></td></tr>");
                html.replace("%ai_clan%",
                        "<tr><td><table width=270 border=0><tr><td width=100><font color=FFAA00>Clan & Range:</font></td><td align=right width=170>" +
                                String
                                        .valueOf(targetNpc.getTemplate().getAIData().getClan()) + " " + String
                                .valueOf(targetNpc.getTemplate().getAIData().getClanRange()) +
                                "</td></tr></table></td></tr>");
                html.replace("%ai_enemy_clan%",
                        "<tr><td><table width=270 border=0 bgcolor=131210><tr><td width=100><font color=FFAA00>Enemy & Range:</font></td><td align=right width=170>" +
                                String
                                        .valueOf(targetNpc.getTemplate().getAIData().getEnemyClan()) + " " + String
                                .valueOf(targetNpc.getTemplate().getAIData().getEnemyRange()) +
                                "</td></tr></table></td></tr>");
            }
            else
            {
        ...
        else if (Config.ALT_GAME_VIEWNPC)
        {
            ...
            final StringBuilder html1 = StringUtil
                    .startAppend(1000,
                            ...
                            String
                                    .valueOf(((L2Character) target)
                                            .getMAtkSpd()), "</td></tr>" + "<tr><td>Race</td><td>",
                            targetNpc.getTemplate()
                                    .getRace()
