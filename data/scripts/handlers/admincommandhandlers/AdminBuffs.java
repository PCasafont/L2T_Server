...
public class AdminBuffs implements IAdminCommandHandler
{
    ...
    public void showBuffs(L2PcInstance activeChar, L2Character target, int page)
    {
        ...
        if (Config.GMAUDIT)
        {
            GMAudit.auditGMAction(activeChar.getName(), "getbuffs", target.getName() + " (" + Integer
                    .toString(target.getObjectId()) + ")", "");
        }
    }
    ...
    private void removeBuff(L2PcInstance activeChar, int objId, int skillId)
    {
        ...
        if (target != null && skillId > 0)
        {
            ...
            if (Config.GMAUDIT)
            {
                GMAudit.auditGMAction(activeChar.getName(), "stopbuff", target.getName() + " (" + objId + ")", Integer
                        .toString(skillId));
            }
        }
    }
