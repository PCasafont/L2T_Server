...
import l2tserver.gameserver.instancemanager.AntiBotsManager.ClientInfo;
import l2tserver.gameserver.instancemanager.AntiBotsManager.ClientProcess;
...
import l2tserver.gameserver.network.serverpackets.GMViewItemList;
...
import l2tserver.gameserver.network.serverpackets.SetSummonRemainTime;
...
public class AdminEditChar implements IAdminCommandHandler
{
	...
	private void gatherCharacterInfo(L2PcInstance activeChar, L2PcInstance player, String filename)
	{
		...
		if (Config.ANTI_BOTS_ENABLED)
		{
			...
			List<ClientInfo> pcsWithSameIp = AntiBotsManager.getInstance().getClientsInfoByIp(properIp);
