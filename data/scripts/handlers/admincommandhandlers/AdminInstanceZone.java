...
public class AdminInstanceZone implements IAdminCommandHandler
{
    ...
    private void display(L2PcInstance player, L2PcInstance activeChar)
    {
        ...
        final StringBuilder html = StringUtil.startAppend(500 + instanceTimes
                .size() * 200, "<html><center><table width=260><tr>" +
                ...
                "</tr></table><br><font color=\"LEVEL\">Instances for ", player
                .getName(), "</font><center><br>" + "<table>" +
        ...
        for (int id : instanceTimes.keySet())
        {
            ...
            StringUtil.append(html, "<tr><td>", InstanceManager.getInstance().getInstanceIdName(id), "</td><td>", String
                            .valueOf(hours), ":", String
                            .valueOf(minutes), "</td><td><button value=\"Clear\" action=\"bypass -h admin_instancezone_clear ",
                    player
                            .getName(), " ", String
                            .valueOf(id),
