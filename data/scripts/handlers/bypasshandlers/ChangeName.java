...
public class ChangeName implements IBypassHandler
{
	...
	public boolean useBypass(String command, L2PcInstance activeChar, L2Npc target)
	{
		...
		if (command.startsWith("ChangeCharName"))
		{
			...
			{
				String html = "<html>" + "<title>Tenkai</title>" + "<body>" + "<center><br><tr><td>Change Name</tr></td><br>" + "<br>" + "Tired of your current character name? Have in mind that this is a very big privilege, the name change has always been denied by the administrators!<br>" + "But I can help you. This is not a recommended option, I would suggest you to create another character, but if you insist that much... it will be 10 coins of luck.<br>" + "<center><tr><td><edit var=text width=130 height=11 length=26><br>" + "<button value=\"Done\" action=\"bypass -h npc_%objectId%_ChangeCharName $text\" back=\"l2ui_ct1.button_df\" width=65 height=20 fore=\"l2ui_ct1.button_df\"></td></tr><br>" + "</center></body></html>";
		...
		else if (command.startsWith("ChangeClanName"))
		{
			...
			{
				String html = "<html>" + "<title>Tenkai</title>" + "<body>" + "<center><br><tr><td>Change Clan Name</tr></td><br>" + "<br>" + "Do you want to change your current clan name? Have in mind that this is a very big privilege, any name change has always been denied by the administrators!<br>" + "But I can help you. This is not a recommended option, I would suggest you to create another clan, but if you insist that much... it will be 25 coins of luck.<br>" + "<center><tr><td><edit var=text width=130 height=11 length=26><br>" + "<button value=\"Done\" action=\"bypass -h npc_%objectId%_ChangeClanName $text\" back=\"l2ui_ct1.button_df\" width=65 height=20 fore=\"l2ui_ct1.button_df\"></td></tr><br>" + "</center></body></html>";
				NpcHtmlMessage packet = new NpcHtmlMessage(target.getObjectId());
				packet.setHtml(html);
				packet.replace("%objectId%", String.valueOf(target.getObjectId()));
				activeChar.sendPacket(packet);
