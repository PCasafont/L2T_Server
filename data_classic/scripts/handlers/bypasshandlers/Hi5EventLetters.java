...
{
	private static final String[] COMMANDS = {"CheckLetters"};
			...
			for (int i = 0; i < 5; i++)
			{
				if (!hasLetters[i])
				{
					activeChar.sendPacket(new NpcHtmlMessage(0,
							"<html><body>You don't have all the required letters!<br>Take your time to find all of them and come back.</body></html>"));
					return true;
				}
			}
