...
public class CustomVoiced implements IVoicedCommandHandler
{
    ...
    public boolean useVoicedCommand(String command, L2PcInstance player, String params)
    {
        ...
        else if (command.equalsIgnoreCase("mammon"))
        {
            ...
            {
                player.sendMessage("The Blacksmith of Mammon is near " + MapRegionTable.getInstance()
                        .getClosestTownName(blacksmith[0]) + ".");
            }
            else
            {
            ...
            {
                player.sendMessage("The Merchant of Mammon is near " + MapRegionTable.getInstance()
                        .getClosestTownName(merchant[0]) + ".");
            }
            else
            {
    ...
    {
        String html = "<html>" + "<title>My Hidden Stats</title>" + "<body><br>" +
        ...
        html += getStatHtm("P. Skill Evasion Rate", player
                .calcStat(Stats.P_SKILL_EVASION, 0, null, null), 0, false, "%");
    ...
    private String getStatHtm(String statName, double statVal, double statDefault, boolean plusIfPositive, String suffix)
    {
        ...
        return "<tr><td>" + statName + ":</td><td>" + ((plusIfPositive && statVal >= 0) ? "+" : "") +
                new DecimalFormat("#0.##")
                        .format(statVal) + suffix + "</td></tr>";
    }
