		...
		if (command.equalsIgnoreCase("sell"))
		{
			...
			if (!isSelling)
			{
				...
				else if (params.startsWith("item"))
				{
					...
					"<title>Tenkai</title>" +
					"<body>" +
					"<center><br><tr><td>Sell %name%</tr></td><br>" +
					"<br>" +
					"Maximum amount: %amount%<br>" +
					"<tr><td><edit var=text width=130 height=11 length=26><br>" +
					"<button value=\"Set max amount\" action=\"bypass -h voice .sell item " + index + " setAmount $text\" back=\"l2ui_ct1.button_df\" width=135 height=20 fore=\"l2ui_ct1.button_df\"></td></tr><br><br>" +
					"%prices%<br><br>" +
					"%addPrice%<br><br>" +
					...
					{
						String itemHtm = priceItem.getName() + " (" + item.getPriceItems().get(priceItem) + ")<br>" +
								"<tr>" +
								"<td><edit var=amt" + priceItem.getItemId() + " width=60 height=11 length=26> " +
								"<button value=\"Set Amount\" action=\"bypass -h voice .sell item " + index + " setPriceAmount " + priceItem.getItemId() + " $amt" + priceItem.getItemId() + "\" back=\"l2ui_ct1.button_df\" width=85 height=20 fore=\"l2ui_ct1.button_df\"></td>" +
								"<td><button value=\"Delete\" action=\"bypass -h voice .sell item " + index + " deletePrice " + priceItem.getItemId() + "\" back=\"l2ui_ct1.button_df\" width=65 height=20 fore=\"l2ui_ct1.button_df\"></td>" +
								"</tr>";;
					...
					packet.replace("%addPrice%", "<button value=\"Add Price Item\" action=\"bypass -h voice .sell item " + index + " addPrice\" back=\"l2ui_ct1.button_df\" width=115 height=20 fore=\"l2ui_ct1.button_df\">");
			...
			for (int i = 0; i < list.getItemCount(); i++)
			{
				...
				String itemHtm = item.getItem().getName() + "<br>" +
						"<tr>" +
						"<td>Price items: " + item.getPriceItems().size() + "</td>" +
						"<td><button value=\"Edit\" action=\"bypass -h voice .sell item " + i + "\" back=\"l2ui_ct1.button_df\" width=65 height=20 fore=\"l2ui_ct1.button_df\"></td>" +
						"<td><button value=\"Delete\" action=\"bypass -h voice .sell deleteItem " + item.getObjectId() + "\" back=\"l2ui_ct1.button_df\" width=65 height=20 fore=\"l2ui_ct1.button_df\"></td>" +
						"</tr>";
			...
			packet.replace("%addItem%", "<button value=\"Add Item\" action=\"bypass -h voice .sell addItem\" back=\"l2ui_ct1.button_df\" width=65 height=20 fore=\"l2ui_ct1.button_df\">");

			if (!isSelling)
				packet.replace("%actionButton%", "<button value=\"Start!\" action=\"bypass -h voice .sell start\" back=\"l2ui_ct1.button_df\" width=85 height=20 fore=\"l2ui_ct1.button_df\">");
			else
				packet.replace("%actionButton%", "<button value=\"Stop\" action=\"bypass -h voice .sell stop\" back=\"l2ui_ct1.button_df\" width=85 height=20 fore=\"l2ui_ct1.button_df\">");
