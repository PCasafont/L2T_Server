	...
	public boolean action(L2PcInstance activeChar, L2Object target, boolean interact)
	{
		...
		if (activeChar.getAccessLevel().isGm())
		{
			...
			if (((L2Npc)target).hasAI())
			{
				...
				html.replace("%ai_clan%",       "<tr><td><table width=270 border=0><tr><td width=100><font color=FFAA00>Clan & Range:</font></td><td align=right width=170>"+String.valueOf(((L2Npc)target).getTemplate().getAIData().getClan())+" "+String.valueOf(((L2Npc)target).getTemplate().getAIData().getClanRange())+"</td></tr></table></td></tr>");
				html.replace("%ai_enemy_clan%", "<tr><td><table width=270 border=0 bgcolor=131210><tr><td width=100><font color=FFAA00>Enemy & Range:</font></td><td align=right width=170>"+String.valueOf(((L2Npc)target).getTemplate().getAIData().getEnemyClan())+" "+String.valueOf(((L2Npc)target).getTemplate().getAIData().getEnemyRange())+"</td></tr></table></td></tr>");
			}
			else
			{
