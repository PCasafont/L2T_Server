...
class Quest(JQuest):
    ...
    def onTalk(self, npc, player):
        ...
        if id == State.COMPLETED:
            ...
            if npcId == 30307 and st.getInt("cond") >= 1 and (
                                st.getQuestItemsCount(KAROYDS_LETTER_ID) >= 1 or st.getQuestItemsCount(
                            CECKTINONS_VOUCHER1_ID) >= 1 or st.getQuestItemsCount(CECKTINONS_VOUCHER2_ID) >= 1):
            ...
            elif npcId == 30132 and st.getInt("cond") >= 2 and (
                            st.getQuestItemsCount(CECKTINONS_VOUCHER1_ID) >= 1 or st.getQuestItemsCount(
                        CECKTINONS_VOUCHER2_ID) >= 1):
            ...
            elif npcId == 30144 and st.getInt("cond") == 3 and st.getQuestItemsCount(
                    CECKTINONS_VOUCHER2_ID) >= 1 and st.getQuestItemsCount(BONE_FRAGMENT1_ID) < 10:
                htmltext = "30144-02.htm"
            elif npcId == 30144 and st.getInt("cond") == 4 and st.getQuestItemsCount(
                    CECKTINONS_VOUCHER2_ID) == 1 and st.getQuestItemsCount(BONE_FRAGMENT1_ID) >= 10:
            ...
            elif npcId == 30132 and st.getInt("cond") == 6 and st.getQuestItemsCount(
                    PRESERVE_OIL_ID) == 1 and st.getQuestItemsCount(ZOMBIE_HEAD_ID) == 0 and st.getQuestItemsCount(
                STEELBENDERS_HEAD_ID) == 0:
