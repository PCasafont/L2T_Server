...
class Quest(JQuest):
    ...
    def onEvent(self, event, st):
        ...
        if event == "1":
            ...
            elif st.getInt("cond") != 0 and st.getQuestItemsCount(MAGICAL_POWERS_RUBY) == 0 and st.getQuestItemsCount(
                    FERTILITY_PERIDOT) != 0:
            ...
            elif st.getInt("cond") != 0 and st.getQuestItemsCount(PURE_AQUAMARINE) == 0 and st.getQuestItemsCount(
                    FERTILITY_PERIDOT) != 0:
            ...
            elif st.getInt("cond") != 0 and st.getQuestItemsCount(NOBILITY_AMETHYST) == 0 and st.getQuestItemsCount(
                    FERTILITY_PERIDOT) != 0:
    ...
    def onKill(self, npc, player, isPet):
        ...
        if npcId == 20466:
            st.set("id", "0")
            if st.getInt("cond") != 0 and st.getQuestItemsCount(CHARM_OF_GRAIN) != 0 and st.getQuestItemsCount(
                    RED_DOWN) < 5 and st.getRandom(100) < 70:
            ...
            st.set("id", "0")
            if st.getInt("cond") != 0 and st.getQuestItemsCount(SAP_OF_WORLD_TREE) != 0 and st.getQuestItemsCount(
                    GOLD_LEAVES) < 5 and st.getRandom(100) < 40:
            ...
            st.set("id", "0")
            if st.getInt("cond") != 0 and st.getQuestItemsCount(LUCKY_POTPOURI) != 0 and st.getQuestItemsCount(
