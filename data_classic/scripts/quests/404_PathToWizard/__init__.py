    ...
    def onTalk(self, npc, player):
        ...
        if npcId == 30391 and st.getInt("cond") == 0:
            ...
            return htmltext
                                ...
                                st.getQuestItemsCount(FLAME_EARING) == 0 or st.getQuestItemsCount(
                            WIND_BANGEL) == 0 or st.getQuestItemsCount(WATER_NECKLACE) == 0 or st.getQuestItemsCount(
                    EARTH_RING) == 0):
            htmltext = "30391-05.htm"
        elif npcId == 30411 and st.getInt("cond") != 0 and st.getQuestItemsCount(
                MAP_OF_LUSTER) == 0 and st.getQuestItemsCount(FLAME_EARING) == 0:
            ...
            st.set("cond", "2")
                ...
                MAP_OF_LUSTER) != 0 and st.getQuestItemsCount(KEY_OF_FLAME) == 0:
        ...
        elif npcId == 30412 and st.getInt("cond") != 0 and st.getQuestItemsCount(
                FLAME_EARING) != 0 and st.getQuestItemsCount(BROKEN_BRONZE_MIRROR) == 0 and st.getQuestItemsCount(
            WIND_BANGEL) == 0:
            ...
            st.set("cond", "5")
                ...
                BROKEN_BRONZE_MIRROR) != 0 and st.getQuestItemsCount(WIND_FEATHER) == 0:
        ...
        elif npcId == 30410 and st.getInt("cond") != 0 and st.getQuestItemsCount(
                BROKEN_BRONZE_MIRROR) != 0 and st.getQuestItemsCount(WIND_FEATHER) == 0:
        ...
        elif npcId == 30413 and st.getInt("cond") != 0 and st.getQuestItemsCount(
                WIND_BANGEL) != 0 and st.getQuestItemsCount(RAMAS_DIARY) == 0 and st.getQuestItemsCount(
            WATER_NECKLACE) == 0:
            ...
            st.set("cond", "8")
                ...
                RAMAS_DIARY) != 0 and st.getQuestItemsCount(SPARKLE_PEBBLE) < 2:
        ...
        elif npcId == 30409 and st.getInt("cond") != 0 and st.getQuestItemsCount(
                WATER_NECKLACE) != 0 and st.getQuestItemsCount(RUST_GOLD_COIN) == 0 and st.getQuestItemsCount(
            EARTH_RING) == 0:
            ...
            st.set("cond", "11")
                ...
                RUST_GOLD_COIN) != 0 and st.getQuestItemsCount(RED_SOIL) == 0:
            ...
            htmltext = "30409-03.htm"
        elif npcId == 30391 and st.getInt("cond") != 0 and st.getQuestItemsCount(
                FLAME_EARING) != 0 and st.getQuestItemsCount(WIND_BANGEL) != 0 and st.getQuestItemsCount(
            WATER_NECKLACE) != 0 and st.getQuestItemsCount(EARTH_RING) != 0:
