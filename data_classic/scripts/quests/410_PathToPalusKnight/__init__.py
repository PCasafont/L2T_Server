...
class Quest(JQuest):
    ...
    def onTalk(self, npc, player):
        ...
        if npcId == 30329 and st.getInt("cond") == 0:
            ...
            elif st.getQuestItemsCount(PALLUS_TALISMAN) == 1 and st.getQuestItemsCount(
                    LYCANTHROPE_SKULL) > 0 and st.getQuestItemsCount(LYCANTHROPE_SKULL) < 13:
            ...
            if st.getQuestItemsCount(VIRGILS_LETTER):
            ...
            elif st.getQuestItemsCount(MORTE_TALISMAN) and st.getQuestItemsCount(
                    TRIMDEN_SILK) == 0 and st.getQuestItemsCount(PREDATOR_CARAPACE) == 0:
                ...
                htmltext = "30422-04.htm"
                    ...
                    TRIMDEN_SILK) >= 5 and st.getQuestItemsCount(PREDATOR_CARAPACE) > 0:
    ...
    def onKill(self, npc, player, isPet):
        ...
        if npcId == 20049:
            st.set("id", "0")
            if st.getInt("cond") and st.getQuestItemsCount(PALLUS_TALISMAN) == 1 and st.getQuestItemsCount(
            ...
            st.set("id", "0")
            if st.getInt("cond") and st.getQuestItemsCount(MORTE_TALISMAN) == 1 and st.getQuestItemsCount(
                    PREDATOR_CARAPACE) < 1:
