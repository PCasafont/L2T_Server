...
class Quest(JQuest):
    ...
    def onTalk(self, npc, player):
        ...
        if npcId == 30220 and st.getInt("cond") == 0 and st.getInt("onlyone") == 0:
            ...
            if st.getQuestItemsCount(RUMIELS_POEM_1_ID) == 1 and st.getQuestItemsCount(
                    RUMIELS_POEM_3_ID) == 1 and st.getQuestItemsCount(RUMIELS_POEM_4_ID) == 1 and st.getQuestItemsCount(
                RUMIELS_POEM_5_ID) == 1 and st.getInt("onlyone") == 0:
                if st.getInt("id") != 163:
                    st.set("id", "163")
        ...
        if npcId == 20372:
            ...
            if st.getInt("cond") == 1:
                if st.getRandom(10) == 0 and st.getQuestItemsCount(RUMIELS_POEM_1_ID) == 0:
                    ...
                    if st.getQuestItemsCount(RUMIELS_POEM_1_ID) + st.getQuestItemsCount(
                            RUMIELS_POEM_3_ID) + st.getQuestItemsCount(RUMIELS_POEM_4_ID) + st.getQuestItemsCount(
                        RUMIELS_POEM_5_ID) == 4:
