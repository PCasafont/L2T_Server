...
class Quest(JQuest):
    ...
    def onTalk(self, npc, player):
        ...
        if npcId == 30461 and cond == 0:
            ...
            st.addExpAndSp(87696, 5687)
            st.giveItems(57, 15981)
            st.giveItems(7562, 8)
        ...
        elif npcId == 30608 and (
                    st.getQuestItemsCount(SYMBOL_OF_SYLVAIN_ID) or st.getQuestItemsCount(MIRIENS_SIGIL2_ID)):
            htmltext = "30608-16.htm"
        elif npcId == 30608 and st.getQuestItemsCount(MIRIENS_SIGIL3_ID) >= 1 and st.getQuestItemsCount(
                VALKONS_REQUEST_ID) == 0:
        ...
        elif npcId == 30111 and st.getQuestItemsCount(MIRIENS_SIGIL3_ID) and st.getQuestItemsCount(
                CRONOS_SIGIL_ID) and st.getQuestItemsCount(DIETERS_DIARY_ID) and st.getQuestItemsCount(
            RAUTS_LETTER_ENVELOPE_ID):
            htmltext = "30111-11.htm"
        elif npcId == 30111 and st.getQuestItemsCount(MIRIENS_SIGIL3_ID) and st.getQuestItemsCount(
                CRONOS_SIGIL_ID) and st.getQuestItemsCount(DIETERS_DIARY_ID) and st.getQuestItemsCount(
            DIETERS_LETTER_ID) == 0 and st.getQuestItemsCount(RAUTS_LETTER_ENVELOPE_ID) == 0:
            if st.getQuestItemsCount(SCRIPTURE_CHAPTER_1_ID) and st.getQuestItemsCount(
                    SCRIPTURE_CHAPTER_2_ID) and st.getQuestItemsCount(SCRIPTURE_CHAPTER_3_ID) and st.getQuestItemsCount(
        ...
        elif npcId == 30230 and st.getQuestItemsCount(DIETERS_DIARY_ID) >= 1 and (
                    st.getQuestItemsCount(STRONG_LIQUOR_ID) or st.getQuestItemsCount(TRIFFS_RING_ID)):
            htmltext = "30230-04.htm"
        elif npcId == 30316 and cond == 24:
            htmltext = "30316-01.htm"
        elif npcId == 30316 and cond == 25:
            htmltext = "30316-04.htm"
        elif npcId == 30316 and st.getQuestItemsCount(DIETERS_DIARY_ID) and st.getQuestItemsCount(
                SCRIPTURE_CHAPTER_1_ID) and st.getQuestItemsCount(TRIFFS_RING_ID):
            ...
            st.playSound("ItemSound.quest_middle")
        elif npcId == 30458 and cond == 26 and st.getQuestItemsCount(POITANS_NOTES_ID) and st.getQuestItemsCount(
                CASIANS_LIST_ID) == 0:
            htmltext = "30458-02.htm"
        elif npcId == 30458 and cond == 27 and st.getQuestItemsCount(POITANS_NOTES_ID) and st.getQuestItemsCount(
                CASIANS_LIST_ID):
            ...
            if st.getQuestItemsCount(SCRIPTURE_CHAPTER_1_ID) and st.getQuestItemsCount(
                    SCRIPTURE_CHAPTER_2_ID) and st.getQuestItemsCount(SCRIPTURE_CHAPTER_3_ID):
                htmltext = "30612-02.htm"
            else:
                htmltext = "30612-01.htm"
        elif npcId == 30612 and cond == 28:
            if st.getQuestItemsCount(GHOULS_SKIN_ID) + st.getQuestItemsCount(MEDUSAS_BLOOD_ID) + st.getQuestItemsCount(
                    FETTEREDSOULS_ICHOR_ID) + st.getQuestItemsCount(ENCHT_GARGOYLES_NAIL_ID) < 32:
        ...
        if st.getInt("cond") == 16:
                ...
                if st.getQuestItemsCount(MEYEDESTROYERS_SKIN_ID) < 5:
                    if st.getRandom(100) < 50:
                        ...
                        if st.getQuestItemsCount(MEYEDESTROYERS_SKIN_ID) < 5:
                            ...
                            st.playSound("ItemSound.quest_middle")
                            if st.getQuestItemsCount(SHACKLES_SCALP_ID) == 2 and st.getQuestItemsCount(
                                    SHAMANS_NECKLACE_ID) == 5 and st.getQuestItemsCount(MEYEDESTROYERS_SKIN_ID) == 5:
                                st.set("cond", "17")
            elif npcId == 20269:
            ...
            if st.getInt("cond") == 28 and st.getQuestItemsCount(GHOULS_SKIN_ID) < 10:
                ...
                if st.getQuestItemsCount(GHOULS_SKIN_ID) < 10:
                    ...
                    st.playSound("ItemSound.quest_middle")
                    if st.getQuestItemsCount(GHOULS_SKIN_ID) == 10 and st.getQuestItemsCount(
                            MEDUSAS_BLOOD_ID) == 12 and st.getQuestItemsCount(
                        FETTEREDSOULS_ICHOR_ID) == 5 and st.getQuestItemsCount(ENCHT_GARGOYLES_NAIL_ID) == 5:
                        st.set("cond", "29")
        elif npcId == 20158:
