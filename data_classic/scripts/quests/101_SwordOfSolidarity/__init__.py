...
class Quest(JQuest):
    def __init__(self, id, name, descr):
        ...
        self.questItemIds = [ALLTRANS_NOTE, HOWTOGO_RUINS, BROKEN_BLADE_TOP, BROKEN_BLADE_BOTTOM, ROIENS_LETTER,
                             BROKEN_SWORD_HANDLE]
    ...
    def onTalk(self, npc, player):
        ...
        if id == State.COMPLETED:
            ...
            elif npcId == 30008 and st.getInt("cond") >= 2 and st.getQuestItemsCount(
                    ROIENS_LETTER) == 0 and st.getQuestItemsCount(ALLTRANS_NOTE) == 0:
            ...
            elif npcId == 30008 and st.getInt("cond") == 4 and st.getQuestItemsCount(
                    ROIENS_LETTER) == 0 and st.getQuestItemsCount(ALLTRANS_NOTE):
            ...
            elif npcId == 30283 and st.getInt("cond") >= 2 and st.getQuestItemsCount(
                    ROIENS_LETTER) == 0 and st.getQuestItemsCount(HOWTOGO_RUINS) > 0:
                if (st.getQuestItemsCount(BROKEN_BLADE_TOP) + st.getQuestItemsCount(BROKEN_BLADE_BOTTOM)) == 1:
