...
class Quest(JQuest):
    def __init__(self, id, name, descr):
        ...
        self.questItemIds = [RANGERS_REPORT1, RANGERS_REPORT2, RANGERS_REPORT3, RANGERS_REPORT4, OL_MAHUM_HEAD,
                             CARGOBOX, TYRAS_BILL, CERTIFICATE, BLADE_MOLD, WEAPON_TRADE_CONTRACT]
    ...
    def onTalk(self, npc, player):
        ...
        if npcId == ALVAH:
            if id == State.CREATED:
                ...
                if st.getQuestItemsCount(RANGERS_REPORT1) and st.getQuestItemsCount(
                        RANGERS_REPORT2) and st.getQuestItemsCount(RANGERS_REPORT3) and st.getQuestItemsCount(
                    RANGERS_REPORT4):
            ...
            if npcId == ARODIN:
                ...
                if cond == 9 and st.getQuestItemsCount(CERTIFICATE) and st.getQuestItemsCount(
                        CARGOBOX) and st.getQuestItemsCount(ATTACK_DIRECTIVES):
