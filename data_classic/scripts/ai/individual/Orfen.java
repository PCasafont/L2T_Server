...
public class Orfen extends L2AttackableAIScript
{
    ...
    private static final int[][] Pos =
            {{43728, 17220, -4342}, {55024, 17368, -5412}, {53504, 21248, -5486}, {53248, 24576, -5262}};
    ...
    public void setSpawnPoint(L2Npc npc, int index)
    {
        ...
        spawn.setX(Pos[index][0]);
        spawn.setY(Pos[index][1]);
        spawn.setZ(Pos[index][2]);
    ...
    public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
    {
        ...
        {
            if ((_IsTeleported && npc.getCurrentHp() > npc.getMaxHp() * 0.95) || (!_Zone
                    .isInsideZone(npc) && !_IsTeleported))
            {
    ...
    public String onKill(L2Npc npc, L2PcInstance killer, boolean isPet)
    {
        if (npc.getNpcId() == ORFEN)
        {
            ...
            long respawnTime = (long) GrandBossManager.getInstance().getRespawnTime(ORFEN) + Rnd
                    .get(GrandBossManager.getInstance().getRandomRespawnTime(ORFEN));
