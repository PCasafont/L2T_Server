...
public class QueenAnt extends L2AttackableAIScript
{
	...
	public final String onEnterZone(L2Character character, L2ZoneType zone)
	{
		if (character != null)
		{
			if (character instanceof L2Playable && character.getLevel() > 48 && !character.isGM())
			{
				//Temp
				...
				if (player != null)
					startQuestTimer("kick_player", 2000, null, player);
			}
		}
	...
	public String onKill(L2Npc npc, L2PcInstance killer, boolean isPet)
	{
		...
		if (npcId == QUEEN)
		{
			...
			long respawnTime = (long)GrandBossManager.getInstance().getRespawnTime(QUEEN) + Rnd.get(GrandBossManager.getInstance().getRandomRespawnTime(QUEEN));
