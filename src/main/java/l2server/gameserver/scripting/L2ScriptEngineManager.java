...
public final class L2ScriptEngineManager {
	public static final File SCRIPT_FOLDER = new File(Config.DATAPACK_ROOT.getAbsolutePath(), Config.DATA_FOLDER + "scripts");
	...
	public void reportScriptFileError(File script, ScriptException e) {
		...
		if (dir != null) {
			...
			Log.log(Level.WARNING,
					"Failed executing script: " + script.getAbsolutePath() + "\r\n" + e.getMessage() +
