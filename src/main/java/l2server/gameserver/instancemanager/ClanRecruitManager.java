...
public class ClanRecruitManager {
	...
	public boolean addClan(L2Clan clan, int karma, String introduction, String largeIntroduction) {
		...
		try {
			...
			PreparedStatement statement =
					con.prepareStatement("INSERT INTO clan_recruit_data (clan_id, karma, introduction, large_introduction) VALUES (?, ?, ?, ?)");
	...
	public void updateClan(L2Clan clan, int karma, String introduction, String largeIntroduction) {
		...
		try {
			con = L2DatabaseFactory.getInstance().getConnection();
			PreparedStatement statement =
					con.prepareStatement("UPDATE clan_recruit_data SET karma = ?, introduction = ?, large_introduction = ? WHERE clan_id = ?");
	...
	public boolean addApplicant(Player player, int clanId, String application) {
		...
		try {
			con = L2DatabaseFactory.getInstance().getConnection();
			PreparedStatement statement =
					con.prepareStatement("INSERT INTO clan_recruit_applicants (applicant_id, clan_id, application) VALUES (?, ?, ?)");
