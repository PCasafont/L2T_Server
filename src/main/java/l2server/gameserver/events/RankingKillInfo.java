...
public class RankingKillInfo {
	...
	private boolean checkConditions(L2PcInstance killerPlayer, L2PcInstance killedPlayer) {
		...
		if (killedPlayer.getPDef(null) < 800 || killedPlayer.getMDef(killedPlayer, null) < 800 || killedPlayer.getPAtkSpd() < 500 ||
				killedPlayer.getMAtkSpd() < 500 || killedPlayer.getPvpKills() < 10) {
			return false;
		}
	...
	private String getBasicKillInfo(L2PcInstance killed, L2PcInstance killer) {
		...
		if (killed.getClassId() >= 148) {
			tb.append("<center><table width=256 height=180 background=\"L2UI_CT1.HtmlWnd.HtmlWnd_ClassMark_" + killed.getClassId() +
		...
		tb.append("<tr><td FIXWIDTH=100><font color=886531>Name [lvl]:</font></td><td><font color=FF6600>" + killer.getName() + " [" +
				killer.getLevel() + "]</font></td></tr>");
		tb.append("<tr><td><font color=772F2F><font color=886531>Current Class:</font></font></td><td><font color=FF6600>" +
		...
		tb.append("<tr><td><font color=886531>Clan:</font></td><td><font color=999999>" + clanName + "</font></td></tr>");

		String allyName = killer.getAllyId() > 0 ? killer.getClan().getAllyName() : "No";
		tb.append("<tr><td><font color=886531>Alliance:</font></td><td><font color=999999>" + allyName + "</font></td></tr>");
		tb.append("</table>");
		tb.append("<img src=\"L2UI.Squaregray\" width=300 height=1>");
		tb.append("<table width=300>");
		tb.append("<tr><td ><font color=886531>Current CP / Max Cp:</font></td><td FIXWIDTH=100><font color=LEVEL>" + (int) killer.getCurrentCp() +
				" / " + killer.getMaxCp() + "</font></td></tr>");
		tb.append("<tr><td><font color=886531>Current HP / Max HP:</font></td><td><font color=FF0000>" + (int) killer.getCurrentHp() + " / " +
				killer.getMaxHp() + "</font></td></tr>");
		tb.append("<tr><td><font color=886531>Current MP / Max MP:</font></td><td><font color=3366FF>" + (int) killer.getCurrentMp() + " / " +
				killer.getMaxMp() + "</font></td></tr>");
		tb.append("</table>");
		tb.append("<img src=\"L2UI.Squaregray\" width=300 height=1>");
		tb.append("<table width=300>");
		tb.append("<tr><td><font color=886531>Legal PvP Points:</font></td><td FIXWIDTH=70><font color=LEVEL>" + killer.getPvpKills() +
				"</font></td></tr>");
		tb.append("<tr><td><font color=886531>Legal PK Points:</font></td><td><font color=LEVEL>" + killer.getPkKills() + "</font></td></tr>");
