...
public class ClanBBSManager extends BaseBBSManager {
	...
	public void parsecmd(String command, Player activeChar) {
		if (command.equals("_bbsclan")) {
			...
			separateAndSend("<html><body><br><br><center>Command : " + command + " needs core development</center><br><br></body></html>",
					activeChar);
		}
	}
		...
		for (L2Clan cl : ClanTable.getInstance().getClans()) {
			...
			if (i++ >= (index - 1) * 7) {
				StringUtil.append(html,
						...
						"\">",
						cl.getName(),
						"</a></td><td FIXWIDTH=200 align=center>",
						cl.getLeaderName(),
						"</td><td FIXWIDTH=100 align=center>",
