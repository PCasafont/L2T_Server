...
public class EffectSignet extends L2Effect {
	...
	public boolean onStart() {
		if (getSkill() instanceof L2SkillSignet) {
			skill = SkillTable.getInstance().getInfo(((L2SkillSignet) getSkill()).effectId, ((L2SkillSignet) getSkill()).effectLevel);
		...
		srcInArena = getEffector().isInsideZone(L2Character.ZONE_PVP) && !getEffector().isInsideZone(L2Character.ZONE_SIEGE);
		return true;
	}
