		...
		if (condition <= COND_ALL_FALSE) {
			...
			// control
			{
				if ((player.getClanPrivileges() & L2Clan.CP_CS_TAXES) == L2Clan.CP_CS_TAXES) {
					...
					final String msg = StringUtil.concat("<html><body>",
							getName(),
							":<br>" + "Current tax rate: ",
							String.valueOf(getCastle().getTaxPercent()),
							"%<br>" + "<table>" + "<tr>" + "<td>Change tax rate to:</td>" + "<td><edit var=\"value\" width=40><br>" +
				...
				if (val.equalsIgnoreCase("tele")) {
					...
					if (getCastle().getFunction(Castle.FUNC_TELEPORT) == null) {
						...
						html.setFile(player.getHtmlPrefix(),
								"chamberlain/" + getCastle().getName() + "-t" + getCastle().getFunction(Castle.FUNC_TELEPORT).getLvl() + ".htm");
					}
					...
					if (getCastle().getFunction(Castle.FUNC_SUPPORT) == null) {
						...
						html.setFile(player.getHtmlPrefix(), "chamberlain/support" + getCastle().getFunction(Castle.FUNC_SUPPORT).getLvl() + ".htm");
					...
					if (val.equalsIgnoreCase("recovery")) {
						if (st.countTokens() >= 1) {
							...
							if (val.equalsIgnoreCase("hp_cancel")) {
								...
								html.replace("%cost%",
										String.valueOf(cost) + "</font>Adena /" + String.valueOf(Config.CS_HPREG_FEE_RATIO / 1000 / 60 / 60 / 24) +
												" Day</font>)");
								html.replace("%use%",
								...
								html.replace("%cost%",
										String.valueOf(cost) + "</font>Adena /" + String.valueOf(Config.CS_MPREG_FEE_RATIO / 1000 / 60 / 60 / 24) +
												" Day</font>)");
								html.replace("%use%",
								...
								html.replace("%cost%",
										String.valueOf(cost) + "</font>Adena /" + String.valueOf(Config.CS_EXPREG_FEE_RATIO / 1000 / 60 / 60 / 24) +
												" Day</font>)");
								html.replace("%use%",
								...
								if (st.countTokens() >= 1) {
									...
									switch (percent) {
										case 0:
											fee = 0;
											html.setFile(player.getHtmlPrefix(), "chamberlain/functions-cancel_confirmed.htm");
											break;
										case 80:
									...
									if (!getCastle().updateFunctions(player,
											Castle.FUNC_RESTORE_HP,
											percent,
											fee,
						...
						if (getCastle().getFunction(Castle.FUNC_RESTORE_HP) != null) {
							html.replace("%hp_recovery%",
									String.valueOf(getCastle().getFunction(Castle.FUNC_RESTORE_HP).getLvl()) + "%</font> (<font color=\"FFAABB\">" +
											String.valueOf(getCastle().getFunction(Castle.FUNC_RESTORE_HP).getLease()) + "</font>Adena /" +
						...
						if (getCastle().getFunction(Castle.FUNC_RESTORE_EXP) != null) {
							html.replace("%exp_recovery%",
									String.valueOf(getCastle().getFunction(Castle.FUNC_RESTORE_EXP).getLvl()) + "%</font> (<font color=\"FFAABB\">" +
											String.valueOf(getCastle().getFunction(Castle.FUNC_RESTORE_EXP).getLease()) + "</font>Adena /" +
						...
						if (getCastle().getFunction(Castle.FUNC_RESTORE_MP) != null) {
							html.replace("%mp_recovery%",
									String.valueOf(getCastle().getFunction(Castle.FUNC_RESTORE_MP).getLvl()) + "%</font> (<font color=\"FFAABB\">" +
											String.valueOf(getCastle().getFunction(Castle.FUNC_RESTORE_MP).getLease()) + "</font>Adena /" +
						...
						if (st.countTokens() >= 1) {
							...
							if (val.equalsIgnoreCase("tele_cancel")) {
								...
								html.replace("%cost%",
										String.valueOf(cost) + "</font>Adena /" + String.valueOf(Config.CS_SUPPORT_FEE_RATIO / 1000 / 60 / 60 / 24) +
												" Day</font>)");
								...
								html.replace("%cost%",
										String.valueOf(cost) + "</font>Adena /" + String.valueOf(Config.CS_TELE_FEE_RATIO / 1000 / 60 / 60 / 24) +
												" Day</font>)");
								html.replace("%use%",
										"Teleports clan members in a castle to the target <font color=\"00FFFF\">Stage " + String.valueOf(stage) +
												"</font> staging area");
						...
						if (getCastle().getFunction(Castle.FUNC_TELEPORT) != null) {
							html.replace("%tele%",
									"Stage " + String.valueOf(getCastle().getFunction(Castle.FUNC_TELEPORT).getLvl()) +
											...
											String.valueOf(getCastle().getFunction(Castle.FUNC_TELEPORT).getLease()) + "</font>Adena /" +
						...
						if (getCastle().getFunction(Castle.FUNC_SUPPORT) != null) {
							html.replace("%support%",
									"Stage " + String.valueOf(getCastle().getFunction(Castle.FUNC_SUPPORT).getLvl()) +
											"</font> (<font color=\"FFAABB\">" +
											String.valueOf(getCastle().getFunction(Castle.FUNC_SUPPORT).getLease()) + "</font>Adena /" +
											String.valueOf(Config.CS_SUPPORT_FEE_RATIO / 1000 / 60 / 60 / 24) + " Day)");
			...
			} else if (actualCommand.equalsIgnoreCase("siege_time_set")) // set preDay
			{
				...
				if (player.isClanLeader()) {
					if (player.getInventory().getItemByItemId(6841) == null) {
						Item crown = player.getInventory().addItem("Castle Crown", 6841, 1, player, this);
				...
				if (player.isClanLeader() && tendency != 0) {
					...
					if (player.getInventory().getItemByItemId(cloakId) == null) {
						Item cloak = player.getInventory().addItem("Lord Cloak", cloakId, 1, player, this);
	...
	private void doTeleport(Player player, int val) {
		...
		if (list != null) {
			if (player.destroyItemByItemId("Teleport", list.getItemId(), list.getPrice(), this, true)) {
				if (Config.DEBUG) {
					log.warn(
							"Teleporting player " + player.getName() + " for Castle to new location: " + list.getLocX() + ":" + list.getLocY() + ":" +
									list.getLocZ());
				}
